...
\paragraph{Why a density statement.} The earlier window result is logically
weaker than it looks: a finite sweep cannot exclude a large solution, and
discrepancy functions of this shape are precisely the kind that can hide a
sporadic zero far out (compare the long search history for odd perfect numbers,
where exhaustive verification to enormous bounds is \emph{not} a proof of
non-existence). By collapsing $D(n)=0$ to the multiplicative condition
$\prod g(p,a)=1$ and bounding every factor's sign, we convert ``no zero found
below $N$'' into ``no zero anywhere'' --- the qualitative jump that makes the
density claim ($\#\{n:D(n)=0\}=2$) rigorous rather than empirical.

\section{Related framings}
\label{sec:related}

Three classical lenses bear on $D$. First, $\sig(n)\phi(n)$ and $n\tau(n)$ are
both well-studied multiplicative functions, and identities equating them are a
species of \emph{divisor-totient balance}; the closest classical companion is
the Dedekind $\psi$ function $\psi(n)=n\prod_{p\mid n}(1+1/p)$, whose
interaction with $\sig$ and $\phi$ produces similar prime-power quotients. Our
$g(p,a)$ is exactly the per-prime balance ratio in that family. Second, the
distinguished role of $n=6$ aligns with the Euclid--Euler theory of perfect
numbers~\citep{dickson}: $6=2(2^2-1)$ is the first Euclid perfect number, and
the cancellation $g(2,1)g(3,1)=1$ is the totient-weighted shadow of its
perfection $\sig(6)=2\cdot6$. Third, the density-zero conclusion places $D$
among arithmetic functions whose ``coincidence locus'' is finite --- a
qualitatively stronger statement than the merely thin (density-zero but
infinite) loci that arise for, e.g., abundant--deficient boundary conditions.
None of these classical framings, however, states the sharp ``exactly
$\{1,6\}$, nowhere else'' result with a machine-audited factor table; that is
...
\section{Appendix D: explicit discrepancy table $D(n)$, $n\in[1,30]$}
\label{sec:dtable}

Table~\ref{tab:full} lists $D(n)=\sig(n)\phi(n)-n\tau(n)$ for every
$n\in[1,30]$, the head of the sweep window. The two zeros at $n=1$ and $n=6$
are the only entries on the $D=0$ line; $n=2$ is the unique negative value;
every other row is strictly positive. The column $\prod g$ records the
multiplicative product $\prod_{p^a\|n} g(p,a)$ of \textsection\ref{sec:proof}:
it equals $1$ exactly when $D=0$, confirming the reduction~\eqref{eq:prodcond}
point-by-point. Rows $n\in[1,22]$ plus $n=28,30$ are machine-verified: each
$\sig,\phi,\tau$ is an independent \texttt{hexa verify --expr} \formal-tier run
(transcripts under \texttt{.verdicts/paper-omega-zero-density/}); the remaining
six rows ($n\in\{23,24,25,26,27,29\}$) are exact integer fill by the same
closed-form definitions and are included only to complete the window picture.

\begin{longtable}{r l r r r r r}
\caption{$D(n)$ over $n\in[1,30]$. Zeros (boxed) occur only at $n\in\{1,6\}$,
where the prime-power product $\prod g$ hits $1$.}\\
\toprule
$n$ & factorisation & $\sig$ & $\phi$ & $\tau$ & $D(n)$ & $\prod g$\\
\midrule
\endfirsthead
\toprule
$n$ & factorisation & $\sig$ & $\phi$ & $\tau$ & $D(n)$ & $\prod g$\\
...
$4$  & $2^2$          & $7$  & $2$  & $3$ & $2$   & $1.167$\\
$5$  & $5$            & $6$  & $4$  & $2$ & $14$  & $2.400$\\
$6$  & $2\cdot3$      & $12$ & $2$  & $4$ & $\boxed{0}$ & $1$\\
$7$  & $7$            & $8$  & $6$  & $2$ & $34$  & $3.429$\\
$8$  & $2^3$          & $15$ & $4$  & $4$ & $28$  & $1.875$\\
$9$  & $3^2$          & $13$ & $6$  & $3$ & $51$  & $2.889$\\
$10$ & $2\cdot5$      & $18$ & $4$  & $4$ & $32$  & $1.800$\\
$11$ & $11$           & $12$ & $10$ & $2$ & $98$  & $5.455$\\
$12$ & $2^2\cdot3$    & $28$ & $4$  & $6$ & $40$  & $1.556$\\
$13$ & $13$           & $14$ & $12$ & $2$ & $142$ & $6.462$\\
$14$ & $2\cdot7$      & $24$ & $6$  & $4$ & $88$  & $2.571$\\
$15$ & $3\cdot5$      & $24$ & $8$  & $4$ & $132$ & $3.200$\\
$16$ & $2^4$          & $31$ & $8$  & $5$ & $168$ & $3.100$\\
$17$ & $17$           & $18$ & $16$ & $2$ & $254$ & $8.471$\\
$18$ & $2\cdot3^2$    & $39$ & $6$  & $6$ & $126$ & $2.167$\\
$19$ & $19$           & $20$ & $18$ & $2$ & $322$ & $9.474$\\
$20$ & $2^2\cdot5$    & $42$ & $8$  & $6$ & $216$ & $2.800$\\
$21$ & $3\cdot7$      & $32$ & $12$ & $4$ & $300$ & $4.571$\\
$22$ & $2\cdot11$     & $36$ & $10$ & $4$ & $272$ & $4.091$\\
$23$ & $23$           & $24$ & $22$ & $2$ & $482$ & $11.48$\\
$24$ & $2^3\cdot3$    & $60$ & $8$  & $8$ & $288$ & $2.500$\\
$25$ & $5^2$          & $31$ & $20$ & $3$ & $545$ & $8.267$\\
$26$ & $2\cdot13$     & $42$ & $12$ & $4$ & $400$ & $4.846$\\
$27$ & $3^3$          & $40$ & $18$ & $4$ & $612$ & $6.667$\\
$28$ & $2^2\cdot7$    & $56$ & $12$ & $6$ & $504$ & $4.000$\\
$29$ & $29$           & $30$ & $28$ & $2$ & $782$ & $14.48$\\
$30$ & $2\cdot3\cdot5$& $72$ & $8$  & $8$ & $336$ & $2.400$\\
\bottomrule
\label{tab:full}
\end{longtable}

\noindent The $\prod g$ column is the clearest view of the theorem: starting
from $n=2$ ($g=0.75<1$), only $n=6$ multiplies that deficit back to exactly $1$
via $g(3,1)=4/3$; every other row's product is bounded away from $1$ and grows
with $\omega(n)$ and with the prime sizes, so no further crossing is possible.
