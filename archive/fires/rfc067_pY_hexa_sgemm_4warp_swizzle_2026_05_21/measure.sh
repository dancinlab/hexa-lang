#!/usr/bin/env bash
# RFC 067 PY -- 4-WARP 64x64 + XOR-swizzle plumbing (single-axis isolation per N104).
#
...
ART_DIR_BASENAME="rfc067_pY_hexa_sgemm_4warp_swizzle_2026_05_21"
...
ssh ubu-2 "cd /tmp/${ART_DIR_BASENAME} && ./host \
    ...
    sgemm_4warp_swizzle_1536x1536_grid.ptx 2>&1" | tee fire.log
