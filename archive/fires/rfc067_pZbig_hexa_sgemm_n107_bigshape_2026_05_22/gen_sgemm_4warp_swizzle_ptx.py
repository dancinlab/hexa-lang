...
# 9 shapes -- 64-aligned (256/384/512/768/1024/1536/2048/3072/4096 all divisible by 64).
# RFC 067 PZbig extension: add M=2048/3072/4096 to test cuBLAS-BEAT regime expansion
# at compute-bound large-M. cuBLAS HGEMM peak on RTX 5070 sm_120 ~67 TFLOPS @ large-M
# (compute-bound regime). Hypothesis: more arithmetic intensity -> ratio improves or
# saturates at structural ceiling. Memory: M=2048 50 MB, M=3072 113 MB, M=4096 201 MB,
# all fit in 12 GB VRAM. Pre-existing 6 shapes retained for regression-sanity check.
SHAPES = [256, 384, 512, 768, 1024, 1536, 2048, 3072, 4096]
