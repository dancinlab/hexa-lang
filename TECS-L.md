...
도메인 scaffold 단계. archive-TECS-L 의 핵심은 n=6 완전수에서 산술함수
...
- [ ] M1 — n=6 핵심 정체성 σ(n)·φ(n)=n·τ(n) ⟺ n∈{1,6}: hexa-native 재계산 + `hexa verify` 🔵 SUPPORTED-FORMAL + atlas 등록
- [ ] M2 — 산술함수 stdlib 모듈 (σ · τ · φ · sopfr) hexa-native — Python `model_utils.py` 대체 + 단위 테스트
- [ ] M3 — Dedekind ψ discrepancy D(n)=σφ−n·τ 유일성 (n=6/28) hexa-native 재계산 + g5
