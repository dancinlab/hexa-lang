...
_persistent python audio worker (hexa-only)_

**Source:** [`stdlib/anima_audio_worker.hexa`](../../stdlib/anima_audio_worker.hexa)  

## Overview

hexa-only final closure (cycle 30 wave 4 follow-up, 2026-04-30): the on-disk
...
C3 honest disclosure:
  ...
  hexa is out of scope for hexa-only closure (no equivalents in the hexa
...
self-host fixpoint self-host fixpoint: byte-for-byte equivalent to the retired .py.
