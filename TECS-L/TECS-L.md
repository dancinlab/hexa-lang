...
- [ ] CM0 — n=6 lattice (σ=12·τ=4·φ=2·sopfr=5, master σφ=nτ=24) 재근거 (축 0 M2/M5 공유 🔵)
- [ ] CM1-CM7 — BSD·Hodge·N-S·P-vs-NP·Poincaré·Riemann·Yang-Mills candidate g5 triage (lattice 🔵 / candidate 🟠 honest · over-claim 금지)
...
- [ ] PH1 — 축 0 M5 물리상수 thread 를 PHYSICS 대축으로 재편 (string dim τ(perfect)=4/6/10/14/26 🔵 재참조 + 확장 후보)
...
- [ ] CO1 — 우주론 상수 후보 스캔: hexa verify 가능한 정수/비율 식별 (대부분 🟠 예상, honest)
...
- [ ] LF1 — 생명 수학 verify-able 후보: IIT Φ (`stdlib/consciousness/iit4` faithful_phi) + 분자조합 닫힌형 식별
