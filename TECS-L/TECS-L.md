...
- [ ] F-NEW-4 — Γ₀(N) sweep N=41..60: 20 candidates closed-form ψ(N) recompute. F-NEW-1 [31,40] extension. 각 N 별 `hexa verify --expr gamma0_index N ψ(N) --no-absorb` exact 🔵 expected (`--no-absorb` = auto-absorb hang INBOX 2026-05-26T22:10Z canonical workaround).
- [ ] F-NEW-5 — σ_2(N) divisor-square sum batch: σ_2(6)=50 · σ_2(12)=210 · σ_2(28)=1050 · σ_2(496) · σ_2(8128). 첫 perfect-number subset 5 candidates (agent next-seed 2). 각 verify `hexa verify --expr sigma_2 N V --no-absorb`.
