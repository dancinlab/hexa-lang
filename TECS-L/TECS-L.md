...
- [x] F-NEW-3 — jacobi (a/p) atlas pad 양수 batch CLOSED (R2 round 2): **4/4 양수 candidates 🔵 SUPPORTED-FORMAL** — jacobi(2,7)=1 · jacobi(3,11)=1 · jacobi(5,11)=1 · jacobi(7,3)=1. 음수 인자 12 candidates (a<0 dispatch 미지원) = calc gap → INBOX inbox/notes/tecs-l-jacobi-negative-dispatch-2026-05-26.md 후보 (cap n=12, #1230 calc-gap family). → `.verdicts/tecs-l-f-new-3/jacobi_{2_7,3_11,5_11,7_3}.txt`.
