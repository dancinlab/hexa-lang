...
- [x] MF7 — first_cusp_form_weight(N) N=1..30 sweep 🔵 + AL=2^ω(N) 닫힌형 (sample N + 공식): **30/30 🔵 sweep** (N=1→12 Δ₁₂·N=6→4·N=12→4 headline), AL involution 닫힌형 |{AL of Γ₀(N)}|=2^ω(N) 은 hexa `atkin_lehner_count`/`omega` 계산기 경로 부재(🟠) → 🟡 SUPPORTED-BY-CITATION (Atkin–Lehner 1970 Lemma 8), 단 squarefree N 의 ω-parity 는 μ(N)=(−1)^ω(N) 로 g5 정박(μ(1)=1·μ(2)=−1·μ(6)=1·μ(30)=−1 4 verdict 🔵). 30+4+1 verdict + AL 공식문서 → `.verdicts/tecs-l-modform-weight-al/` · `CLAIMS.tape` slug=tecs-l-modform-weight-al 9 entry
