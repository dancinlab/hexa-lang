...
- [x] E2 — atlas health: `hexa atlas stats --audit` drift=0 (clean·merged · duplicates=0 · malformed=0 · entries=16108) + ATLAS_HASH 스냅샷(`663698a0…ce7fb`) + verified-* 6 노드 lookup 가능(τ-33550336·τ-496·τ-8128·is_perfect-8589869056·gamma0_genus-6·gamma0_cusps-6, E1 fold 확인). 🟢 health green
