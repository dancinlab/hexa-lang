...
- [x] **DOMAINS.tape reuse edge** (g67): repo-root `DOMAINS.tape` connection graph 에 cross-domain `@link TECS-L --reuses--> OEIS` 등록 — 7 provenance link. cross-project STAR 엣지(cross-project `@link` 블록) 미접촉.
