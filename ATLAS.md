...
calc_dispatch.hexa 미러 단일화(최우선·serial·link-fragility 위험) · falsifier 구조화 필드 + cascade 무효화 · numerology 격리 tier · active-acquisition 랭킹(Q/🟡/🟠) · lookup on-disk offset 색인 · reverify 확장(비-F kind · drift→자동 재등록) · 신규역량(MCP/API·시맨틱검색·proof-chain export·auto-edge 추론·atlas diff)
