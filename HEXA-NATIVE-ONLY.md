...
- RFC 032 — `farr_matmul` native builtin (`docs/rfc/rfc_drafts_2026_05_12/rfc_032_farr_matmul_native_builtin.md`)
- RFC 033 — `farr_copy` + Gaussian noise (`docs/rfc/rfc_drafts_2026_05_12/rfc_033_farr_copy_and_gaussian.md`)
