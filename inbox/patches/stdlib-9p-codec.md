...
> **Status: resolved-#468 (umbrella) · MVP applied 2026-05-14 · VERIFIED-CLOSED 2026-05-20** — 9P2000.L wire codec ships on disk at `self/stdlib/p9/{codec,client,server}.hexa` (codec.hexa 16,980B · server.hexa 7,457B · client.hexa 3,872B). Umbrella PR #468 (`docs(inbox): stdlib-for-cpu-port umbrella — all 5 sub-patches landed`) merged 2026-05-23. This inbox entry is archived — no further fix cycle needed. v2 surface (Attacher/Session traits · `serve_attacher` loop · 9P2000.L extras) tracked separately if/when downstream demands.
