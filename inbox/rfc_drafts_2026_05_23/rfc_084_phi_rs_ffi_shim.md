...
kind: rfc_draft
filed_from: dancinlab/anima (HEXAD/LIFE 23+ H 가설 공통 blocker) + inbox/rfc_drafts_2026_05_12/phi-rs-rust-ffi-shim.md
filed_at: 2026-05-24
priority: high
status: proposed
promoted_from: inbox/rfc_drafts_2026_05_12/phi-rs-rust-ffi-shim.md (proposal-tier)
supersedes_blocker_in:
  - inbox/rfc_drafts_2026_05_12/rfc_036_phi_rs_rust_ffi.md (named blocker · numeric core LANDED, FFI part OPEN)
  - inbox/rfc_drafts_2026_05_12/phi-rs-rust-ffi-shim.md (proposal-tier, option A/B/C survey)
unblocks:
...
- **Source**: `inbox/rfc_drafts_2026_05_12/phi-rs-rust-ffi-shim.md` (proposal-tier) 의 option A 만 정식 promote
...
RFC 036 (`inbox/rfc_drafts_2026_05_12/rfc_036_phi_rs_rust_ffi.md`) 은 두 part 로 명시적 분리되어 있고:
...
5/5 PASS → RFC 084 land · `inbox/rfc_drafts_2026_05_12/phi-rs-rust-ffi-shim.md` CLOSE · RFC 036 part 2 의 `F-RFC036-FFI-LIVE` (named-but-not-claimed) 가 본 RFC 의 F-084-4 로 동시에 닫힘.
...
- `inbox/rfc_drafts_2026_05_12/phi-rs-rust-ffi-shim.md` (proposal-tier · 본 RFC source)
- `inbox/rfc_drafts_2026_05_12/rfc_036_phi_rs_rust_ffi.md` (RFC 036 — numeric core LANDED, FFI part NAMED BLOCKER)
