...
filed: 2026-05-24
related_patch: inbox/patches/cah6-dft-phonon-sternheimer-nan-wall-2026-05-24.md
related_rfc:   inbox/rfc_drafts_2026_05_24/rfc_088_hexa_cloud_preflight.md
...
- `stdlib/cloud/cloud_cli.hexa` grep: `preflight` keyword 미존재 (cycle
  12 발언 confirm).
- `inbox/rfc_drafts_2026_05_24/rfc_088_hexa_cloud_preflight.md` 본문
