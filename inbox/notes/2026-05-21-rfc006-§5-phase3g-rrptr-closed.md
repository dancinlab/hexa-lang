...
**Predecessor**: PR #247 (Phase 3f intra-iter SSA), PR #250 (T74 minimum-shape falsifier),
  inbox/patches/yosys-rr-ptr-cross-iteration-comb-loop.md (commit `f4283ac2`)
...
memwr emit (see `inbox/notes/2026-05-20-rfc006-§5-tier1-e-fifo-mem-2d-memwr.md`)
...
- inbox/notes/2026-05-20-rfc006-§5-tier1-e-fifo-mem-2d-memwr.md — the new
