...
CC0-1.0 licensing makes verbatim copy frictionless. Add a header comment pointing to upstream provenance per `inbox/notes/2026-05-12-atlas-n6-absorption-session.md` precedent.
...
- `inbox/notes/2026-05-12-atlas-n6-absorption-session.md` — prior absorption of the corpus itself (rodata). This plan continues from there.
