...
9-shape sweep (`inbox/fires/rfc067_ptma_swizzle128_2026_05_22/result.json`,
...
`inbox/rfc_drafts_2026_05_20/rfc_068_mixed_precision_mir_layer.md` 로 점유됨.
...
**산출물 (구현 cycle):** `inbox/fires/rfc076_adaptive_tile_*/` 에
...
- RFC 067 N201 (`inbox/fires/rfc067_ptma_swizzle128_2026_05_22/`) --
