...
priority: high
status: proposed
promoted_from: inbox/rfc_drafts_2026_05_20/rfc_070_hexa_ld_dlopen_shared.md (g7-d-scaffold)
unblocks:
...
- **Source**: `inbox/rfc_drafts_2026_05_20/rfc_070_hexa_ld_dlopen_shared.md` (status `g7-d-scaffold`) + `inbox/patches/g7-hexa-ld-dlopen.md` (opened 2026-05-10)
...
- **`inbox/rfc_drafts_2026_05_20/rfc_070_hexa_ld_dlopen_shared.md`** — 본 RFC 가 promote 하는 원본
  ...
  c_ffi 경계 명확화 layer.
- **`inbox/patches/g7-hexa-ld-dlopen.md`** — opened 2026-05-10, status `rfc-promoted 2026-05-20 (RFC 070)`.
  원본 spec.
...
- **RFC 084 (`rfc_084_phi_rs_ffi_shim`, `inbox/rfc_drafts_2026_05_23/`)** — phi_rs option A =
