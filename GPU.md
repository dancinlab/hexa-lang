...
g3 caveats:
- **WALL clause (b) is DEFERRED, NOT WON.** Round 1 proved structural ≠ wall; only a real timed silicon fire settles the ≥30% wall. The verdict tier this round is 🔵 SUPPORTED-FORMAL for the codegen/structural clause only; the wall is the round-3 §finding.
