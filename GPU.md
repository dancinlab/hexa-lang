...
- **Silicon-fires**: **14** total = 13 on Nvidia RTX 5070 sm_120 (PR #82 FP64 + #189 f16 + #190 unroll byte-eq + #191 wmma single-tile + #203 bf16 + #205 wmma multi-K-tile + #206 wmma 16-warp grid + #207 wmma cp.async pipelined + #213 tf32 + **#222 n=6 hex-fabric** + **2026-05-25 F-FUSION-ATTENTION-FLASH fused attention vs cuBLAS, 4-shape timed wall** + **F-FUSION-LAUNCH-AMORT-WALL 5-size timed wall 73–76% faster → §10 moat box flip (PR #1028)** + **F-FUSION-ATTN-WMMA-WALL 4-size timed wall 🔴 9.4–15.5× slower, single-CTA closed-negative**) + **1 on Apple M3 GPU (RFC 075 Metal P4, 2026-05-21)** — first Mac silicon-fire, byte-eq 1024-cell vec-add
