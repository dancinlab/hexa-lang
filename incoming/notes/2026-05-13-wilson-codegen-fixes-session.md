...
**Date:** 2026-05-13.
**Scope:** 3 codegen bugs filed by wilson (`incoming/patches/wilson-build-broken-pool-openai-compat.md`,
`incoming/patches/wilson-fn-arena-escapes-on-push.md`). Verified with minimal repros and
