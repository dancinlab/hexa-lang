...
**Companion artifacts:**
- `incoming/poc/static_index_lazy_v0.hexa` (263 LOC PoC, Option A)
- `incoming/poc/static_index_lazy_v0_fixture.n6` (62 LOC, 51-node fixture)
...
`incoming/poc/static_index_lazy_v0.hexa` implements the recommended
shape, end-to-end:
