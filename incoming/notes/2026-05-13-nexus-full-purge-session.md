...
- incoming/notes/* incoming/patches/* (external sessions)
...
the 37-file active set (excluding incoming/, state/, .gen.hexa, etc.). 277
...
- NEXUS_* identifiers in active code (excl. incoming/state/.gen.hexa/
