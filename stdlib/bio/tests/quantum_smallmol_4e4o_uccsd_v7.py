#!/usr/bin/env python3
"""
quantum_smallmol_4e4o_uccsd_v7.py — Phase β #4 (v7 follow-up 2026-05-11).

7 small-mol (hd6/clc1/mfn2 cohort × orig+alt) → 4e/4o UCCSD + ParityMapper
+ SLSQP VQE. §12.2.c 의 2e/2o → §12.2.e 4e/4o generalization 검증
(active-space 의존도 평가).
...
def main() -> int:
    ...
    print(f"# §12.2.e small-mol cohort × orig+alt 4e/4o UCCSD ({len(geoms)} entry)\n")
    results = []
