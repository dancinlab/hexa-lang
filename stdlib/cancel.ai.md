...
**Driver**: wilson core port G3 prereq (`archive/patches/PATCHES.yaml#wilson-pi-port-6-gap-prereq`)
...
- `archive/patches/PATCHES.yaml#wilson-pi-port-6-gap-prereq` — wilson core port entry; G3 = this module.
