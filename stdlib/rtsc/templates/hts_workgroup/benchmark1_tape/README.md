...
### License-block evidence (2026-05-21 re-verify)

Three pages re-fetched on 2026-05-21 to triple-check before any vendor attempt:

| page | verbatim block found | explicit license? |
|---|---|---|
| https://htsmodelling.com/benchmark-1/ | `© 2026 HTS MODELLING WORKGROUP` | **none** |
| https://htsmodelling.com/model-files/ | `© 2026 HTS MODELLING WORKGROUP` | **none** |
| https://htsmodelling.com/?page_id=748 | `© 2026 HTS MODELLING WORKGROUP` | **none** |

No `LICENSE` file. No "All rights reserved." No CC-BY / MIT / Apache / GPL / public-domain declaration. Default copyright law applies → redistribution unsafe → SKIP (per demiurge g3, RTSC.md §4.2 Axis E honest stance). Provenance manifest only.

Cross-verified by: `exports/material_sim/benchmark1_tape/2026-05-21T10-43-28Z/material_sim_benchmark1_tape_20260521T104328Z.json` (`gate_type=license-unclear`, `absorbed=false`).
