...
> **Inbox source**: `archive/patches/rfc020-enum-payload-variants.md` — F agent (`bfda8c9b`) **punted decisions (3) + (4)**: "B2 multi-cycle scope … 별도 RFC drafting 후 진행", "C1 multi-field 디자인 — positional vs labeled vs tuple — 1차 정착 후 별도 RFC"
...
2026-05-20 RFC-074 decision-lock
  ...
  Cross-link             : archive/patches/rfc020-enum-payload-variants.md (B2+C1 rows updated)
