...
- **Source**: HEXA-LANG.md "Deferred RFC 사이클" 후보 3 · `archive/patches/websocket-streaming-client-websocat-dependency`
...
- **rfc_083_impl_g** — `archive/patches/websocket-streaming-client-websocat-dependency` CLOSE
...
- `archive/patches/websocket-streaming-client-websocat-dependency`
