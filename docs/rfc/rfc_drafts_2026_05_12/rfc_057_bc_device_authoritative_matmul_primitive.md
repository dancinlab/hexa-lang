...
- RFC 056 spec `docs/rfc/rfc_drafts_2026_05_12/rfc_056_*.md` §6.1 §6.2 §8.2
...
- AGENTS.tape `g7` — RFC-first (verified oracle + d=32 겸용 primitive 건드림); `docs/rfc/rfc_drafts_2026_05_12/` 보관
