...
status: proposed
promoted_from:
  - docs/rfc/rfc_drafts_2026_05_20/rfc_063_target_firmware_codegen.md  # @target(firmware)
  - docs/rfc/rfc_drafts_2026_05_20/rfc_064_target_rtl_codegen.md       # @target(rtl)
unblocks:
...
- **Severity**: HIGH (FIRMWARE.md §1 금지 규칙의 enabler · `.c`/`.s`/`.v`/`.sv`/`.vhd` authored-as-X
  의 hexa-source 대체)
- **Source**:
  - `docs/rfc/rfc_drafts_2026_05_20/rfc_063_target_firmware_codegen.md` (status `DRAFT (scaffolded, codegen pending)`)
  - `docs/rfc/rfc_drafts_2026_05_20/rfc_064_target_rtl_codegen.md` (status `DRAFT (scaffolded, codegen pending)`)
...
> (`docs/rfc/rfc_drafts_2026_05_20/rfc_063_target_firmware_codegen.md` · 미구현). 동일하게 RFC 064
...
원본 draft (`docs/rfc/rfc_drafts_2026_05_20/rfc_063_target_firmware_codegen.md`) §2-§7 을 그대로
inherit:
...
원본 draft (`docs/rfc/rfc_drafts_2026_05_20/rfc_064_target_rtl_codegen.md`) §2-§7 을 그대로
inherit:
...
- `docs/rfc/rfc_drafts_2026_05_20/rfc_063_target_firmware_codegen.md` (원본 firmware draft)
- `docs/rfc/rfc_drafts_2026_05_20/rfc_064_target_rtl_codegen.md` (원본 rtl draft)
- `docs/rfc/rfc_drafts_2026_05_24/rfc_089_ld_shared_dlopen.md` (sibling promote — runtime
  extension lane)
