...
- **Date**: 2026-05-24
- **Source**:
  - `archive/patches/macro-expander-pass-design.md` (Phase 1 stub, PR #451 merged)
  - `archive/patches/macro-expander-pass-design-detailed.md` (Phase 1 detailed, PR #451 merged)
  - `archive/patches/macro-expander-phase2-rfc.md` (Phase 2 inbox patch, PR #493 open)
...
| PR #451 (`fcb265e3`) | `archive/patches/macro-expander-pass-design{,-detailed}.md` | Phase 1 design doc (97+290줄) — 본 RFC §2 알고리즘의 reference |
| PR #462 (`2a9f8028`) | `self/parser.hexa:3278-3340` | Phase 1 intrinsics 구현 — 본 RFC §3 의 intrinsic table 이 이를 흡수 |
| PR #493 (open) | `archive/patches/macro-expander-phase2-rfc.md` (`bbe61b7c`) | Phase 2 inbox patch — 본 RFC 가 정식 promote |
...
| `archive/patches/macro-expander-pass-design-detailed.md` §8 | 4-phase 로드맵 표 | 본 RFC §6 phasing 의 baseline |
...
- `archive/patches/macro-expander-pass-design.md` — Phase 1 stub
- `archive/patches/macro-expander-pass-design-detailed.md` — Phase 1 detailed
- `archive/patches/macro-expander-phase2-rfc.md` — Phase 2 inbox patch
...
expander-phase2-stack` (Phase 2a-2e merged), `archive/patches/macro-expander-
