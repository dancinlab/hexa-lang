...
authors:
  - dancinlab
supersedes:
  - docs/rfc/rfc_drafts_2026_05_20/rfc_066_atlas_memcap_unblock.md
unblocks:
...
원안 **RFC 066** (`docs/rfc/rfc_drafts_2026_05_20/rfc_066_atlas_memcap_unblock.md`)
...
- [ ] approved → 파일이 `archive/patches/rfc_landed/` 로 이동 + B-1 (pool 재배포) 트리거
