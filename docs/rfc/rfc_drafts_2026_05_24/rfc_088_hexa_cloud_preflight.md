...
unblocks:
  ...
  - gap_cloud_typed_env
related:
  - docs/notes/2026-05-21-hexa-cloud-optimizer-mem-budget-preflight.md (source gap)
  - docs/notes/2026-05-21-hexa-cloud-typed-env-var-passing.md (source gap)
  - archive/patches/hexa-cloud-subcommand.md (cycle C preflight verb claim — source mismatch)
  - docs/rfc/rfc_drafts_2026_05_24/rfc_085_dispatcher_hygiene.md (sibling — dispatcher cleanup; if numbering shifts the link should follow `dispatcher hygiene` SSOT)
...
**신호 없는 비용**으로 소진된다. 두 gap 모두 `docs/notes/2026-05-21-*` 에
...
anima S187 3B grid 사건 (`docs/notes/2026-05-21-hexa-cloud-optimizer-mem-budget-preflight.md`)
에서 9차례 OOM 이 발생했다:
...
S187 attempt 7–8 (`docs/notes/2026-05-21-hexa-cloud-typed-env-var-passing.md`)
...
> 부가: `archive/patches/hexa-cloud-subcommand.md` 가 "cycle C 에서 preflight verb
