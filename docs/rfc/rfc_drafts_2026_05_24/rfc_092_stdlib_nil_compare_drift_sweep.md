...
related:
  ...
  - docs/notes/2026-05-24-stdlib-fs-nil-parser-reject-drift.md (원본 finding · 워크어라운드 검증)
...
PR #618 + docs/notes/2026-05-24-stdlib-fs-nil-parser-reject-drift.md 에서
검증된 1:1 매핑:
...
```
docs/notes/2026-05-24-stdlib-fs-nil-parser-reject-drift.md §재현 의 4 verdict 모두
재현되어야 한다.
