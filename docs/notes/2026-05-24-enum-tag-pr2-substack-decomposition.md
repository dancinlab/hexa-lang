...
**SSOT**: archive/patches/enum-to-string-codegen-emit.md · PR #553 (cycle 3 fail-honest decompose) · PR #555 (PR-1 names emit) · 본 PR (PR-2.0)
**Branch**: `fix/codegen-enum-tag-enum-pr2-2026-05-24`

## 배경

원본 3-PR 스택 권장 (`archive/patches/enum-to-string-codegen-emit.md`):
...
- archive/patches/enum-to-string-codegen-emit.md (원본 3-PR 권장)
