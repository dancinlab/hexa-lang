...
**Predecessor**: `archive/patches/yosys-fifo-mem-2d-array-memwr-emit.md` (Option A landed)
...
- `archive/patches/yosys-fifo-mem-2d-array-memwr-emit.md` (Option A landed `c4b35b13`)
