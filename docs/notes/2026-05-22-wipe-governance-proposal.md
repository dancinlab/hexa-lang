...
# Background: see docs/notes/2026-05-22-wipe-governance-proposal.md
...
echo ""
echo "Background: docs/notes/2026-05-22-wipe-governance-proposal.md"
echo "------------------------------------------------------------"
exit 1
```
...
1. **THIS file** (proposal, docs/notes) — landed now, this audit cycle.
