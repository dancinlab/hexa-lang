...
static HexaVal _hexa_to_string_rec(HexaVal v, int depth) {
    ...
    switch (HX_TAG(v)) {
        ...
        case TAG_ARRAY: {
            ...
            // hexa source. NULL-ptr + depth guards stay C (cheap, and the
            // hexa body assumes a live arr_ptr). rt_to_string_array owns
            // the element loop / cap / overflow-trailer; nested arrays/maps
            // recurse within hexa, scalars dispatch back to hexa_to_string.
        ...
        case TAG_MAP: {
            ...
            // the keys()/get() traversal + cap + overflow-trailer.
