// array_typed_leaf_x86_64.s — FROZEN BOOTSTRAP SEED (RT-NATIVE — array typed-leaf i64 DISPATCH).
// GENERATED: tool/regen_array_typed_leaf_native_s.sh — aprime_cc _drv.hexa --emit=asm
//   --target=x86_64-linux-gnu -o array_typed_leaf_x86_64.s stdlib/runtime/array_typed_leaf.hexa.
...
.L360b_hexa_arr_i64_new_seed_bb0:
    ...
    jz .L360b_hexa_arr_i64_new_seed_bb2 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_new_seed_bb1 # jump -> then
.L360b_hexa_arr_i64_new_seed_bb1:
    mov r13, 1 # assign L2
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 200], r11 # store tag L2
    jmp .L360b_hexa_arr_i64_new_seed_bb2 # branch
.L360b_hexa_arr_i64_new_seed_bb2:
    ...
    jz .L360b_hexa_arr_i64_new_seed_bb4 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_new_seed_bb3 # jump -> then
.L360b_hexa_arr_i64_new_seed_bb3:
    ...
    jmp .L360b_hexa_arr_i64_new_seed_bb4 # branch
.L360b_hexa_arr_i64_new_seed_bb4:
    ...
    test r10, r10 # br_cond test
    jz .L360b_hexa_arr_i64_new_seed_bb6 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_new_seed_bb5 # jump -> then
.L360b_hexa_arr_i64_new_seed_bb5:
    lea rsi, [rip+.LCstr0] # hv arg payload: &str .LCstr0
    mov rdi, 3 # hv arg tag = TAG_STR
    call hexa_throw # call hexa_throw
    ...
    jmp .L360b_hexa_arr_i64_new_seed_bb6 # branch
.L360b_hexa_arr_i64_new_seed_bb6:
    mov r10, [rbp - 64] # reload L6 from spill slot
    mov r10, r10 # hv payload
    mov r11, 0 # hv payload
...
.L360b_hexa_arr_i64_push_seed_bb0:
    mov r11, 0 # hv payload
    mov r10, rbx # hv payload
    add r10, r11 # __hx_payload_add: r10 = a.pl add b.pl
    ...
    test r10, r10 # br_cond test
    jz .L360b_hexa_arr_i64_push_seed_bb2 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_push_seed_bb1 # jump -> then
.L360b_hexa_arr_i64_push_seed_bb1:
    ...
    test r10, r10 # br_cond test
    jz .L360b_hexa_arr_i64_push_seed_bb4 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_push_seed_bb3 # jump -> then
.L360b_hexa_arr_i64_push_seed_bb2:
    mov r10, r14 # hv payload
    mov r11, 0 # hv payload
    add r10, r11 # __hx_ptr_load64: addr = ptr + off
    mov r10, qword ptr [r10] # __hx_ptr_load64: r10 = *(addr)
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L360b_hexa_arr_i64_push_seed_bb3:
    ...
    jmp .L360b_hexa_arr_i64_push_seed_bb4 # branch
.L360b_hexa_arr_i64_push_seed_bb4:
    mov r10, r14 # hv payload
    mov r11, 0 # hv payload
    ...
    jmp .L360b_hexa_arr_i64_push_seed_bb2 # branch
...
hexa_arr_i64_len_seed:
    ...
    mov rbx, rsi # ingress param payload
.L360b_hexa_arr_i64_len_seed_bb0:
    mov r11, 0 # hv payload
    mov r10, rbx # hv payload
    add r10, r11 # __hx_payload_add: r10 = a.pl add b.pl
    mov r12, r10 # leaf: payload → dst L1
...
hexa_arr_i64_box_seed:
    ...
    mov r12, rcx # ingress param payload
.L360b_hexa_arr_i64_box_seed_bb0:
    mov r11, 0 # hv payload
    mov r10, rbx # hv payload
    add r10, r11 # __hx_payload_add: r10 = a.pl add b.pl
    mov r13, r10 # leaf: payload → dst L2
    ...
    test r10, r10 # br_cond test
    jz .L360b_hexa_arr_i64_box_seed_bb2 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_box_seed_bb1 # jump -> then
.L360b_hexa_arr_i64_box_seed_bb1:
    ...
    mov r10, rdx # hv: unbox user-call result payload
    mov [rbp - 96], r10 # spill L10 to slot
    jmp .L360b_hexa_arr_i64_box_seed_bb2 # branch
.L360b_hexa_arr_i64_box_seed_bb2:
    ...
    test r10, r10 # br_cond test
    jz .L360b_hexa_arr_i64_box_seed_bb4 # jump-if-zero -> else
    jmp .L360b_hexa_arr_i64_box_seed_bb3 # jump -> then
.L360b_hexa_arr_i64_box_seed_bb3:
    lea rsi, [rip+.LCstr2] # hv arg payload: &str .LCstr2
    mov rdi, 3 # hv arg tag = TAG_STR
    call hexa_throw # call hexa_throw
    ...
    mov r10, rdx # hv: unbox user-call result payload
    mov [rbp - 120], r10 # spill L13 to slot
    jmp .L360b_hexa_arr_i64_box_seed_bb4 # branch
.L360b_hexa_arr_i64_box_seed_bb4:
    mov r10, r14 # hv payload
    mov r11, 0 # hv payload
    add r10, r11 # __hx_ptr_load64: addr = ptr + off
    mov r10, qword ptr [r10] # __hx_ptr_load64: r10 = *(addr)
