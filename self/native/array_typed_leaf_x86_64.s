...
//   ABI: ELF, no underscore. External U-floor: malloc realloc write hexa_exit hexa_int hexa_throw (libc-bearing: realloc grow dissolves the
...
# source: /tmp/arr_flip/stdlib/runtime/array_typed_leaf.hexa
.intel_syntax noprefix
.file 1 "stdlib/runtime/array_typed_leaf.hexa"
.text
.globl hexa_arr_i64_new
.hidden hexa_arr_i64_new
    .p2align 4
hexa_arr_i64_new:
    .loc 1 62 0
...
.L6cf9_hexa_arr_i64_new_bb0:
    ...
    jz .L6cf9_hexa_arr_i64_new_bb2 # jump-if-zero -> else
    jmp .L6cf9_hexa_arr_i64_new_bb1 # jump -> then
.L6cf9_hexa_arr_i64_new_bb1:
    mov r12, 1 # assign L1
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 136], r11 # store tag L1
    jmp .L6cf9_hexa_arr_i64_new_bb2 # branch
.L6cf9_hexa_arr_i64_new_bb2:
    ...
    ret # return
.globl hexa_arr_i64_push
.hidden hexa_arr_i64_push
    .p2align 4
hexa_arr_i64_push:
    .loc 1 76 0
    push rbp # prologue: save rbp
...
.L6cf9_hexa_arr_i64_push_bb0:
    ...
    jz .L6cf9_hexa_arr_i64_push_bb2 # jump-if-zero -> else
    jmp .L6cf9_hexa_arr_i64_push_bb1 # jump -> then
.L6cf9_hexa_arr_i64_push_bb1:
    ...
    test r10, r10 # br_cond test
    jz .L6cf9_hexa_arr_i64_push_bb4 # jump-if-zero -> else
    jmp .L6cf9_hexa_arr_i64_push_bb3 # jump -> then
.L6cf9_hexa_arr_i64_push_bb2:
    mov r10, r14 # hv payload
    mov r11, 0 # hv payload
    add r10, r11 # __hx_ptr_load64: addr = ptr + off
    mov r10, qword ptr [r10] # __hx_ptr_load64: r10 = *(addr)
...
.L6cf9_hexa_arr_i64_push_bb3:
    ...
    jmp .L6cf9_hexa_arr_i64_push_bb4 # branch
.L6cf9_hexa_arr_i64_push_bb4:
    mov r10, r14 # hv payload
    mov r11, 0 # hv payload
    ...
    jmp .L6cf9_hexa_arr_i64_push_bb2 # branch
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.globl hexa_arr_i64_len
.hidden hexa_arr_i64_len
    .p2align 4
hexa_arr_i64_len:
    .loc 1 102 0
    push rbp # prologue: save rbp
...
.L6cf9_hexa_arr_i64_len_bb0:
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.globl hexa_arr_i64_box
.hidden hexa_arr_i64_box
    .p2align 4
hexa_arr_i64_box:
    .loc 1 110 0
    push rbp # prologue: save rbp
...
.L6cf9_hexa_arr_i64_box_bb0:
    ...
    test r10, r10 # br_cond test
    jz .L6cf9_hexa_arr_i64_box_bb2 # jump-if-zero -> else
    jmp .L6cf9_hexa_arr_i64_box_bb1 # jump -> then
.L6cf9_hexa_arr_i64_box_bb1:
    ...
    mov r10, rdx # hv: unbox user-call result payload
    mov [rbp - 80], r10 # spill L8 to slot
    jmp .L6cf9_hexa_arr_i64_box_bb2 # branch
.L6cf9_hexa_arr_i64_box_bb2:
    ...
    test r10, r10 # br_cond test
    jz .L6cf9_hexa_arr_i64_box_bb4 # jump-if-zero -> else
    jmp .L6cf9_hexa_arr_i64_box_bb3 # jump -> then
.L6cf9_hexa_arr_i64_box_bb3:
    lea rsi, [rip+.LCstr1] # hv arg payload: &str .LCstr1
    mov rdi, 3 # hv arg tag = TAG_STR
    call hexa_throw # call hexa_throw
    ...
    mov r10, rdx # hv: unbox user-call result payload
    mov [rbp - 104], r10 # spill L11 to slot
    jmp .L6cf9_hexa_arr_i64_box_bb4 # branch
.L6cf9_hexa_arr_i64_box_bb4:
    mov r10, r14 # hv payload
    mov r11, 0 # hv payload
    add r10, r11 # __hx_ptr_load64: addr = ptr + off
    mov r10, qword ptr [r10] # __hx_ptr_load64: r10 = *(addr)
    ...
    mov rsi, [rbp - 152] # reload L17 from spill slot
    mov rsi, rsi # hv arg payload
    mov rdi, [rbp - 304] # tag L17 from tag-slot
    call hexa_int # call hexa_int
    mov [rbp - 312], rax # store tag L18
    mov r10, rdx # hv: unbox user-call result payload
    mov [rbp - 160], r10 # spill L18 to slot
