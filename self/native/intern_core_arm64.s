// intern_core_arm64.s — FROZEN BOOTSTRAP SEED (RT-NATIVE leg B M4 INTERN-R1).
// GENERATED: tool/regen_intern_core_native_s.sh — aprime_cc _drv.hexa --emit=asm
//   --target=arm64-apple-darwin -o intern_core_arm64.s stdlib/runtime/intern_core.hexa.
...
//   ABI: Mach-O, _rt_intern_*_native underscore-prefixed. External: none (rt_intern_strcmp0_native is local).
...
.globl _rt_intern_strcmp0_native
.private_extern _rt_intern_strcmp0_native
    .p2align 2
_rt_intern_strcmp0_native:
    .loc 1 48 0
...
__Le37b_rt_intern_strcmp0_native_bb0:
    ...
    b __Le37b_rt_intern_strcmp0_native_bb1 ; branch
__Le37b_rt_intern_strcmp0_native_bb1:
    ...
    cbz x0, __Le37b_rt_intern_strcmp0_native_bb3 ; br_cond: !truthy -> else
    b __Le37b_rt_intern_strcmp0_native_bb2 ; branch -> then
__Le37b_rt_intern_strcmp0_native_bb2:
    ldp x0, x1, [sp, #64] ; hv load L4
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    cmp x1, x3 ; __hx_payload_eq: cmp payloads
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __Le37b_rt_intern_strcmp0_native_bb5 ; br_cond: !truthy -> else
    b __Le37b_rt_intern_strcmp0_native_bb4 ; branch -> then
__Le37b_rt_intern_strcmp0_native_bb3:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add sp, sp, #208 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Le37b_rt_intern_strcmp0_native_bb4:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add sp, sp, #208 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Le37b_rt_intern_strcmp0_native_bb5:
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_intern_find_native
.private_extern _rt_intern_find_native
    .p2align 2
_rt_intern_find_native:
    .loc 1 72 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
...
__Le37b_rt_intern_find_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    b __Le37b_rt_intern_find_native_bb1 ; branch
__Le37b_rt_intern_find_native_bb1:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __Le37b_rt_intern_find_native_bb3 ; br_cond: !truthy -> else
    b __Le37b_rt_intern_find_native_bb2 ; branch -> then
__Le37b_rt_intern_find_native_bb2:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __Le37b_rt_intern_find_native_bb5 ; br_cond: !truthy -> else
    b __Le37b_rt_intern_find_native_bb4 ; branch -> then
__Le37b_rt_intern_find_native_bb3:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Le37b_rt_intern_find_native_bb4:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Le37b_rt_intern_find_native_bb5:
    ldp x0, x1, [sp, #256] ; hv load L16
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __Le37b_rt_intern_find_native_bb7 ; br_cond: !truthy -> else
    b __Le37b_rt_intern_find_native_bb6 ; branch -> then
__Le37b_rt_intern_find_native_bb6:
    ldp x0, x1, [sp, #384] ; hv load L24
    ldp x2, x3, [sp, #64] ; hv load L4
    bl _rt_intern_strcmp0_native ; call rt_intern_strcmp0_native
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __Le37b_rt_intern_find_native_bb9 ; br_cond: !truthy -> else
    b __Le37b_rt_intern_find_native_bb8 ; branch -> then
__Le37b_rt_intern_find_native_bb7:
    ldp x0, x1, [sp, #256] ; hv load L16
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #272] ; hv store L17
    b __Le37b_rt_intern_find_native_bb1 ; branch
__Le37b_rt_intern_find_native_bb8:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Le37b_rt_intern_find_native_bb9:
    b __Le37b_rt_intern_find_native_bb7 ; branch
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
    add sp, sp, #768 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
