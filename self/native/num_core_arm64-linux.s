// num_core_arm64-linux.s — FROZEN BOOTSTRAP SEED (RT-NATIVE leg B M4 NUM — sh-num-native).
// GENERATED: tool/regen_num_core_native_s.sh — aprime_cc _drv.hexa --emit=asm
//   --target=arm64-linux-gnu -o num_core_arm64-linux.s stdlib/runtime/num_core.hexa.
...
//   ABI: ELF aarch64, rt_parse_int_native no underscore. External: NONE (fully self-contained).
...
// source: stdlib/runtime/num_core.hexa
...
_Ldd24_rt_parse_int_native_bb0:
    ...
    b _Ldd24_rt_parse_int_native_bb1 // branch
_Ldd24_rt_parse_int_native_bb1:
    ...
    cbz x0, _Ldd24_rt_parse_int_native_bb3 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb2 // branch -> then
_Ldd24_rt_parse_int_native_bb2:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb5 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb4 // branch -> then
_Ldd24_rt_parse_int_native_bb3:
    ldp x0, x1, [sp, #32] // hv load L2
    ldp x2, x3, [sp, #48] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb8 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb7 // branch -> then
_Ldd24_rt_parse_int_native_bb4:
    ...
    stp x0, x1, [sp, #48] // hv store L3
    b _Ldd24_rt_parse_int_native_bb6 // branch
_Ldd24_rt_parse_int_native_bb5:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    stp x0, x1, [sp, #64] // hv store L4
    b _Ldd24_rt_parse_int_native_bb6 // branch
_Ldd24_rt_parse_int_native_bb6:
    b _Ldd24_rt_parse_int_native_bb1 // branch
_Ldd24_rt_parse_int_native_bb7:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #352] // hv store L22
    b _Ldd24_rt_parse_int_native_bb11 // branch
_Ldd24_rt_parse_int_native_bb8:
    ldp x0, x1, [sp, #352] // hv load L22
    movz x2, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb10 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb9 // branch -> then
_Ldd24_rt_parse_int_native_bb9:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    stp x0, x1, [sp, #368] // hv store L23
    ldp x0, x1, [sp, #48] // hv load L3
    ...
    stp x0, x1, [sp, #352] // hv store L22
    b _Ldd24_rt_parse_int_native_bb10 // branch
_Ldd24_rt_parse_int_native_bb10:
    b _Ldd24_rt_parse_int_native_bb11 // branch
_Ldd24_rt_parse_int_native_bb11:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb13 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb12 // branch -> then
_Ldd24_rt_parse_int_native_bb12:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb15 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb14 // branch -> then
_Ldd24_rt_parse_int_native_bb13:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb17 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb16 // branch -> then
_Ldd24_rt_parse_int_native_bb14:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    stp x0, x1, [sp, #352] // hv store L22
    b _Ldd24_rt_parse_int_native_bb15 // branch
_Ldd24_rt_parse_int_native_bb15:
    b _Ldd24_rt_parse_int_native_bb13 // branch
_Ldd24_rt_parse_int_native_bb16:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #52428 // imm 0-15
    movk x1, #52428, lsl #16 // imm 16-31
    movk x1, #52428, lsl #32 // imm 32-47
    ...
    add x15, sp, #800 // hv frame base
    stp x0, x1, [x15] // hv store L50
    b _Ldd24_rt_parse_int_native_bb17 // branch
_Ldd24_rt_parse_int_native_bb17:
    add x15, sp, #512 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb19 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb18 // branch -> then
_Ldd24_rt_parse_int_native_bb18:
    ldp x0, x1, [sp, #368] // hv load L23
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    cmp x1, x3 // __hx_payload_eq: cmp payloads
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb21 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb20 // branch -> then
_Ldd24_rt_parse_int_native_bb19:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    ...
    b _Ldd24_rt_parse_int_native_bb23 // branch
_Ldd24_rt_parse_int_native_bb20:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    add x15, sp, #800 // hv frame base
    stp x0, x1, [x15] // hv store L50
    b _Ldd24_rt_parse_int_native_bb22 // branch
_Ldd24_rt_parse_int_native_bb21:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // imm 0-15
    ...
    stp x0, x1, [x15] // hv store L50
    b _Ldd24_rt_parse_int_native_bb22 // branch
_Ldd24_rt_parse_int_native_bb22:
    b _Ldd24_rt_parse_int_native_bb19 // branch
_Ldd24_rt_parse_int_native_bb23:
    add x15, sp, #960 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb25 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb24 // branch -> then
_Ldd24_rt_parse_int_native_bb24:
    ldp x0, x1, [sp, #32] // hv load L2
    ldp x2, x3, [sp, #48] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb27 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb26 // branch -> then
_Ldd24_rt_parse_int_native_bb25:
    add x15, sp, #928 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb43 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb42 // branch -> then
_Ldd24_rt_parse_int_native_bb26:
    add x15, sp, #1008 // hv frame base
    ldp x0, x1, [x15] // hv load L63
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #48 // hv const_int val
    ...
    add x15, sp, #1040 // hv frame base
    stp x0, x1, [x15] // hv store L65
    b _Ldd24_rt_parse_int_native_bb35 // branch
_Ldd24_rt_parse_int_native_bb27:
    add x15, sp, #512 // hv frame base
    ldp x0, x1, [x15] // hv load L32
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #16 // hv const_int val
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb29 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb28 // branch -> then
_Ldd24_rt_parse_int_native_bb28:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb31 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb30 // branch -> then
_Ldd24_rt_parse_int_native_bb29:
    b _Ldd24_rt_parse_int_native_bb35 // branch
_Ldd24_rt_parse_int_native_bb30:
    add x15, sp, #1008 // hv frame base
    ldp x0, x1, [x15] // hv load L63
    movz x2, #0 // hv const_int: TAG_INT
    ...
    add x15, sp, #1040 // hv frame base
    stp x0, x1, [x15] // hv store L65
    b _Ldd24_rt_parse_int_native_bb34 // branch
_Ldd24_rt_parse_int_native_bb31:
    add x15, sp, #1408 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb33 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb32 // branch -> then
_Ldd24_rt_parse_int_native_bb32:
    add x15, sp, #1008 // hv frame base
    ldp x0, x1, [x15] // hv load L63
    movz x2, #0 // hv const_int: TAG_INT
    ...
    add x15, sp, #1040 // hv frame base
    stp x0, x1, [x15] // hv store L65
    b _Ldd24_rt_parse_int_native_bb33 // branch
_Ldd24_rt_parse_int_native_bb33:
    b _Ldd24_rt_parse_int_native_bb34 // branch
_Ldd24_rt_parse_int_native_bb34:
    b _Ldd24_rt_parse_int_native_bb29 // branch
_Ldd24_rt_parse_int_native_bb35:
    add x15, sp, #1040 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb37 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb36 // branch -> then
_Ldd24_rt_parse_int_native_bb36:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #960 // hv frame base
    stp x0, x1, [x15] // hv store L60
    b _Ldd24_rt_parse_int_native_bb41 // branch
_Ldd24_rt_parse_int_native_bb37:
    add x15, sp, #784 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb39 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb38 // branch -> then
_Ldd24_rt_parse_int_native_bb38:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #944 // hv frame base
    stp x0, x1, [x15] // hv store L59
    b _Ldd24_rt_parse_int_native_bb40 // branch
_Ldd24_rt_parse_int_native_bb39:
    add x15, sp, #912 // hv frame base
    ldp x0, x1, [x15] // hv load L57
    add x15, sp, #512 // hv frame base
    ...
    stp x0, x1, [x15] // hv store L57
    b _Ldd24_rt_parse_int_native_bb40 // branch
_Ldd24_rt_parse_int_native_bb40:
    add x15, sp, #928 // hv frame base
    ldp x0, x1, [x15] // hv load L58
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    ...
    stp x0, x1, [sp, #48] // hv store L3
    b _Ldd24_rt_parse_int_native_bb41 // branch
_Ldd24_rt_parse_int_native_bb41:
    b _Ldd24_rt_parse_int_native_bb23 // branch
_Ldd24_rt_parse_int_native_bb42:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add sp, sp, #2032 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_Ldd24_rt_parse_int_native_bb43:
    add x15, sp, #944 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb45 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb44 // branch -> then
_Ldd24_rt_parse_int_native_bb44:
    ldp x0, x1, [sp, #368] // hv load L23
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    cmp x1, x3 // __hx_payload_ne: cmp payloads
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb47 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb46 // branch -> then
_Ldd24_rt_parse_int_native_bb45:
    ldp x0, x1, [sp, #368] // hv load L23
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    cmp x1, x3 // __hx_payload_ne: cmp payloads
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _Ldd24_rt_parse_int_native_bb49 // br_cond: !truthy -> else
    b _Ldd24_rt_parse_int_native_bb48 // branch -> then
_Ldd24_rt_parse_int_native_bb46:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    movz x2, #0 // hv const_int: TAG_INT
