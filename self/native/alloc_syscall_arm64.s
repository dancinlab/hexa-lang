...
_SYS_LINUX_NANOSLEEP:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_LINUX_NANOSLEEP_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_LINUX_GETDENTS64:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_LINUX_GETDENTS64_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_LINUX_CLOCK_GETTIME:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_LINUX_CLOCK_GETTIME_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_LINUX_EXIT_GROUP:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_LINUX_EXIT_GROUP_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_LINUX_UNLINKAT:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_LINUX_UNLINKAT_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_LINUX_GETRANDOM:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_LINUX_GETRANDOM_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_DARWIN_FSTAT64:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_DARWIN_FSTAT64_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_DARWIN_GETDIRENTRIES:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_DARWIN_GETDIRENTRIES_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_DARWIN_GETDIRENTRIES64:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_DARWIN_GETDIRENTRIES64_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_SYS_DARWIN_NANOSLEEP:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_DARWIN_NANOSLEEP_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #197 ; imm 0-15
    movk x1, #512, lsl #16 ; imm 16-31
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
...
_SYS_DARWIN_CLOCK_GETTIME:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_SYS_DARWIN_CLOCK_GETTIME_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
__L188d_sys_read_bb0:
    ...
    cbz x0, __L188d_sys_read_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_read_bb1 ; branch -> then
__L188d_sys_read_bb1:
...
_sys_write:
    ...
    stp x2, x3, [sp, #16] ; ingress param 1
    stp x4, x5, [sp, #32] ; ingress param 2
__L188d_sys_write_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_write_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_write_bb1 ; branch -> then
__L188d_sys_write_bb1:
...
_sys_open:
    ...
    stp x2, x3, [sp, #16] ; ingress param 1
    stp x4, x5, [sp, #32] ; ingress param 2
__L188d_sys_open_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_open_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_open_bb1 ; branch -> then
__L188d_sys_open_bb1:
...
_sys_close:
    ...
    sub sp, sp, #112 ; sp adj
    stp x0, x1, [sp, #0] ; ingress param 0
__L188d_sys_close_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #16] ; hv store L1
    ldp x0, x1, [sp, #16] ; hv load L1
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_close_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_close_bb1 ; branch -> then
__L188d_sys_close_bb1:
...
_sys_lseek:
    ...
    stp x2, x3, [sp, #16] ; ingress param 1
    stp x4, x5, [sp, #32] ; ingress param 2
__L188d_sys_lseek_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_lseek_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_lseek_bb1 ; branch -> then
__L188d_sys_lseek_bb1:
...
_sys_unlink:
    ...
    sub sp, sp, #112 ; sp adj
    stp x0, x1, [sp, #0] ; ingress param 0
__L188d_sys_unlink_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #16] ; hv store L1
    ldp x0, x1, [sp, #16] ; hv load L1
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_unlink_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_unlink_bb1 ; branch -> then
__L188d_sys_unlink_bb1:
...
_sys_mkdir:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L188d_sys_mkdir_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #32] ; hv store L2
    ldp x0, x1, [sp, #32] ; hv load L2
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_mkdir_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_mkdir_bb1 ; branch -> then
__L188d_sys_mkdir_bb1:
...
_sys_mmap:
    ...
    ldp x9, x10, [x29, #32] ; ingress stack param 5
    stp x9, x10, [sp, #128] ; store stack param 5
__L188d_sys_mmap_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #144] ; hv store L6
    ldp x0, x1, [sp, #144] ; hv load L6
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_mmap_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_mmap_bb1 ; branch -> then
__L188d_sys_mmap_bb1:
...
_sys_munmap:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L188d_sys_munmap_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #32] ; hv store L2
    ldp x0, x1, [sp, #32] ; hv load L2
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_munmap_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_munmap_bb1 ; branch -> then
__L188d_sys_munmap_bb1:
...
_sys_exit:
    ...
    sub sp, sp, #112 ; sp adj
    stp x0, x1, [sp, #0] ; ingress param 0
__L188d_sys_exit_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #16] ; hv store L1
    ldp x0, x1, [sp, #16] ; hv load L1
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_exit_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_exit_bb1 ; branch -> then
__L188d_sys_exit_bb1:
...
_sys_getrandom:
    ...
    stp x2, x3, [sp, #16] ; ingress param 1
    stp x4, x5, [sp, #32] ; ingress param 2
__L188d_sys_getrandom_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_getrandom_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_getrandom_bb1 ; branch -> then
__L188d_sys_getrandom_bb1:
...
__L188d_sys_getrandom_bb2:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_getrandom_bb4 ; br_cond: !truthy -> else
    b __L188d_sys_getrandom_bb3 ; branch -> then
__L188d_sys_getrandom_bb3:
    ldp x0, x1, [sp, #144] ; hv load L9
    add sp, sp, #240 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L188d_sys_getrandom_bb4:
    ldp x0, x1, [sp, #144] ; hv load L9
    ldp x2, x3, [sp, #0] ; hv load L0
    ldp x4, x5, [sp, #16] ; hv load L1
...
_sys_clock_gettime:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L188d_sys_clock_gettime_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #32] ; hv store L2
    ldp x0, x1, [sp, #32] ; hv load L2
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_clock_gettime_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_clock_gettime_bb1 ; branch -> then
__L188d_sys_clock_gettime_bb1:
...
_sys_fork:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #96 ; sp adj
__L188d_sys_fork_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #0] ; hv store L0
    ldp x0, x1, [sp, #0] ; hv load L0
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_fork_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_fork_bb1 ; branch -> then
__L188d_sys_fork_bb1:
...
_sys_execve:
    ...
    stp x2, x3, [sp, #16] ; ingress param 1
    stp x4, x5, [sp, #32] ; ingress param 2
__L188d_sys_execve_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_execve_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_execve_bb1 ; branch -> then
__L188d_sys_execve_bb1:
...
__L188d_sys_wait4_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #80] ; hv store L4
    ldp x0, x1, [sp, #80] ; hv load L4
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_wait4_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_wait4_bb1 ; branch -> then
__L188d_sys_wait4_bb1:
...
_sys_pipe:
    ...
    sub sp, sp, #80 ; sp adj
    stp x0, x1, [sp, #0] ; ingress param 0
__L188d_sys_pipe_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #16] ; hv store L1
    ldp x0, x1, [sp, #16] ; hv load L1
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_pipe_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_pipe_bb1 ; branch -> then
__L188d_sys_pipe_bb1:
...
_sys_dup2:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L188d_sys_dup2_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #32] ; hv store L2
    ldp x0, x1, [sp, #32] ; hv load L2
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_dup2_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_dup2_bb1 ; branch -> then
__L188d_sys_dup2_bb1:
...
_sys_nanosleep:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L188d_sys_nanosleep_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #32] ; hv store L2
    ldp x0, x1, [sp, #32] ; hv load L2
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_sys_nanosleep_bb2 ; br_cond: !truthy -> else
    b __L188d_sys_nanosleep_bb1 ; branch -> then
__L188d_sys_nanosleep_bb1:
...
_flag_o_creat:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #64 ; sp adj
__L188d_flag_o_creat_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #0] ; hv store L0
    ldp x0, x1, [sp, #0] ; hv load L0
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_flag_o_creat_bb2 ; br_cond: !truthy -> else
    b __L188d_flag_o_creat_bb1 ; branch -> then
__L188d_flag_o_creat_bb1:
...
_flag_o_append:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #64 ; sp adj
__L188d_flag_o_append_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #0] ; hv store L0
    ldp x0, x1, [sp, #0] ; hv load L0
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_flag_o_append_bb2 ; br_cond: !truthy -> else
    b __L188d_flag_o_append_bb1 ; branch -> then
__L188d_flag_o_append_bb1:
...
_flag_o_trunc:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #64 ; sp adj
__L188d_flag_o_trunc_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #0] ; hv store L0
    ldp x0, x1, [sp, #0] ; hv load L0
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_flag_o_trunc_bb2 ; br_cond: !truthy -> else
    b __L188d_flag_o_trunc_bb1 ; branch -> then
__L188d_flag_o_trunc_bb1:
...
_flag_map_anon:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #64 ; sp adj
__L188d_flag_map_anon_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #0] ; hv store L0
    ldp x0, x1, [sp, #0] ; hv load L0
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_flag_map_anon_bb2 ; br_cond: !truthy -> else
    b __L188d_flag_map_anon_bb1 ; branch -> then
__L188d_flag_map_anon_bb1:
...
_CLOCK_MONOTONIC_LINUX:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_CLOCK_MONOTONIC_LINUX_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
...
_CLOCK_MONOTONIC_DARWIN:
    ...
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_CLOCK_MONOTONIC_DARWIN_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
...
_clock_monotonic:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #64 ; sp adj
__L188d_clock_monotonic_bb0:
    bl _target_is_linux ; call target_is_linux
    stp x0, x1, [sp, #0] ; hv store L0
    ldp x0, x1, [sp, #0] ; hv load L0
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_clock_monotonic_bb2 ; br_cond: !truthy -> else
    b __L188d_clock_monotonic_bb1 ; branch -> then
__L188d_clock_monotonic_bb1:
...
__L188d_clock_monotonic_bb2:
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _POOL_PAGE_SIZE
.private_extern _POOL_PAGE_SIZE
    .p2align 2
_POOL_PAGE_SIZE:
    .loc 1 321 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_POOL_PAGE_SIZE_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; imm 0-15
    movk x1, #16, lsl #16 ; imm 16-31
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _ARENA_MAX_POOLS
.private_extern _ARENA_MAX_POOLS
    .p2align 2
_ARENA_MAX_POOLS:
    .loc 1 322 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
__L188d_ARENA_MAX_POOLS_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #256 ; hv const_int val
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl ___env_extend
...
__L188d___env_extend_bb0:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d___env_extend_bb2 ; br_cond: !truthy -> else
    b __L188d___env_extend_bb1 ; branch -> then
__L188d___env_extend_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    adrp x15, _g1@PAGE ; hv global page (store)
    add x15, x15, _g1@PAGEOFF ; hv global off (store)
    stp x0, x1, [x15] ; hv store global g1
    b __L188d___env_extend_bb5 ; branch
__L188d___env_extend_bb2:
    ldp x0, x1, [sp, #0] ; hv load L0
    adrp x2, _g1@PAGE ; hv global page
    add x2, x2, _g1@PAGEOFF ; hv global off
    ldp x2, x3, [x2] ; hv load global g1
    bl _hexa_cmp_lt ; binop <
    stp x0, x1, [sp, #64] ; hv store L4
    ldp x0, x1, [sp, #64] ; hv load L4
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d___env_extend_bb4 ; br_cond: !truthy -> else
    b __L188d___env_extend_bb3 ; branch -> then
__L188d___env_extend_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    adrp x15, _g1@PAGE ; hv global page (store)
    add x15, x15, _g1@PAGEOFF ; hv global off (store)
    stp x0, x1, [x15] ; hv store global g1
    b __L188d___env_extend_bb4 ; branch
__L188d___env_extend_bb4:
    b __L188d___env_extend_bb5 ; branch
__L188d___env_extend_bb5:
    ldp x0, x1, [sp, #0] ; hv load L0
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d___env_extend_bb7 ; br_cond: !truthy -> else
    b __L188d___env_extend_bb6 ; branch -> then
__L188d___env_extend_bb6:
    ldp x0, x1, [sp, #112] ; hv load L7
    adrp x15, _g2@PAGE ; hv global page (store)
    add x15, x15, _g2@PAGEOFF ; hv global off (store)
    stp x0, x1, [x15] ; hv store global g2
    b __L188d___env_extend_bb7 ; branch
__L188d___env_extend_bb7:
...
__L188d___arena_grow_bb0:
    bl ___a_np ; call __a_np
    stp x0, x1, [sp, #32] ; hv store L0
    ...
    ldp x0, x1, [sp, #64] ; hv load L2
    ldp x2, x3, [sp, #80] ; hv load L3
    bl _hexa_add_slow ; binop +
    stp x0, x1, [sp, #96] ; hv store L4
    ldp x0, x1, [sp, #96] ; hv load L4
    ...
    bl _POOL_PAGE_SIZE ; call POOL_PAGE_SIZE
    stp x0, x1, [sp, #192] ; hv store L10
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ldp x2, x3, [sp, #192] ; hv load L10
    ldp x4, x5, [sp, #176] ; hv load L9
    ldp x6, x7, [sp, #112] ; hv load L5
    ...
    ldp x0, x1, [sp, #240] ; hv load L13
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d___arena_grow_bb2 ; br_cond: !truthy -> else
    b __L188d___arena_grow_bb1 ; branch -> then
__L188d___arena_grow_bb1:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L188d___arena_grow_bb2:
    ldp x0, x1, [sp, #48] ; hv load L1
    ldp x2, x3, [sp, #224] ; hv load L12
    bl ___p_set_base ; call __p_set_base
    stp x0, x1, [sp, #288] ; hv store L16
    bl _POOL_PAGE_SIZE ; call POOL_PAGE_SIZE
    stp x0, x1, [sp, #304] ; hv store L17
    ldp x0, x1, [sp, #48] ; hv load L1
    ldp x2, x3, [sp, #304] ; hv load L17
    bl ___p_set_size ; call __p_set_size
    stp x0, x1, [sp, #320] ; hv store L18
    ldp x0, x1, [sp, #48] ; hv load L1
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl ___p_set_used ; call __p_set_used
    stp x0, x1, [sp, #336] ; hv store L19
    ldp x0, x1, [sp, #48] ; hv load L1
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    bl _hexa_add_slow ; binop +
    stp x0, x1, [sp, #352] ; hv store L20
    ldp x0, x1, [sp, #352] ; hv load L20
    bl ___a_set_np ; call __a_set_np
    stp x0, x1, [sp, #368] ; hv store L21
    bl _POOL_PAGE_SIZE ; call POOL_PAGE_SIZE
    stp x0, x1, [sp, #384] ; hv store L22
    ldp x0, x1, [sp, #224] ; hv load L12
    ldp x2, x3, [sp, #384] ; hv load L22
    bl ___env_extend ; call __env_extend
    stp x0, x1, [sp, #400] ; hv store L23
    ldp x0, x1, [sp, #400] ; hv load L23
    add sp, sp, #416 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _page_alloc
.private_extern _page_alloc
    .p2align 2
_page_alloc:
    .loc 1 400 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L188d_page_alloc_bb0:
    ...
    bl _PROT_WRITE ; call PROT_WRITE
    stp x0, x1, [sp, #160] ; hv store L8
    ldp x0, x1, [sp, #144] ; hv load L7
    ldp x2, x3, [sp, #160] ; hv load L8
    bl _hexa_add_slow ; binop +
    stp x0, x1, [sp, #176] ; hv store L9
    ldp x0, x1, [sp, #176] ; hv load L9
    stp x0, x1, [sp, #192] ; hv store L10
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ldp x2, x3, [sp, #64] ; hv load L2
    ldp x4, x5, [sp, #192] ; hv load L10
    ldp x6, x7, [sp, #128] ; hv load L6
    movz x9, #0 ; hv const_int: TAG_INT
    movz x10, #0 ; imm 0-15
    mvn x10, x10 ; hv const_int: negate
    stp x9, x10, [sp, #0] ; C7: stack arg 4
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_page_alloc_bb2 ; br_cond: !truthy -> else
    b __L188d_page_alloc_bb1 ; branch -> then
__L188d_page_alloc_bb1:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #137 ; hv const_int val
    bl _sys_exit ; call sys_exit
    stp x0, x1, [sp, #272] ; hv store L15
...
__L188d_page_free_bb0:
    ...
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #48] ; hv load L3
    bl _sys_munmap ; call sys_munmap
    stp x0, x1, [sp, #64] ; hv store L4
    ldp x0, x1, [sp, #64] ; hv load L4
    add sp, sp, #80 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
...
__L188d_rt_init_bb0:
    ...
    stp x0, x1, [sp, #112] ; hv store L5
    ldp x0, x1, [sp, #96] ; hv load L4
    ldp x2, x3, [sp, #112] ; hv load L5
    bl _hexa_add_slow ; binop +
    stp x0, x1, [sp, #128] ; hv store L6
    ldp x0, x1, [sp, #128] ; hv load L6
    stp x0, x1, [sp, #144] ; hv store L7
    bl _ARENA_MAX_POOLS ; call ARENA_MAX_POOLS
    stp x0, x1, [sp, #160] ; hv store L8
    ldp x0, x1, [sp, #160] ; hv load L8
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    movz x1, #0 ; hv const_int val
    ldp x2, x3, [sp, #192] ; hv load L10
    ldp x4, x5, [sp, #144] ; hv load L7
    ldp x6, x7, [sp, #80] ; hv load L3
    movz x9, #0 ; hv const_int: TAG_INT
    movz x10, #0 ; imm 0-15
    mvn x10, x10 ; hv const_int: negate
    stp x9, x10, [sp, #0] ; C7: stack arg 4
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_rt_init_bb2 ; br_cond: !truthy -> else
    b __L188d_rt_init_bb1 ; branch -> then
__L188d_rt_init_bb1:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #137 ; hv const_int val
    bl _sys_exit ; call sys_exit
...
__L188d_rt_init_bb2:
    ...
    movz x0, #0 ; __hx_ptr_store64: TAG_INT
    stp x0, x1, [sp, #272] ; hv store L15
    bl ___arena_grow ; call __arena_grow
    stp x0, x1, [sp, #288] ; hv store L16
...
__L188d_hexa_arena_mark_bb0:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_arena_mark_bb2 ; br_cond: !truthy -> else
    b __L188d_hexa_arena_mark_bb1 ; branch -> then
__L188d_hexa_arena_mark_bb1:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; imm 0-15
    mvn x1, x1 ; hv const_int: negate
    add sp, sp, #176 ; sp adj
...
__L188d_hexa_arena_rewind_bb0:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_arena_rewind_bb2 ; br_cond: !truthy -> else
    b __L188d_hexa_arena_rewind_bb1 ; branch -> then
__L188d_hexa_arena_rewind_bb1:
    bl _hexa_arena_reset ; call hexa_arena_reset
    stp x0, x1, [sp, #48] ; hv store L3
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
...
__L188d_hexa_arena_rewind_bb2:
    ...
    b __L188d_hexa_arena_rewind_bb3 ; branch
__L188d_hexa_arena_rewind_bb3:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_arena_rewind_bb5 ; br_cond: !truthy -> else
    b __L188d_hexa_arena_rewind_bb4 ; branch -> then
__L188d_hexa_arena_rewind_bb4:
    ldp x0, x1, [sp, #240] ; hv load L15
    bl ___p_base ; call __p_base
    stp x0, x1, [sp, #272] ; hv store L17
    ldp x0, x1, [sp, #240] ; hv load L15
    bl ___p_size ; call __p_size
...
_hexa_arena_reset:
    ...
    mov x29, sp ; prologue: set fp
    sub sp, sp, #128 ; sp adj
__L188d_hexa_arena_reset_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    stp x0, x1, [sp, #0] ; hv store L0
    b __L188d_hexa_arena_reset_bb1 ; branch
__L188d_hexa_arena_reset_bb1:
    bl ___a_np ; call __a_np
    stp x0, x1, [sp, #16] ; hv store L1
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_arena_reset_bb3 ; br_cond: !truthy -> else
    b __L188d_hexa_arena_reset_bb2 ; branch -> then
__L188d_hexa_arena_reset_bb2:
    ldp x0, x1, [sp, #0] ; hv load L0
    bl ___p_base ; call __p_base
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #0] ; hv load L0
...
__L188d_hexa_ptr_alloc_bb0:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_ptr_alloc_bb2 ; br_cond: !truthy -> else
    b __L188d_hexa_ptr_alloc_bb1 ; branch -> then
__L188d_hexa_ptr_alloc_bb1:
    ldp x0, x1, [sp, #32] ; hv load L2
    bl _page_alloc ; call page_alloc
    stp x0, x1, [sp, #112] ; hv store L7
    ldp x0, x1, [sp, #112] ; hv load L7
    add sp, sp, #496 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L188d_hexa_ptr_alloc_bb2:
    bl ___a_np ; call __a_np
    stp x0, x1, [sp, #128] ; hv store L8
    ldp x0, x1, [sp, #128] ; hv load L8
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_ptr_alloc_bb4 ; br_cond: !truthy -> else
    b __L188d_hexa_ptr_alloc_bb3 ; branch -> then
__L188d_hexa_ptr_alloc_bb3:
    bl ___arena_grow ; call __arena_grow
    stp x0, x1, [sp, #176] ; hv store L11
    b __L188d_hexa_ptr_alloc_bb4 ; branch
__L188d_hexa_ptr_alloc_bb4:
    bl ___a_np ; call __a_np
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_ptr_alloc_bb6 ; br_cond: !truthy -> else
    b __L188d_hexa_ptr_alloc_bb5 ; branch -> then
__L188d_hexa_ptr_alloc_bb5:
    bl ___arena_grow ; call __arena_grow
    stp x0, x1, [sp, #320] ; hv store L20
    b __L188d_hexa_ptr_alloc_bb6 ; branch
__L188d_hexa_ptr_alloc_bb6:
    bl ___a_np ; call __a_np
    stp x0, x1, [sp, #336] ; hv store L21
    ldp x0, x1, [sp, #336] ; hv load L21
    movz x2, #0 ; hv const_int: TAG_INT
...
__L188d_hexa_ptr_free_bb0:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L188d_hexa_ptr_free_bb2 ; br_cond: !truthy -> else
    b __L188d_hexa_ptr_free_bb1 ; branch -> then
__L188d_hexa_ptr_free_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    bl _page_free ; call page_free
    stp x0, x1, [sp, #96] ; hv store L6
    ldp x0, x1, [sp, #96] ; hv load L6
    add sp, sp, #112 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L188d_hexa_ptr_free_bb2:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add sp, sp, #112 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
...
_hexa_ptr_write_byte:
    ...
    stp x2, x3, [sp, #16] ; ingress param 1
    stp x4, x5, [sp, #32] ; ingress param 2
__L188d_hexa_ptr_write_byte_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
_hexa_ptr_read_byte:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L188d_hexa_ptr_read_byte_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
