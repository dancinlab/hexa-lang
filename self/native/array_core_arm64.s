...
//   ABI: Mach-O, _rt_array_*_native underscore-prefixed. External: _hexa_to_int.
...
__L8c2a_rt_array_len_native_bb0:
...
__L8c2a_rt_array_get_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
...
__L8c2a_rt_array_set_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
...
_rt_array_pop_native:
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
__L8c2a_rt_array_pop_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
