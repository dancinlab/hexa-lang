...
//   ABI: ELF aarch64, rt_parse_float_native no underscore. External: NONE (fully self-contained; float leaves lower inline).
...
_L40fd_rt_parse_float_native_bb0:
    ...
    b _L40fd_rt_parse_float_native_bb1 // branch
_L40fd_rt_parse_float_native_bb1:
    ...
    cbz x0, _L40fd_rt_parse_float_native_bb3 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb2 // branch -> then
_L40fd_rt_parse_float_native_bb2:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb5 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb4 // branch -> then
_L40fd_rt_parse_float_native_bb3:
    ldp x0, x1, [sp, #48] // hv load L2
    ldp x2, x3, [sp, #64] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb8 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb7 // branch -> then
_L40fd_rt_parse_float_native_bb4:
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb6 // branch
_L40fd_rt_parse_float_native_bb5:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    stp x0, x1, [sp, #80] // hv store L4
    b _L40fd_rt_parse_float_native_bb6 // branch
_L40fd_rt_parse_float_native_bb6:
    b _L40fd_rt_parse_float_native_bb1 // branch
_L40fd_rt_parse_float_native_bb7:
    ldp x0, x1, [sp, #64] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb11 // branch
_L40fd_rt_parse_float_native_bb8:
    ldp x0, x1, [sp, #368] // hv load L22
    movz x2, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb10 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb9 // branch -> then
_L40fd_rt_parse_float_native_bb9:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    stp x0, x1, [sp, #0] // hv store L23
    ldp x0, x1, [sp, #64] // hv load L3
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb10 // branch
_L40fd_rt_parse_float_native_bb10:
    b _L40fd_rt_parse_float_native_bb11 // branch
_L40fd_rt_parse_float_native_bb11:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    ...
    b _L40fd_rt_parse_float_native_bb12 // branch
_L40fd_rt_parse_float_native_bb12:
    add x15, sp, #560 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb14 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb13 // branch -> then
_L40fd_rt_parse_float_native_bb13:
    ldp x0, x1, [sp, #48] // hv load L2
    ldp x2, x3, [sp, #64] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb16 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb15 // branch -> then
_L40fd_rt_parse_float_native_bb14:
    ldp x0, x1, [sp, #48] // hv load L2
    ldp x2, x3, [sp, #64] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb30 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb29 // branch -> then
_L40fd_rt_parse_float_native_bb15:
    add x15, sp, #608 // hv frame base
    ldp x0, x1, [x15] // hv load L38
    movz x2, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb18 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb17 // branch -> then
_L40fd_rt_parse_float_native_bb16:
    add x15, sp, #736 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb23 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb22 // branch -> then
_L40fd_rt_parse_float_native_bb17:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #544 // hv frame base
    stp x0, x1, [x15] // hv store L34
    b _L40fd_rt_parse_float_native_bb19 // branch
_L40fd_rt_parse_float_native_bb18:
    ...
    stp x0, x1, [sp, #480] // hv store L30
    b _L40fd_rt_parse_float_native_bb19 // branch
_L40fd_rt_parse_float_native_bb19:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb21 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb20 // branch -> then
_L40fd_rt_parse_float_native_bb20:
    add x15, sp, #512 // hv frame base
    ...
    add x15, sp, #512 // hv frame base
    stp x0, x1, [x15] // hv store L32
    b _L40fd_rt_parse_float_native_bb21 // branch
_L40fd_rt_parse_float_native_bb21:
    ldp x0, x1, [sp, #64] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb28 // branch
_L40fd_rt_parse_float_native_bb22:
    add x15, sp, #528 // hv frame base
    ldp x0, x1, [x15] // hv load L33
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb25 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb24 // branch -> then
_L40fd_rt_parse_float_native_bb23:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #560 // hv frame base
    stp x0, x1, [x15] // hv store L35
    b _L40fd_rt_parse_float_native_bb27 // branch
_L40fd_rt_parse_float_native_bb24:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #560 // hv frame base
    stp x0, x1, [x15] // hv store L35
    b _L40fd_rt_parse_float_native_bb26 // branch
_L40fd_rt_parse_float_native_bb25:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #528 // hv frame base
    stp x0, x1, [x15] // hv store L33
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb26 // branch
_L40fd_rt_parse_float_native_bb26:
    b _L40fd_rt_parse_float_native_bb27 // branch
_L40fd_rt_parse_float_native_bb27:
    b _L40fd_rt_parse_float_native_bb28 // branch
_L40fd_rt_parse_float_native_bb28:
    b _L40fd_rt_parse_float_native_bb12 // branch
_L40fd_rt_parse_float_native_bb29:
    ldp x0, x1, [sp, #64] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb32 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb31 // branch -> then
_L40fd_rt_parse_float_native_bb30:
    add x15, sp, #1200 // hv frame base
    ldp x0, x1, [x15] // hv load L75
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb45 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb44 // branch -> then
_L40fd_rt_parse_float_native_bb31:
    ldp x0, x1, [sp, #64] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb35 // branch
_L40fd_rt_parse_float_native_bb32:
    add x15, sp, #1328 // hv frame base
    ldp x0, x1, [x15] // hv load L83
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #45 // hv const_int val
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb34 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb33 // branch -> then
_L40fd_rt_parse_float_native_bb33:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1216 // hv frame base
    stp x0, x1, [x15] // hv store L76
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb34 // branch
_L40fd_rt_parse_float_native_bb34:
    b _L40fd_rt_parse_float_native_bb35 // branch
_L40fd_rt_parse_float_native_bb35:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1440 // hv frame base
    stp x0, x1, [x15] // hv store L90
    b _L40fd_rt_parse_float_native_bb36 // branch
_L40fd_rt_parse_float_native_bb36:
    add x15, sp, #1440 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb38 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb37 // branch -> then
_L40fd_rt_parse_float_native_bb37:
    ldp x0, x1, [sp, #48] // hv load L2
    ldp x2, x3, [sp, #64] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb40 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb39 // branch -> then
_L40fd_rt_parse_float_native_bb38:
    b _L40fd_rt_parse_float_native_bb30 // branch
_L40fd_rt_parse_float_native_bb39:
    add x15, sp, #1488 // hv frame base
    ldp x0, x1, [x15] // hv load L93
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #48 // hv const_int val
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb42 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb41 // branch -> then
_L40fd_rt_parse_float_native_bb40:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #1440 // hv frame base
    stp x0, x1, [x15] // hv store L90
    b _L40fd_rt_parse_float_native_bb43 // branch
_L40fd_rt_parse_float_native_bb41:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1000 // hv const_int val
    add x15, sp, #1232 // hv frame base
    stp x0, x1, [x15] // hv store L77
    b _L40fd_rt_parse_float_native_bb42 // branch
_L40fd_rt_parse_float_native_bb42:
    ldp x0, x1, [sp, #64] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] // hv store L3
    b _L40fd_rt_parse_float_native_bb43 // branch
_L40fd_rt_parse_float_native_bb43:
    b _L40fd_rt_parse_float_native_bb36 // branch
_L40fd_rt_parse_float_native_bb44:
    add x15, sp, #1216 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb47 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb46 // branch -> then
_L40fd_rt_parse_float_native_bb45:
    ldp x0, x1, [sp, #48] // hv load L2
    ldp x2, x3, [sp, #64] // hv load L3
    add x1, x1, x3 // __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] // __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb50 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb49 // branch -> then
_L40fd_rt_parse_float_native_bb46:
    add x15, sp, #512 // hv frame base
    ldp x0, x1, [x15] // hv load L32
    add x15, sp, #1232 // hv frame base
    ldp x2, x3, [x15] // hv load L77
    ...
    add x15, sp, #512 // hv frame base
    stp x0, x1, [x15] // hv store L32
    b _L40fd_rt_parse_float_native_bb48 // branch
_L40fd_rt_parse_float_native_bb47:
    add x15, sp, #512 // hv frame base
    ldp x0, x1, [x15] // hv load L32
    add x15, sp, #1232 // hv frame base
    ldp x2, x3, [x15] // hv load L77
    ...
    stp x0, x1, [x15] // hv store L32
    b _L40fd_rt_parse_float_native_bb48 // branch
_L40fd_rt_parse_float_native_bb48:
    b _L40fd_rt_parse_float_native_bb45 // branch
_L40fd_rt_parse_float_native_bb49:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1920 // hv frame base
    stp x0, x1, [x15] // hv store L120
    b _L40fd_rt_parse_float_native_bb50 // branch
_L40fd_rt_parse_float_native_bb50:
    add x15, sp, #544 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb52 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb51 // branch -> then
_L40fd_rt_parse_float_native_bb51:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1920 // hv frame base
    stp x0, x1, [x15] // hv store L120
    b _L40fd_rt_parse_float_native_bb52 // branch
_L40fd_rt_parse_float_native_bb52:
    add x15, sp, #1200 // hv frame base
    ldp x0, x1, [x15] // hv load L75
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb54 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb53 // branch -> then
_L40fd_rt_parse_float_native_bb53:
    add x15, sp, #1248 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb56 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb55 // branch -> then
_L40fd_rt_parse_float_native_bb54:
    add x15, sp, #1904 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb58 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb57 // branch -> then
_L40fd_rt_parse_float_native_bb55:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1920 // hv frame base
    stp x0, x1, [x15] // hv store L120
    b _L40fd_rt_parse_float_native_bb56 // branch
_L40fd_rt_parse_float_native_bb56:
    b _L40fd_rt_parse_float_native_bb54 // branch
_L40fd_rt_parse_float_native_bb57:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1920 // hv frame base
    stp x0, x1, [x15] // hv store L120
    b _L40fd_rt_parse_float_native_bb58 // branch
_L40fd_rt_parse_float_native_bb58:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb60 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb59 // branch -> then
_L40fd_rt_parse_float_native_bb59:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1920 // hv frame base
    stp x0, x1, [x15] // hv store L120
    b _L40fd_rt_parse_float_native_bb60 // branch
_L40fd_rt_parse_float_native_bb60:
    add x15, sp, #2144 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb62 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb61 // branch -> then
_L40fd_rt_parse_float_native_bb61:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #512 // hv frame base
    ldp x2, x3, [x15] // hv load L32
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb64 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb63 // branch -> then
_L40fd_rt_parse_float_native_bb62:
    add x15, sp, #1920 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb66 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb65 // branch -> then
_L40fd_rt_parse_float_native_bb63:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    add x15, sp, #1920 // hv frame base
    stp x0, x1, [x15] // hv store L120
    b _L40fd_rt_parse_float_native_bb64 // branch
_L40fd_rt_parse_float_native_bb64:
    b _L40fd_rt_parse_float_native_bb62 // branch
_L40fd_rt_parse_float_native_bb65:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    ret // return
_L40fd_rt_parse_float_native_bb66:
    ldp x0, x1, [sp, #480] // hv load L30
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb68 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb67 // branch -> then
_L40fd_rt_parse_float_native_bb67:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #512 // hv frame base
    ldp x2, x3, [x15] // hv load L32
    ...
    add x15, sp, #2528 // hv frame base
    stp x0, x1, [x15] // hv store L158
    b _L40fd_rt_parse_float_native_bb68 // branch
_L40fd_rt_parse_float_native_bb68:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add x15, sp, #2624 // hv frame base
    stp x0, x1, [x15] // hv store L164
    b _L40fd_rt_parse_float_native_bb69 // branch
_L40fd_rt_parse_float_native_bb69:
    add x15, sp, #2624 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb71 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb70 // branch -> then
_L40fd_rt_parse_float_native_bb70:
    add x15, sp, #2448 // hv frame base
    ...
    stp x0, x1, [x15] // hv store L164
    b _L40fd_rt_parse_float_native_bb69 // branch
_L40fd_rt_parse_float_native_bb71:
    add x15, sp, #2384 // hv frame base
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb73 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb72 // branch -> then
_L40fd_rt_parse_float_native_bb72:
    add x15, sp, #2384 // hv frame base
    ldp x0, x1, [x15] // hv load L149
    add x15, sp, #2448 // hv frame base
    ...
    add x15, sp, #2688 // hv frame base
    stp x0, x1, [x15] // hv store L168
    b _L40fd_rt_parse_float_native_bb74 // branch
_L40fd_rt_parse_float_native_bb73:
    add x15, sp, #2384 // hv frame base
    ldp x0, x1, [x15] // hv load L149
    add x15, sp, #2448 // hv frame base
    ldp x2, x3, [x15] // hv load L153
    ...
    stp x0, x1, [x15] // hv store L168
    b _L40fd_rt_parse_float_native_bb74 // branch
_L40fd_rt_parse_float_native_bb74:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L40fd_rt_parse_float_native_bb76 // br_cond: !truthy -> else
    b _L40fd_rt_parse_float_native_bb75 // branch -> then
_L40fd_rt_parse_float_native_bb75:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #1 // hv const_int val
    ...
    add x15, sp, #2688 // hv frame base
    stp x0, x1, [x15] // hv store L168
    b _L40fd_rt_parse_float_native_bb76 // branch
_L40fd_rt_parse_float_native_bb76:
    add x15, sp, #2688 // hv frame base
    ldp x0, x1, [x15] // hv load L168
    add sp, sp, #2880 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
