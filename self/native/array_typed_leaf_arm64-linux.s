...
//   ABI: ELF aarch64, no underscore. External U-floor: malloc realloc write hexa_exit hexa_int hexa_throw (libc-bearing: realloc grow dissolves the
...
_L6cf9_hexa_arr_i64_new_bb0:
    ...
    cbz x1, _L6cf9_hexa_arr_i64_new_bb2 // br_cond: !payload -> else
    b _L6cf9_hexa_arr_i64_new_bb1 // branch -> then
_L6cf9_hexa_arr_i64_new_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    stp x0, x1, [sp, #16] // hv store L1
    b _L6cf9_hexa_arr_i64_new_bb2 // branch
_L6cf9_hexa_arr_i64_new_bb2:
    movz x0, #0 // hv const_int: TAG_INT
...
_L6cf9_hexa_arr_i64_push_bb0:
    ...
    stp x0, x1, [sp, #128] // hv store L8
    ldp x0, x1, [sp, #128] // hv load L8
    cbz x1, _L6cf9_hexa_arr_i64_push_bb2 // br_cond: !payload -> else
    b _L6cf9_hexa_arr_i64_push_bb1 // branch -> then
_L6cf9_hexa_arr_i64_push_bb1:
    ldp x0, x1, [sp, #112] // hv load L7
    movz x2, #0 // hv const_int: TAG_INT
    ...
    cbz x1, _L6cf9_hexa_arr_i64_push_bb4 // br_cond: !payload -> else
    b _L6cf9_hexa_arr_i64_push_bb3 // branch -> then
_L6cf9_hexa_arr_i64_push_bb2:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_ptr_load64: addr = ptr + off
...
_L6cf9_hexa_arr_i64_push_bb3:
    ...
    b _L6cf9_hexa_arr_i64_push_bb4 // branch
_L6cf9_hexa_arr_i64_push_bb4:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    b _L6cf9_hexa_arr_i64_push_bb2 // branch
...
_L6cf9_hexa_arr_i64_box_bb0:
    ...
    stp x0, x1, [sp, #96] // hv store L6
    ldp x0, x1, [sp, #96] // hv load L6
    cbz x1, _L6cf9_hexa_arr_i64_box_bb2 // br_cond: !payload -> else
    b _L6cf9_hexa_arr_i64_box_bb1 // branch -> then
_L6cf9_hexa_arr_i64_box_bb1:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr1@PAGE // hv str ptr page
    add x1, x1, .LCstr1@PAGEOFF // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #128] // hv store L8
    b _L6cf9_hexa_arr_i64_box_bb2 // branch
_L6cf9_hexa_arr_i64_box_bb2:
    ldp x0, x1, [sp, #16] // hv load L1
    ldp x2, x3, [sp, #80] // hv load L5
    cmp x1, x3 // __hx_payload_ge: cmp payloads
    cset x0, ge // __hx_payload_ge: x0 = (a.pl ge b.pl)
    ...
    cbz x1, _L6cf9_hexa_arr_i64_box_bb4 // br_cond: !payload -> else
    b _L6cf9_hexa_arr_i64_box_bb3 // branch -> then
_L6cf9_hexa_arr_i64_box_bb3:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr1@PAGE // hv str ptr page
    add x1, x1, .LCstr1@PAGEOFF // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #176] // hv store L11
    b _L6cf9_hexa_arr_i64_box_bb4 // branch
_L6cf9_hexa_arr_i64_box_bb4:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_ptr_load64: addr = ptr + off
