// array_typed_leaf_arm64-linux.s — FROZEN BOOTSTRAP SEED (RT-NATIVE — array typed-leaf i64 DISPATCH).
// GENERATED: tool/regen_array_typed_leaf_native_s.sh — aprime_cc _drv.hexa --emit=asm
//   --target=arm64-linux-gnu -o array_typed_leaf_arm64-linux.s stdlib/runtime/array_typed_leaf.hexa.
//   Provides the 4 packed-i64 array dispatcher natives (hexa_arr_i64_new/push/len/box).
//   ABI: ELF aarch64, no underscore. External U-floor: hexa_heap_alloc hexa_heap_realloc hexa_throw hexa_bool (libc-bearing: realloc grow dissolves the
...
_L360b_hexa_arr_i64_new_seed_bb0:
    ...
    cbz x1, _L360b_hexa_arr_i64_new_seed_bb2 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_new_seed_bb1 // branch -> then
_L360b_hexa_arr_i64_new_seed_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    stp x0, x1, [sp, #32] // hv store L2
    b _L360b_hexa_arr_i64_new_seed_bb2 // branch
_L360b_hexa_arr_i64_new_seed_bb2:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    cbz x1, _L360b_hexa_arr_i64_new_seed_bb4 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_new_seed_bb3 // branch -> then
_L360b_hexa_arr_i64_new_seed_bb3:
    ...
    b _L360b_hexa_arr_i64_new_seed_bb4 // branch
_L360b_hexa_arr_i64_new_seed_bb4:
    ldp x0, x1, [sp, #32] // hv load L2
    movz x2, #0 // hv const_int: TAG_INT
    ...
    cbz x1, _L360b_hexa_arr_i64_new_seed_bb6 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_new_seed_bb5 // branch -> then
_L360b_hexa_arr_i64_new_seed_bb5:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr0 // hv str ptr page
    add x1, x1, :lo12:.LCstr0 // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #256] // hv store L16
    b _L360b_hexa_arr_i64_new_seed_bb6 // branch
_L360b_hexa_arr_i64_new_seed_bb6:
    ldp x0, x1, [sp, #96] // hv load L6
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    ret // return
.globl hexa_arr_i64_push_seed
.hidden hexa_arr_i64_push_seed
    .p2align 2
hexa_arr_i64_push_seed:
    .loc 1 102 0
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
...
_L360b_hexa_arr_i64_push_seed_bb0:
    ldp x0, x1, [sp, #0] // hv load L0
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #160] // hv store L10
    ldp x0, x1, [sp, #160] // hv load L10
    cbz x1, _L360b_hexa_arr_i64_push_seed_bb2 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_push_seed_bb1 // branch -> then
_L360b_hexa_arr_i64_push_seed_bb1:
    ...
    bl hexa_heap_realloc // call hexa_heap_realloc
    stp x0, x1, [sp, #288] // hv store L18
    ...
    stp x0, x1, [sp, #320] // hv store L20
    ldp x0, x1, [sp, #320] // hv load L20
    cbz x1, _L360b_hexa_arr_i64_push_seed_bb4 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_push_seed_bb3 // branch -> then
_L360b_hexa_arr_i64_push_seed_bb2:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_ptr_load64: addr = ptr + off
    ...
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L360b_hexa_arr_i64_push_seed_bb3:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr1 // hv str ptr page
    add x1, x1, :lo12:.LCstr1 // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #352] // hv store L22
    b _L360b_hexa_arr_i64_push_seed_bb4 // branch
_L360b_hexa_arr_i64_push_seed_bb4:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    b _L360b_hexa_arr_i64_push_seed_bb2 // branch
    movz x0, #4 // ret void: TAG_VOID
    movz x1, #0 // ret void: payload 0
    add sp, sp, #528 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
.globl hexa_arr_i64_len_seed
.hidden hexa_arr_i64_len_seed
    .p2align 2
hexa_arr_i64_len_seed:
    .loc 1 125 0
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
    sub sp, sp, #96 // sp adj
    stp x0, x1, [sp, #0] // ingress param 0
_L360b_hexa_arr_i64_len_seed_bb0:
    ldp x0, x1, [sp, #0] // hv load L0
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
.globl hexa_arr_i64_box_seed
.hidden hexa_arr_i64_box_seed
    .p2align 2
hexa_arr_i64_box_seed:
    .loc 1 134 0
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
    sub sp, sp, #336 // sp adj
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_L360b_hexa_arr_i64_box_seed_bb0:
    ldp x0, x1, [sp, #0] // hv load L0
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #128] // hv store L8
    ldp x0, x1, [sp, #128] // hv load L8
    cbz x1, _L360b_hexa_arr_i64_box_seed_bb2 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_box_seed_bb1 // branch -> then
_L360b_hexa_arr_i64_box_seed_bb1:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr2 // hv str ptr page
    add x1, x1, :lo12:.LCstr2 // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #160] // hv store L10
    b _L360b_hexa_arr_i64_box_seed_bb2 // branch
_L360b_hexa_arr_i64_box_seed_bb2:
    ldp x0, x1, [sp, #80] // hv load L5
    ...
    stp x0, x1, [sp, #176] // hv store L11
    ldp x0, x1, [sp, #176] // hv load L11
    cbz x1, _L360b_hexa_arr_i64_box_seed_bb4 // br_cond: !payload -> else
    b _L360b_hexa_arr_i64_box_seed_bb3 // branch -> then
_L360b_hexa_arr_i64_box_seed_bb3:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr2 // hv str ptr page
    add x1, x1, :lo12:.LCstr2 // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #208] // hv store L13
    b _L360b_hexa_arr_i64_box_seed_bb4 // branch
_L360b_hexa_arr_i64_box_seed_bb4:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_ptr_load64: addr = ptr + off
