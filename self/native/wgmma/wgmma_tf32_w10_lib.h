// wgmma_tf32_w10_lib.h — AUTO-DERIVED from wgmma_tf32_w10.cu (W10 frontier #2847).
// Body identical; main() guarded behind W10_NO_MAIN so W11 can #include the W10
// helpers/kernels (gmma_phys, sw128, mbar+TMA, WG, mk, tf, get_enc, gemm_w10) VERBATIM.
// Regenerate: sed wrap of main() in the .cu. DO NOT hand-edit numerics here.
#pragma once
