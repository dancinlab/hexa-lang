...
//   starts_with_b/ends_with_b/contains_b (14 fns). ABI: ELF, rt_str_* no underscore + .hidden.
...
.L9670_rt_str_split_bb0:
    ...
    jz .L9670_rt_str_split_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_split_bb1 # jump -> then
.L9670_rt_str_split_bb1:
...
.L9670_rt_str_split_bb2:
    ...
    jmp .L9670_rt_str_split_bb3 # branch
.L9670_rt_str_split_bb3:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_split_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_split_bb4 # jump -> then
.L9670_rt_str_split_bb4:
    mov r10, [rbp - 104] # reload L11 from spill slot
    mov r11, [rbp - 88] # reload L9 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, r11 # binop +
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_split_bb7 # jump-if-zero -> else
    jmp .L9670_rt_str_split_bb6 # jump -> then
.L9670_rt_str_split_bb5:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 224] # tag L0 from tag-slot
    call hexa_len # call hexa_len
    mov r10, rax # hv: unbox call result (rax)
...
.L9670_rt_str_split_bb6:
    ...
    mov [rbp - 312], r11 # store tag L11
    jmp .L9670_rt_str_split_bb8 # branch
.L9670_rt_str_split_bb7:
    mov r10, [rbp - 104] # reload L11 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
...
.L9670_rt_str_pad_left_bb0:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_left_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_left_bb1 # jump -> then
.L9670_rt_str_pad_left_bb1:
...
.L9670_rt_str_pad_left_bb2:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_left_bb4 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_left_bb3 # jump -> then
.L9670_rt_str_pad_left_bb3:
    mov rdx, rbx # hv arg payload
    mov rax, [rbp - 232] # tag L0 from tag-slot
    add rsp, 400 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_pad_left_bb4:
    ...
    mov r10, [rbp - 144] # reload L16 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_left_bb6 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_left_bb5 # jump -> then
.L9670_rt_str_pad_left_bb5:
    mov r10, [rbp - 128] # reload L14 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 344], r11 # store tag L14
    jmp .L9670_rt_str_pad_left_bb6 # branch
.L9670_rt_str_pad_left_bb6:
    call hexa_array_new # array_lit: new array
    ...
    jmp .L9670_rt_str_pad_left_bb7 # branch
.L9670_rt_str_pad_left_bb7:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_left_bb9 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_left_bb8 # jump -> then
.L9670_rt_str_pad_left_bb8:
...
.L9670_rt_str_pad_right_bb0:
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_right_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_right_bb1 # jump -> then
.L9670_rt_str_pad_right_bb1:
    mov rdx, rbx # hv arg payload
    mov rax, [rbp - 232] # tag L0 from tag-slot
    add rsp, 400 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_pad_right_bb2:
    ...
    mov r10, [rbp - 88] # reload L9 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_right_bb4 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_right_bb3 # jump -> then
.L9670_rt_str_pad_right_bb3:
    mov rdx, rbx # hv arg payload
    mov rax, [rbp - 232] # tag L0 from tag-slot
    add rsp, 400 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_pad_right_bb4:
    ...
    mov r10, [rbp - 144] # reload L16 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_right_bb6 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_right_bb5 # jump -> then
.L9670_rt_str_pad_right_bb5:
    mov r10, [rbp - 128] # reload L14 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    ...
    mov r11, [rbp - 376] # tag L18 from tag-slot
    mov [rbp - 344], r11 # store tag L14
    jmp .L9670_rt_str_pad_right_bb6 # branch
.L9670_rt_str_pad_right_bb6:
    call hexa_array_new # array_lit: new array
    mov r10, rdx # array_lit: capture new array payload
    mov [rbp - 384], rax # store tag L19
    mov [rbp - 168], r10 # spill L19 to slot
    ...
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 408], r11 # store tag L22
    jmp .L9670_rt_str_pad_right_bb7 # branch
.L9670_rt_str_pad_right_bb7:
    mov r10, [rbp - 192] # reload L22 from spill slot
    mov r11, [rbp - 128] # reload L14 from spill slot
    cmp r10, r11 # binop <
    setl al # binop < → al
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_pad_right_bb9 # jump-if-zero -> else
    jmp .L9670_rt_str_pad_right_bb8 # jump -> then
.L9670_rt_str_pad_right_bb8:
    mov rsi, [rbp - 176] # reload L20 from spill slot
    mov rsi, rsi # hv arg payload
    mov rdi, [rbp - 392] # tag L20 from tag-slot
    mov rcx, r13 # hv arg payload
...
.L9670_rt_str_repeat_bb0:
    ...
    jz .L9670_rt_str_repeat_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_repeat_bb1 # jump -> then
.L9670_rt_str_repeat_bb1:
...
.L9670_rt_str_repeat_bb2:
    ...
    jmp .L9670_rt_str_repeat_bb3 # branch
.L9670_rt_str_repeat_bb3:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, r12 # binop <
    setl al # binop < → al
    movzx r10, al # zero-extend al into dst
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_repeat_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_repeat_bb4 # jump -> then
.L9670_rt_str_repeat_bb4:
...
.L9670_rt_str_center_bb0:
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_center_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_center_bb1 # jump -> then
.L9670_rt_str_center_bb1:
    mov rdx, rbx # hv arg payload
...
.L9670_rt_str_center_bb2:
    ...
    mov r10, [rbp - 88] # reload L9 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_center_bb4 # jump-if-zero -> else
    jmp .L9670_rt_str_center_bb3 # jump -> then
.L9670_rt_str_center_bb3:
    mov rdx, rbx # hv arg payload
    mov rax, [rbp - 344] # tag L0 from tag-slot
    add rsp, 624 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_center_bb4:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_center_bb6 # jump-if-zero -> else
    jmp .L9670_rt_str_center_bb5 # jump -> then
.L9670_rt_str_center_bb5:
    mov r10, [rbp - 160] # reload L18 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 488], r11 # store tag L18
    jmp .L9670_rt_str_center_bb6 # branch
.L9670_rt_str_center_bb6:
    mov r10, [rbp - 144] # reload L16 from spill slot
    mov r11, [rbp - 64] # reload L6 from spill slot
    mov rax, r10 # idiv dividend → rax
    cqo # sign-extend rax into rdx:rax
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_center_bb8 # jump-if-zero -> else
    jmp .L9670_rt_str_center_bb7 # jump -> then
.L9670_rt_str_center_bb7:
    mov r10, [rbp - 208] # reload L24 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 536], r11 # store tag L24
    jmp .L9670_rt_str_center_bb8 # branch
.L9670_rt_str_center_bb8:
    call hexa_array_new # array_lit: new array
    mov r10, rdx # array_lit: capture new array payload
    ...
    jmp .L9670_rt_str_center_bb9 # branch
.L9670_rt_str_center_bb9:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_center_bb11 # jump-if-zero -> else
    jmp .L9670_rt_str_center_bb10 # jump -> then
.L9670_rt_str_center_bb10:
...
.L9670_rt_str_center_bb11:
    ...
    jmp .L9670_rt_str_center_bb12 # branch
.L9670_rt_str_center_bb12:
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_center_bb14 # jump-if-zero -> else
    jmp .L9670_rt_str_center_bb13 # jump -> then
.L9670_rt_str_center_bb13:
    mov rsi, [rbp - 256] # reload L30 from spill slot
    mov rsi, rsi # hv arg payload
    mov rdi, [rbp - 584] # tag L30 from tag-slot
    mov rcx, r13 # hv arg payload
...
.L9670_rt_str_to_upper_bb0:
    ...
    jmp .L9670_rt_str_to_upper_bb1 # branch
.L9670_rt_str_to_upper_bb1:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, r14 # binop <
    setl al # binop < → al
    movzx r10, al # zero-extend al into dst
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_to_upper_bb3 # jump-if-zero -> else
    jmp .L9670_rt_str_to_upper_bb2 # jump -> then
.L9670_rt_str_to_upper_bb2:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 208] # tag L0 from tag-slot
    ...
    test r10, r10 # br_cond test
    jz .L9670_rt_str_to_upper_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_to_upper_bb4 # jump -> then
.L9670_rt_str_to_upper_bb3:
    mov rsi, [rbp - 56] # reload L5 from spill slot
    mov rsi, rsi # hv arg payload
...
.L9670_rt_str_to_upper_bb4:
    ...
    jmp .L9670_rt_str_to_upper_bb6 # branch
.L9670_rt_str_to_upper_bb5:
    mov r11, [rbp - 96] # reload L10 from spill slot
    mov r10, r11 # assign L11
    mov [rbp - 104], r10 # spill L11 to slot
    ...
    mov [rbp - 296], r11 # store tag L11
    jmp .L9670_rt_str_to_upper_bb6 # branch
.L9670_rt_str_to_upper_bb6:
    mov r10, [rbp - 104] # reload L11 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_to_upper_bb8 # jump-if-zero -> else
    jmp .L9670_rt_str_to_upper_bb7 # jump -> then
.L9670_rt_str_to_upper_bb7:
    mov r10, [rbp - 88] # reload L9 from spill slot
    mov r10, r10 # binop lhs into dst
    sub r10, 97 # binop -
    mov r11, 0 # materialize tag imm 0
    ...
    jmp .L9670_rt_str_to_upper_bb9 # branch
.L9670_rt_str_to_upper_bb8:
    mov r10, [rbp - 64] # reload L6 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
...
.L9670_rt_str_to_lower_bb0:
    ...
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 256], r11 # store tag L6
    jmp .L9670_rt_str_to_lower_bb1 # branch
.L9670_rt_str_to_lower_bb1:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, r14 # binop <
    setl al # binop < → al
    movzx r10, al # zero-extend al into dst
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_to_lower_bb3 # jump-if-zero -> else
    jmp .L9670_rt_str_to_lower_bb2 # jump -> then
.L9670_rt_str_to_lower_bb2:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 208] # tag L0 from tag-slot
    mov rcx, [rbp - 64] # reload L6 from spill slot
    mov rcx, rcx # hv arg payload
    ...
    mov r10, [rbp - 96] # reload L10 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_to_lower_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_to_lower_bb4 # jump -> then
.L9670_rt_str_to_lower_bb3:
    mov rsi, [rbp - 56] # reload L5 from spill slot
    mov rsi, rsi # hv arg payload
    mov rdi, [rbp - 248] # tag L5 from tag-slot
    lea rcx, [rip+.LCstr1] # hv arg payload: &str .LCstr1
...
.L9670_rt_str_to_lower_bb4:
    ...
    mov r11, [rbp - 304] # tag L12 from tag-slot
    mov [rbp - 296], r11 # store tag L11
    jmp .L9670_rt_str_to_lower_bb6 # branch
.L9670_rt_str_to_lower_bb5:
    mov r11, [rbp - 96] # reload L10 from spill slot
    mov r10, r11 # assign L11
    mov [rbp - 104], r10 # spill L11 to slot
    mov r11, [rbp - 288] # tag L10 from tag-slot
    mov [rbp - 296], r11 # store tag L11
    jmp .L9670_rt_str_to_lower_bb6 # branch
.L9670_rt_str_to_lower_bb6:
    mov r10, [rbp - 104] # reload L11 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_to_lower_bb8 # jump-if-zero -> else
    jmp .L9670_rt_str_to_lower_bb7 # jump -> then
.L9670_rt_str_to_lower_bb7:
    mov r10, [rbp - 88] # reload L9 from spill slot
    mov r10, r10 # binop lhs into dst
    sub r10, 65 # binop -
    mov r11, 0 # materialize tag imm 0
    ...
    mov r11, [rbp - 352] # tag L18 from tag-slot
    mov [rbp - 312], r11 # store tag L13
    jmp .L9670_rt_str_to_lower_bb9 # branch
.L9670_rt_str_to_lower_bb8:
    mov r10, [rbp - 64] # reload L6 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
...
.L9670_rt_str_trim_bb0:
    ...
    jmp .L9670_rt_str_trim_bb1 # branch
.L9670_rt_str_trim_bb1:
    cmp r14, r13 # binop <
    setl al # binop < → al
    ...
    jz .L9670_rt_str_trim_bb3 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb2 # jump -> then
.L9670_rt_str_trim_bb2:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 264] # tag L0 from tag-slot
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb4 # jump -> then
.L9670_rt_str_trim_bb3:
    mov r10, r13 # assign L16
    mov [rbp - 144], r10 # spill L16 to slot
    mov r11, [rbp - 280] # tag L2 from tag-slot
    mov [rbp - 392], r11 # store tag L16
    jmp .L9670_rt_str_trim_bb16 # branch
.L9670_rt_str_trim_bb4:
    ...
    jmp .L9670_rt_str_trim_bb6 # branch
.L9670_rt_str_trim_bb5:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, 9 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 328], r11 # store tag L8
    jmp .L9670_rt_str_trim_bb6 # branch
.L9670_rt_str_trim_bb6:
    mov r10, [rbp - 80] # reload L8 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb8 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb7 # jump -> then
.L9670_rt_str_trim_bb7:
    mov r11, [rbp - 80] # reload L8 from spill slot
    mov r10, r11 # assign L10
    mov [rbp - 96], r10 # spill L10 to slot
    mov r11, [rbp - 328] # tag L8 from tag-slot
    mov [rbp - 344], r11 # store tag L10
    jmp .L9670_rt_str_trim_bb9 # branch
.L9670_rt_str_trim_bb8:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, 10 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 344], r11 # store tag L10
    jmp .L9670_rt_str_trim_bb9 # branch
.L9670_rt_str_trim_bb9:
    mov r10, [rbp - 96] # reload L10 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb11 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb10 # jump -> then
.L9670_rt_str_trim_bb10:
    mov r11, [rbp - 96] # reload L10 from spill slot
    mov r10, r11 # assign L12
    mov [rbp - 112], r10 # spill L12 to slot
    mov r11, [rbp - 344] # tag L10 from tag-slot
    mov [rbp - 360], r11 # store tag L12
    jmp .L9670_rt_str_trim_bb12 # branch
.L9670_rt_str_trim_bb11:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, 13 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 360], r11 # store tag L12
    jmp .L9670_rt_str_trim_bb12 # branch
.L9670_rt_str_trim_bb12:
    mov r10, [rbp - 112] # reload L12 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb14 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb13 # jump -> then
.L9670_rt_str_trim_bb13:
    ...
    mov [rbp - 288], r11 # store tag L3
    jmp .L9670_rt_str_trim_bb15 # branch
.L9670_rt_str_trim_bb14:
    jmp .L9670_rt_str_trim_bb3 # branch
.L9670_rt_str_trim_bb15:
    jmp .L9670_rt_str_trim_bb1 # branch
.L9670_rt_str_trim_bb16:
    mov r10, [rbp - 144] # reload L16 from spill slot
    cmp r10, r14 # binop >
    setg al # binop > → al
    movzx r10, al # zero-extend al into dst
    ...
    mov r10, [rbp - 152] # reload L17 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb18 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb17 # jump -> then
.L9670_rt_str_trim_bb17:
    mov r10, [rbp - 144] # reload L16 from spill slot
    mov r10, r10 # binop lhs into dst
    sub r10, 1 # binop -
    mov r11, 0 # materialize tag imm 0
    ...
    mov r10, [rbp - 184] # reload L21 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb20 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb19 # jump -> then
.L9670_rt_str_trim_bb18:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 264] # tag L0 from tag-slot
    mov rcx, r14 # hv arg payload
    mov rdx, [rbp - 288] # tag L3 from tag-slot
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_trim_bb19:
    mov r11, [rbp - 184] # reload L21 from spill slot
    mov r10, r11 # assign L22
    mov [rbp - 192], r10 # spill L22 to slot
    mov r11, [rbp - 432] # tag L21 from tag-slot
    mov [rbp - 440], r11 # store tag L22
    jmp .L9670_rt_str_trim_bb21 # branch
.L9670_rt_str_trim_bb20:
    mov r10, [rbp - 176] # reload L20 from spill slot
    cmp r10, 9 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 440], r11 # store tag L22
    jmp .L9670_rt_str_trim_bb21 # branch
.L9670_rt_str_trim_bb21:
    mov r10, [rbp - 192] # reload L22 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb23 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb22 # jump -> then
.L9670_rt_str_trim_bb22:
    mov r11, [rbp - 192] # reload L22 from spill slot
    mov r10, r11 # assign L24
    mov [rbp - 208], r10 # spill L24 to slot
    mov r11, [rbp - 440] # tag L22 from tag-slot
    mov [rbp - 456], r11 # store tag L24
    jmp .L9670_rt_str_trim_bb24 # branch
.L9670_rt_str_trim_bb23:
    mov r10, [rbp - 176] # reload L20 from spill slot
    cmp r10, 10 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 456], r11 # store tag L24
    jmp .L9670_rt_str_trim_bb24 # branch
.L9670_rt_str_trim_bb24:
    mov r10, [rbp - 208] # reload L24 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb26 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb25 # jump -> then
.L9670_rt_str_trim_bb25:
    mov r11, [rbp - 208] # reload L24 from spill slot
    mov r10, r11 # assign L26
    mov [rbp - 224], r10 # spill L26 to slot
    mov r11, [rbp - 456] # tag L24 from tag-slot
    mov [rbp - 472], r11 # store tag L26
    jmp .L9670_rt_str_trim_bb27 # branch
.L9670_rt_str_trim_bb26:
    mov r10, [rbp - 176] # reload L20 from spill slot
    cmp r10, 13 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 472], r11 # store tag L26
    jmp .L9670_rt_str_trim_bb27 # branch
.L9670_rt_str_trim_bb27:
    mov r10, [rbp - 224] # reload L26 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_bb29 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_bb28 # jump -> then
.L9670_rt_str_trim_bb28:
    mov r10, [rbp - 144] # reload L16 from spill slot
    mov r10, r10 # binop lhs into dst
    sub r10, 1 # binop -
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 392], r11 # store tag L16
    jmp .L9670_rt_str_trim_bb30 # branch
.L9670_rt_str_trim_bb29:
    jmp .L9670_rt_str_trim_bb18 # branch
.L9670_rt_str_trim_bb30:
    jmp .L9670_rt_str_trim_bb16 # branch
    add rsp, 464 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
    pop r15 # epilogue: restore r15
...
.L9670_rt_str_trim_start_bb0:
    ...
    jmp .L9670_rt_str_trim_start_bb1 # branch
.L9670_rt_str_trim_start_bb1:
    cmp r14, r13 # binop <
    setl al # binop < → al
    movzx r15, al # zero-extend al into dst
    mov r11, 2 # materialize tag imm 2
    ...
    test r15, r15 # br_cond test
    jz .L9670_rt_str_trim_start_bb3 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_start_bb2 # jump -> then
.L9670_rt_str_trim_start_bb2:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 152] # tag L0 from tag-slot
    mov rcx, r14 # hv arg payload
    ...
    mov r10, [rbp - 72] # reload L7 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_start_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_start_bb4 # jump -> then
.L9670_rt_str_trim_start_bb3:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 152] # tag L0 from tag-slot
    mov rcx, r14 # hv arg payload
    mov rdx, [rbp - 176] # tag L3 from tag-slot
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_trim_start_bb4:
    mov r11, [rbp - 72] # reload L7 from spill slot
    mov r10, r11 # assign L8
    mov [rbp - 80], r10 # spill L8 to slot
    mov r11, [rbp - 208] # tag L7 from tag-slot
    mov [rbp - 216], r11 # store tag L8
    jmp .L9670_rt_str_trim_start_bb6 # branch
.L9670_rt_str_trim_start_bb5:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, 9 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 216], r11 # store tag L8
    jmp .L9670_rt_str_trim_start_bb6 # branch
.L9670_rt_str_trim_start_bb6:
    mov r10, [rbp - 80] # reload L8 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_start_bb8 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_start_bb7 # jump -> then
.L9670_rt_str_trim_start_bb7:
    mov r11, [rbp - 80] # reload L8 from spill slot
    mov r10, r11 # assign L10
    mov [rbp - 96], r10 # spill L10 to slot
    mov r11, [rbp - 216] # tag L8 from tag-slot
    mov [rbp - 232], r11 # store tag L10
    jmp .L9670_rt_str_trim_start_bb9 # branch
.L9670_rt_str_trim_start_bb8:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, 10 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 232], r11 # store tag L10
    jmp .L9670_rt_str_trim_start_bb9 # branch
.L9670_rt_str_trim_start_bb9:
    mov r10, [rbp - 96] # reload L10 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_start_bb11 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_start_bb10 # jump -> then
.L9670_rt_str_trim_start_bb10:
    mov r11, [rbp - 96] # reload L10 from spill slot
    mov r10, r11 # assign L12
    mov [rbp - 112], r10 # spill L12 to slot
    mov r11, [rbp - 232] # tag L10 from tag-slot
    mov [rbp - 248], r11 # store tag L12
    jmp .L9670_rt_str_trim_start_bb12 # branch
.L9670_rt_str_trim_start_bb11:
    mov r10, [rbp - 64] # reload L6 from spill slot
    cmp r10, 13 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 248], r11 # store tag L12
    jmp .L9670_rt_str_trim_start_bb12 # branch
.L9670_rt_str_trim_start_bb12:
    mov r10, [rbp - 112] # reload L12 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_start_bb14 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_start_bb13 # jump -> then
.L9670_rt_str_trim_start_bb13:
    mov r10, r14 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 176], r11 # store tag L3
    jmp .L9670_rt_str_trim_start_bb15 # branch
.L9670_rt_str_trim_start_bb14:
    jmp .L9670_rt_str_trim_start_bb3 # branch
.L9670_rt_str_trim_start_bb15:
    jmp .L9670_rt_str_trim_start_bb1 # branch
    add rsp, 240 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
    pop r15 # epilogue: restore r15
...
.L9670_rt_str_trim_end_bb0:
    ...
    jmp .L9670_rt_str_trim_end_bb1 # branch
.L9670_rt_str_trim_end_bb1:
    cmp r14, 0 # binop >
    setg al # binop > → al
    movzx r15, al # zero-extend al into dst
    mov r11, 2 # materialize tag imm 2
    ...
    test r15, r15 # br_cond test
    jz .L9670_rt_str_trim_end_bb3 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_end_bb2 # jump -> then
.L9670_rt_str_trim_end_bb2:
    mov r10, r14 # binop lhs into dst
    sub r10, 1 # binop -
    mov r11, 0 # materialize tag imm 0
    ...
    mov r10, [rbp - 80] # reload L8 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_end_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_end_bb4 # jump -> then
.L9670_rt_str_trim_end_bb3:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 160] # tag L0 from tag-slot
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_trim_end_bb4:
    mov r11, [rbp - 80] # reload L8 from spill slot
    mov r10, r11 # assign L9
    mov [rbp - 88], r10 # spill L9 to slot
    mov r11, [rbp - 224] # tag L8 from tag-slot
    mov [rbp - 232], r11 # store tag L9
    jmp .L9670_rt_str_trim_end_bb6 # branch
.L9670_rt_str_trim_end_bb5:
    mov r10, [rbp - 72] # reload L7 from spill slot
    cmp r10, 9 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 232], r11 # store tag L9
    jmp .L9670_rt_str_trim_end_bb6 # branch
.L9670_rt_str_trim_end_bb6:
    mov r10, [rbp - 88] # reload L9 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_end_bb8 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_end_bb7 # jump -> then
.L9670_rt_str_trim_end_bb7:
    mov r11, [rbp - 88] # reload L9 from spill slot
    mov r10, r11 # assign L11
    mov [rbp - 104], r10 # spill L11 to slot
    mov r11, [rbp - 232] # tag L9 from tag-slot
    mov [rbp - 248], r11 # store tag L11
    jmp .L9670_rt_str_trim_end_bb9 # branch
.L9670_rt_str_trim_end_bb8:
    mov r10, [rbp - 72] # reload L7 from spill slot
    cmp r10, 10 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 248], r11 # store tag L11
    jmp .L9670_rt_str_trim_end_bb9 # branch
.L9670_rt_str_trim_end_bb9:
    mov r10, [rbp - 104] # reload L11 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_end_bb11 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_end_bb10 # jump -> then
.L9670_rt_str_trim_end_bb10:
    mov r11, [rbp - 104] # reload L11 from spill slot
    mov r10, r11 # assign L13
    mov [rbp - 120], r10 # spill L13 to slot
    mov r11, [rbp - 248] # tag L11 from tag-slot
    mov [rbp - 264], r11 # store tag L13
    jmp .L9670_rt_str_trim_end_bb12 # branch
.L9670_rt_str_trim_end_bb11:
    mov r10, [rbp - 72] # reload L7 from spill slot
    cmp r10, 13 # binop ==
    sete al # binop == → al
    movzx r10, al # zero-extend al into dst
    ...
    mov [rbp - 264], r11 # store tag L13
    jmp .L9670_rt_str_trim_end_bb12 # branch
.L9670_rt_str_trim_end_bb12:
    mov r10, [rbp - 120] # reload L13 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_trim_end_bb14 # jump-if-zero -> else
    jmp .L9670_rt_str_trim_end_bb13 # jump -> then
.L9670_rt_str_trim_end_bb13:
    mov r10, r14 # binop lhs into dst
    sub r10, 1 # binop -
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 184], r11 # store tag L3
    jmp .L9670_rt_str_trim_end_bb15 # branch
.L9670_rt_str_trim_end_bb14:
    jmp .L9670_rt_str_trim_end_bb3 # branch
.L9670_rt_str_trim_end_bb15:
    jmp .L9670_rt_str_trim_end_bb1 # branch
    add rsp, 256 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
    pop r15 # epilogue: restore r15
...
rt_str_starts_with_b:
    ...
    mov r12, rcx # ingress param payload
.L9670_rt_str_starts_with_b_bb0:
    mov rsi, r12 # hv arg payload
    ...
    mov r10, [rbp - 64] # reload L6 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_starts_with_b_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_starts_with_b_bb1 # jump -> then
.L9670_rt_str_starts_with_b_bb1:
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_starts_with_b_bb2:
    mov r10, 0 # assign L8
    mov [rbp - 80], r10 # spill L8 to slot
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 200], r11 # store tag L8
    jmp .L9670_rt_str_starts_with_b_bb3 # branch
.L9670_rt_str_starts_with_b_bb3:
    mov r10, [rbp - 80] # reload L8 from spill slot
    cmp r10, r14 # binop <
    setl al # binop < → al
    movzx r10, al # zero-extend al into dst
    ...
    mov r10, [rbp - 88] # reload L9 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_starts_with_b_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_starts_with_b_bb4 # jump -> then
.L9670_rt_str_starts_with_b_bb4:
    mov rsi, rbx # hv arg payload
    mov rdi, [rbp - 136] # tag L0 from tag-slot
    ...
    mov r10, [rbp - 112] # reload L12 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_starts_with_b_bb7 # jump-if-zero -> else
    jmp .L9670_rt_str_starts_with_b_bb6 # jump -> then
.L9670_rt_str_starts_with_b_bb5:
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_starts_with_b_bb6:
    mov rdx, 0 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 208 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_starts_with_b_bb7:
    mov r10, [rbp - 80] # reload L8 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    mov [rbp - 248], r11 # store tag L14
    mov [rbp - 128], r10 # spill L14 to slot
    mov r11, [rbp - 128] # reload L14 from spill slot
    mov r10, r11 # assign L8
    mov [rbp - 80], r10 # spill L8 to slot
...
.L9670_rt_str_ends_with_b_bb0:
    ...
    mov r10, [rbp - 64] # reload L6 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_ends_with_b_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_ends_with_b_bb1 # jump -> then
.L9670_rt_str_ends_with_b_bb1:
    mov rdx, 0 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 256 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_ends_with_b_bb2:
    ...
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 240], r11 # store tag L10
    jmp .L9670_rt_str_ends_with_b_bb3 # branch
.L9670_rt_str_ends_with_b_bb3:
    mov r10, [rbp - 96] # reload L10 from spill slot
    cmp r10, r14 # binop <
    setl al # binop < → al
    movzx r10, al # zero-extend al into dst
    ...
    mov r10, [rbp - 104] # reload L11 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_ends_with_b_bb5 # jump-if-zero -> else
    jmp .L9670_rt_str_ends_with_b_bb4 # jump -> then
.L9670_rt_str_ends_with_b_bb4:
    mov r10, [rbp - 88] # reload L9 from spill slot
    mov r11, [rbp - 96] # reload L10 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, r11 # binop +
    ...
    mov r10, [rbp - 136] # reload L15 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_ends_with_b_bb7 # jump-if-zero -> else
    jmp .L9670_rt_str_ends_with_b_bb6 # jump -> then
.L9670_rt_str_ends_with_b_bb5:
    mov rdx, 1 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 256 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_ends_with_b_bb6:
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_ends_with_b_bb7:
    mov r10, [rbp - 96] # reload L10 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    mov [rbp - 296], r11 # store tag L17
    mov [rbp - 152], r10 # spill L17 to slot
    mov r11, [rbp - 152] # reload L17 from spill slot
    mov r10, r11 # assign L10
    mov [rbp - 96], r10 # spill L10 to slot
...
.L9670_rt_str_contains_b_bb0:
    ...
    mov r10, [rbp - 64] # reload L6 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_contains_b_bb2 # jump-if-zero -> else
    jmp .L9670_rt_str_contains_b_bb1 # jump -> then
.L9670_rt_str_contains_b_bb1:
    mov rdx, 1 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 352 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_contains_b_bb2:
    ...
    mov r10, [rbp - 80] # reload L8 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_contains_b_bb4 # jump-if-zero -> else
    jmp .L9670_rt_str_contains_b_bb3 # jump -> then
.L9670_rt_str_contains_b_bb3:
    mov rdx, 0 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 352 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
    ...
    pop rbp # epilogue: restore rbp
    ret # return
.L9670_rt_str_contains_b_bb4:
    mov r10, 0 # assign L10
    mov [rbp - 96], r10 # spill L10 to slot
    mov r11, 0 # tag default = TAG_INT
    mov [rbp - 288], r11 # store tag L10
    jmp .L9670_rt_str_contains_b_bb5 # branch
.L9670_rt_str_contains_b_bb5:
    mov r10, [rbp - 96] # reload L10 from spill slot
    mov r11, [rbp - 56] # reload L5 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, r11 # binop +
    ...
    mov r10, [rbp - 112] # reload L12 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_contains_b_bb7 # jump-if-zero -> else
    jmp .L9670_rt_str_contains_b_bb6 # jump -> then
.L9670_rt_str_contains_b_bb6:
    ...
    mov [rbp - 320], r11 # store tag L14
    jmp .L9670_rt_str_contains_b_bb8 # branch
.L9670_rt_str_contains_b_bb7:
    mov rdx, 0 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 352 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
...
.L9670_rt_str_contains_b_bb8:
    ...
    mov r10, [rbp - 136] # reload L15 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_contains_b_bb10 # jump-if-zero -> else
    jmp .L9670_rt_str_contains_b_bb9 # jump -> then
.L9670_rt_str_contains_b_bb9:
    mov r10, [rbp - 96] # reload L10 from spill slot
    mov r11, [rbp - 120] # reload L13 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, r11 # binop +
    ...
    mov r10, [rbp - 168] # reload L19 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_contains_b_bb12 # jump-if-zero -> else
    jmp .L9670_rt_str_contains_b_bb11 # jump -> then
.L9670_rt_str_contains_b_bb10:
    mov r10, [rbp - 128] # reload L14 from spill slot
    test r10, r10 # br_cond test
    jz .L9670_rt_str_contains_b_bb15 # jump-if-zero -> else
    jmp .L9670_rt_str_contains_b_bb14 # jump -> then
.L9670_rt_str_contains_b_bb11:
    ...
    mov [rbp - 312], r11 # store tag L13
    jmp .L9670_rt_str_contains_b_bb13 # branch
.L9670_rt_str_contains_b_bb12:
    mov r10, [rbp - 120] # reload L13 from spill slot
    mov r10, r10 # binop lhs into dst
    add r10, 1 # binop +
    mov r11, 0 # materialize tag imm 0
    ...
    mov [rbp - 312], r11 # store tag L13
    jmp .L9670_rt_str_contains_b_bb13 # branch
.L9670_rt_str_contains_b_bb13:
    jmp .L9670_rt_str_contains_b_bb8 # branch
.L9670_rt_str_contains_b_bb14:
    mov rdx, 1 # hv arg payload
    mov rax, 2 # tag const_bool = TAG_BOOL
    add rsp, 352 # epilogue: free spill frame
    add rsp, 8 # epilogue: drop callee-save align pad
