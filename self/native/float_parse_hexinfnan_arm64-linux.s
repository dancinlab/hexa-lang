...
_La4b0_hpx_round_shift_bb6:
    ...
    stp x0, x1, [sp, #304] // hv store L19
    b _La4b0_hpx_round_shift_bb15 // branch
_La4b0_hpx_round_shift_bb7:
    ...
    cbz x1, _La4b0_hpx_round_shift_bb9 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb8 // branch -> then
_La4b0_hpx_round_shift_bb8:
    ...
    cbz x1, _La4b0_hpx_round_shift_bb11 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb10 // branch -> then
...
_La4b0_hpx_round_shift_bb11:
    ...
    cbz x1, _La4b0_hpx_round_shift_bb13 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb12 // branch -> then
_La4b0_hpx_round_shift_bb12:
    ...
    stp x0, x1, [sp, #304] // hv store L19
    b _La4b0_hpx_round_shift_bb13 // branch
_La4b0_hpx_round_shift_bb13:
    b _La4b0_hpx_round_shift_bb14 // branch
_La4b0_hpx_round_shift_bb14:
    b _La4b0_hpx_round_shift_bb9 // branch
_La4b0_hpx_round_shift_bb15:
    ...
    add x15, sp, #512 // hv frame base
    ldp x0, x1, [x15] // hv load L32
    cbz x1, _La4b0_hpx_round_shift_bb17 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb16 // branch -> then
_La4b0_hpx_round_shift_bb16:
    ...
    cbz x1, _La4b0_hpx_round_shift_bb19 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb18 // branch -> then
_La4b0_hpx_round_shift_bb17:
    ...
    cbz x1, _La4b0_hpx_round_shift_bb23 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb22 // branch -> then
_La4b0_hpx_round_shift_bb18:
    ...
    add x15, sp, #624 // hv frame base
    ldp x0, x1, [x15] // hv load L39
    cbz x1, _La4b0_hpx_round_shift_bb21 // br_cond: !payload -> else
    b _La4b0_hpx_round_shift_bb20 // branch -> then
...
_La4b0_hpx_nan_payload_bb1:
    ...
    stp x0, x1, [sp, #208] // hv store L13
    ldp x0, x1, [sp, #208] // hv load L13
    cbz x1, _La4b0_hpx_nan_payload_bb4 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb3 // branch -> then
_La4b0_hpx_nan_payload_bb2:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    stp x0, x1, [sp, #320] // hv store L20
    b _La4b0_hpx_nan_payload_bb11 // branch
_La4b0_hpx_nan_payload_bb3:
    ...
    stp x0, x1, [sp, #240] // hv store L15
    ldp x0, x1, [sp, #240] // hv load L15
    cbz x1, _La4b0_hpx_nan_payload_bb6 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb5 // branch -> then
_La4b0_hpx_nan_payload_bb4:
    ldp x0, x1, [sp, #208] // hv load L13
    stp x0, x1, [sp, #224] // hv store L14
    b _La4b0_hpx_nan_payload_bb8 // branch
...
_La4b0_hpx_nan_payload_bb8:
    ldp x0, x1, [sp, #224] // hv load L14
    cbz x1, _La4b0_hpx_nan_payload_bb10 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb9 // branch -> then
...
_La4b0_hpx_nan_payload_bb10:
    b _La4b0_hpx_nan_payload_bb2 // branch
_La4b0_hpx_nan_payload_bb11:
    ...
    cbz x1, _La4b0_hpx_nan_payload_bb13 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb12 // branch -> then
_La4b0_hpx_nan_payload_bb12:
    ...
    stp x0, x1, [sp, #384] // hv store L24
    ldp x0, x1, [sp, #384] // hv load L24
    cbz x1, _La4b0_hpx_nan_payload_bb15 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb14 // branch -> then
...
_La4b0_hpx_nan_payload_bb15:
    ...
    stp x0, x1, [sp, #464] // hv store L29
    ldp x0, x1, [sp, #464] // hv load L29
    cbz x1, _La4b0_hpx_nan_payload_bb17 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb16 // branch -> then
_La4b0_hpx_nan_payload_bb16:
    ...
    ldp x0, x1, [sp, #496] // hv load L31
    stp x0, x1, [sp, #480] // hv store L30
    b _La4b0_hpx_nan_payload_bb18 // branch
...
_La4b0_hpx_nan_payload_bb18:
    ldp x0, x1, [sp, #480] // hv load L30
    cbz x1, _La4b0_hpx_nan_payload_bb20 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb19 // branch -> then
_La4b0_hpx_nan_payload_bb19:
    ...
    ldp x0, x1, [x15] // hv load L33
    stp x0, x1, [sp, #448] // hv store L28
    b _La4b0_hpx_nan_payload_bb38 // branch
_La4b0_hpx_nan_payload_bb20:
    ...
    add x15, sp, #544 // hv frame base
    ldp x0, x1, [x15] // hv load L34
    cbz x1, _La4b0_hpx_nan_payload_bb22 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb21 // branch -> then
_La4b0_hpx_nan_payload_bb21:
    ...
    add x15, sp, #560 // hv frame base
    stp x0, x1, [x15] // hv store L35
    b _La4b0_hpx_nan_payload_bb23 // branch
...
_La4b0_hpx_nan_payload_bb23:
    add x15, sp, #560 // hv frame base
    ldp x0, x1, [x15] // hv load L35
    cbz x1, _La4b0_hpx_nan_payload_bb25 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb24 // branch -> then
_La4b0_hpx_nan_payload_bb24:
    ...
    add x15, sp, #592 // hv frame base
    stp x0, x1, [x15] // hv store L37
    b _La4b0_hpx_nan_payload_bb26 // branch
...
_La4b0_hpx_nan_payload_bb26:
    add x15, sp, #592 // hv frame base
    ldp x0, x1, [x15] // hv load L37
    cbz x1, _La4b0_hpx_nan_payload_bb28 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb27 // branch -> then
_La4b0_hpx_nan_payload_bb27:
    ...
    ldp x0, x1, [x15] // hv load L40
    stp x0, x1, [sp, #448] // hv store L28
    b _La4b0_hpx_nan_payload_bb37 // branch
_La4b0_hpx_nan_payload_bb28:
    ...
    add x15, sp, #656 // hv frame base
    ldp x0, x1, [x15] // hv load L41
    cbz x1, _La4b0_hpx_nan_payload_bb30 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb29 // branch -> then
...
_La4b0_hpx_nan_payload_bb35:
    ...
    ldp x0, x1, [x15] // hv load L47
    stp x0, x1, [sp, #448] // hv store L28
    b _La4b0_hpx_nan_payload_bb36 // branch
...
_La4b0_hpx_nan_payload_bb38:
    ...
    add x15, sp, #768 // hv frame base
    ldp x0, x1, [x15] // hv load L48
    cbz x1, _La4b0_hpx_nan_payload_bb40 // br_cond: !payload -> else
    b _La4b0_hpx_nan_payload_bb39 // branch -> then
_La4b0_hpx_nan_payload_bb39:
    add x15, sp, #768 // hv frame base
    ldp x0, x1, [x15] // hv load L48
    add x15, sp, #784 // hv frame base
    stp x0, x1, [x15] // hv store L49
    b _La4b0_hpx_nan_payload_bb41 // branch
...
_La4b0_hpx_nan_payload_bb42:
    b _La4b0_hpx_nan_payload_bb13 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb16:
    ...
    stp x0, x1, [sp, #336] // hv store L21
    ldp x0, x1, [sp, #336] // hv load L21
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb19 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb18 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb17:
    ...
    stp x0, x1, [sp, #432] // hv store L27
    ldp x0, x1, [sp, #432] // hv load L27
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb24 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb23 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb18:
    ...
    ldp x0, x1, [sp, #368] // hv load L23
    stp x0, x1, [sp, #48] // hv store L3
    b _La4b0_rt_str_parse_float_hexinfnan_bb22 // branch
_La4b0_rt_str_parse_float_hexinfnan_bb19:
    ...
    stp x0, x1, [sp, #384] // hv store L24
    ldp x0, x1, [sp, #384] // hv load L24
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb21 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb20 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb22:
    b _La4b0_rt_str_parse_float_hexinfnan_bb17 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb24:
    ...
    add x15, sp, #544 // hv frame base
    ldp x0, x1, [x15] // hv load L34
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb26 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb25 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb26:
    ...
    add x15, sp, #880 // hv frame base
    ldp x0, x1, [x15] // hv load L55
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb41 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb40 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb27:
    ...
    add x15, sp, #608 // hv frame base
    ldp x0, x1, [x15] // hv load L38
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb31 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb30 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb28:
    ...
    add x15, sp, #720 // hv frame base
    ldp x0, x1, [x15] // hv load L45
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb34 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb33 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb29:
    ...
    add x15, sp, #784 // hv frame base
    ldp x0, x1, [x15] // hv load L49
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb36 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb35 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb30:
    ...
    add x15, sp, #624 // hv frame base
    stp x0, x1, [x15] // hv store L39
    b _La4b0_rt_str_parse_float_hexinfnan_bb32 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb32:
    add x15, sp, #624 // hv frame base
    ldp x0, x1, [x15] // hv load L39
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb29 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb28 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb33:
    b _La4b0_rt_str_parse_float_hexinfnan_bb29 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb35:
    ...
    add x15, sp, #800 // hv frame base
    stp x0, x1, [x15] // hv store L50
    b _La4b0_rt_str_parse_float_hexinfnan_bb37 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb37:
    add x15, sp, #800 // hv frame base
    ldp x0, x1, [x15] // hv load L50
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb39 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb38 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb40:
    ...
    add x15, sp, #928 // hv frame base
    ldp x0, x1, [x15] // hv load L58
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb43 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb42 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb44:
    ...
    b _La4b0_rt_str_parse_float_hexinfnan_bb46 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb46:
    ...
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb48 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb47 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb50:
    ...
    add x15, sp, #1136 // hv frame base
    stp x0, x1, [x15] // hv store L71
    b _La4b0_rt_str_parse_float_hexinfnan_bb51 // branch
_La4b0_rt_str_parse_float_hexinfnan_bb51:
    ...
    add x15, sp, #1248 // hv frame base
    ldp x0, x1, [x15] // hv load L78
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb53 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb52 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb52:
    ...
    add x15, sp, #1312 // hv frame base
    ldp x0, x1, [x15] // hv load L82
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb55 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb54 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb58:
    ...
    add x15, sp, #1552 // hv frame base
    stp x0, x1, [x15] // hv store L97
    b _La4b0_rt_str_parse_float_hexinfnan_bb60 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb60:
    add x15, sp, #1552 // hv frame base
    ldp x0, x1, [x15] // hv load L97
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb62 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb61 // branch -> then
_La4b0_rt_str_parse_float_hexinfnan_bb61:
    ...
    add x15, sp, #1664 // hv frame base
    ldp x0, x1, [x15] // hv load L104
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb64 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb63 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb63:
    ...
    add x15, sp, #1680 // hv frame base
    stp x0, x1, [x15] // hv store L105
    b _La4b0_rt_str_parse_float_hexinfnan_bb65 // branch
...
_La4b0_rt_str_parse_float_hexinfnan_bb65:
    ...
    cbz x1, _La4b0_rt_str_parse_float_hexinfnan_bb67 // br_cond: !payload -> else
    b _La4b0_rt_str_parse_float_hexinfnan_bb66 // branch -> then
...
_La4b0_rt_str_parse_float_hexinfnan_bb67:
    b _La4b0_rt_str_parse_float_hexinfnan_bb62 // branch
    movz x0, #4 // ret void: TAG_VOID
    movz x1, #0 // ret void: payload 0
    add sp, sp, #1776 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
