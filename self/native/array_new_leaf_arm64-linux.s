...
//   ABI: ELF aarch64, no underscore. External U-floor: hexa_heap_zalloc hexa_exit hexa_bool — CARRIER-ONLY (HexaVal-ABI); a raw libc U here is a
...
_L0635_hexa_array_new_bb0:
    ...
    cbz x1, _L0635_hexa_array_new_bb2 // br_cond: !payload -> else
    b _L0635_hexa_array_new_bb1 // branch -> then
_L0635_hexa_array_new_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    bl hexa_exit // call hexa_exit
    stp x0, x1, [sp, #64] // hv store L4
    b _L0635_hexa_array_new_bb2 // branch
_L0635_hexa_array_new_bb2:
    movz x0, #0 // hv const_int: TAG_INT
