// arr_zeros_leaf_arm64.s — FROZEN BOOTSTRAP SEED (RT-NATIVE — array ZEROS-LEAF constructors).
...
//   ABI: Mach-O, _-prefixed. External U-floor: hexa_heap_alloc hexa_heap_zalloc hexa_throw hexa_bool — CARRIER-ONLY (HexaVal-ABI); a raw libc U here is a
...
__Lef60_hexa_arr_zeros_leaf_bb0:
    ...
    cbz x1, __Lef60_hexa_arr_zeros_leaf_bb2 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_bb1 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_bb1:
    ...
    b __Lef60_hexa_arr_zeros_leaf_bb2 ; branch
__Lef60_hexa_arr_zeros_leaf_bb2:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __Lef60_hexa_arr_zeros_leaf_bb4 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_bb3 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    stp x0, x1, [sp, #160] ; hv store L10
    b __Lef60_hexa_arr_zeros_leaf_bb5 ; branch
__Lef60_hexa_arr_zeros_leaf_bb4:
    ldp x0, x1, [sp, #0] ; hv load L0
    ...
    stp x0, x1, [sp, #160] ; hv store L10
    b __Lef60_hexa_arr_zeros_leaf_bb5 ; branch
__Lef60_hexa_arr_zeros_leaf_bb5:
    ...
    cbz x1, __Lef60_hexa_arr_zeros_leaf_bb7 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_bb6 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_bb6:
    ldp x0, x1, [sp, #160] ; hv load L10
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __Lef60_hexa_arr_zeros_leaf_bb9 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_bb8 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_bb7:
    ldp x0, x1, [sp, #112] ; hv load L7
    add sp, sp, #608 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Lef60_hexa_arr_zeros_leaf_bb8:
    movz x0, #3 ; hv const_str: TAG_STR
    adrp x1, .LCstr0@PAGE ; hv str ptr page
    add x1, x1, .LCstr0@PAGEOFF ; hv str ptr off
    bl _hexa_throw ; call hexa_throw
    stp x0, x1, [sp, #368] ; hv store L23
    b __Lef60_hexa_arr_zeros_leaf_bb9 ; branch
__Lef60_hexa_arr_zeros_leaf_bb9:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    b __Lef60_hexa_arr_zeros_leaf_bb10 ; branch
__Lef60_hexa_arr_zeros_leaf_bb10:
    ldp x0, x1, [sp, #432] ; hv load L27
    cbz x1, __Lef60_hexa_arr_zeros_leaf_bb12 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_bb11 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_bb11:
    ldp x0, x1, [sp, #320] ; hv load L20
    ...
    stp x0, x1, [sp, #432] ; hv store L27
    b __Lef60_hexa_arr_zeros_leaf_bb10 ; branch
__Lef60_hexa_arr_zeros_leaf_bb12:
    ldp x0, x1, [sp, #32] ; hv load L2
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    b __Lef60_hexa_arr_zeros_leaf_bb7 ; branch
...
_hexa_arr_zeros_leaf_int:
    ...
    sub sp, sp, #608 ; sp adj
    stp x0, x1, [sp, #0] ; ingress param 0
__Lef60_hexa_arr_zeros_leaf_int_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #32 ; hv const_int val
    bl _hexa_heap_zalloc ; call hexa_heap_zalloc
    stp x0, x1, [sp, #16] ; hv store L1
    ...
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    cbz x1, __Lef60_hexa_arr_zeros_leaf_int_bb2 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_int_bb1 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_int_bb1:
    movz x0, #3 ; hv const_str: TAG_STR
    adrp x1, .LCstr1@PAGE ; hv str ptr page
    add x1, x1, .LCstr1@PAGEOFF ; hv str ptr off
    bl _hexa_throw ; call hexa_throw
    stp x0, x1, [sp, #80] ; hv store L5
    b __Lef60_hexa_arr_zeros_leaf_int_bb2 ; branch
__Lef60_hexa_arr_zeros_leaf_int_bb2:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #5 ; hv const_int val
    ldp x2, x3, [sp, #32] ; hv load L2
    mov x0, x1 ; __hx_make_val: lo = tag word
    ...
    stp x0, x1, [sp, #176] ; hv store L11
    ldp x0, x1, [sp, #176] ; hv load L11
    cbz x1, __Lef60_hexa_arr_zeros_leaf_int_bb4 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_int_bb3 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_int_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    ldp x0, x1, [sp, #208] ; hv load L13
    stp x0, x1, [sp, #160] ; hv store L10
    b __Lef60_hexa_arr_zeros_leaf_int_bb5 ; branch
__Lef60_hexa_arr_zeros_leaf_int_bb4:
    ldp x0, x1, [sp, #0] ; hv load L0
    fmov d0, x1 ; __hx_payload_f2i: d0 = v.f bits
    fcvtzs x1, d0 ; __hx_payload_f2i: x1 = (i64)trunc(v.f)
    movz x0, #0 ; __hx_payload_f2i: TAG_INT
    ...
    stp x0, x1, [sp, #160] ; hv store L10
    b __Lef60_hexa_arr_zeros_leaf_int_bb5 ; branch
__Lef60_hexa_arr_zeros_leaf_int_bb5:
    ldp x0, x1, [sp, #160] ; hv load L10
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    cmp x1, x3 ; __hx_payload_ge: cmp payloads
    ...
    stp x0, x1, [sp, #240] ; hv store L15
    ldp x0, x1, [sp, #240] ; hv load L15
    cbz x1, __Lef60_hexa_arr_zeros_leaf_int_bb7 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_int_bb6 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_int_bb6:
    ldp x0, x1, [sp, #160] ; hv load L10
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #16 ; hv const_int val
    mul x1, x1, x3 ; __hx_payload_mul: x1 = a.pl mul b.pl
    ...
    stp x0, x1, [sp, #336] ; hv store L21
    ldp x0, x1, [sp, #336] ; hv load L21
    cbz x1, __Lef60_hexa_arr_zeros_leaf_int_bb9 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_int_bb8 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_int_bb7:
    ldp x0, x1, [sp, #112] ; hv load L7
    add sp, sp, #608 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__Lef60_hexa_arr_zeros_leaf_int_bb8:
    movz x0, #3 ; hv const_str: TAG_STR
    adrp x1, .LCstr1@PAGE ; hv str ptr page
    add x1, x1, .LCstr1@PAGEOFF ; hv str ptr off
    bl _hexa_throw ; call hexa_throw
    stp x0, x1, [sp, #368] ; hv store L23
    b __Lef60_hexa_arr_zeros_leaf_int_bb9 ; branch
__Lef60_hexa_arr_zeros_leaf_int_bb9:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    stp x0, x1, [sp, #384] ; hv store L24
    ldp x0, x1, [sp, #160] ; hv load L10
    ...
    ldp x0, x1, [sp, #416] ; hv load L26
    stp x0, x1, [sp, #432] ; hv store L27
    b __Lef60_hexa_arr_zeros_leaf_int_bb10 ; branch
__Lef60_hexa_arr_zeros_leaf_int_bb10:
    ldp x0, x1, [sp, #432] ; hv load L27
    cbz x1, __Lef60_hexa_arr_zeros_leaf_int_bb12 ; br_cond: !payload -> else
    b __Lef60_hexa_arr_zeros_leaf_int_bb11 ; branch -> then
__Lef60_hexa_arr_zeros_leaf_int_bb11:
    ldp x0, x1, [sp, #320] ; hv load L20
    ldp x2, x3, [sp, #384] ; hv load L24
    movz x4, #0 ; hv const_int: TAG_INT
    movz x5, #0 ; hv const_int val
    ...
    stp x0, x1, [sp, #432] ; hv store L27
    b __Lef60_hexa_arr_zeros_leaf_int_bb10 ; branch
__Lef60_hexa_arr_zeros_leaf_int_bb12:
    ldp x0, x1, [sp, #32] ; hv load L2
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ldp x4, x5, [sp, #320] ; hv load L20
    ...
    add x15, sp, #592 ; hv frame base
    stp x0, x1, [x15] ; hv store L37
    b __Lef60_hexa_arr_zeros_leaf_int_bb7 ; branch
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
    add sp, sp, #608 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
