...
SYS_LINUX_NANOSLEEP:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_LINUX_NANOSLEEP_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_GETDENTS64:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_LINUX_GETDENTS64_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_CLOCK_GETTIME:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_LINUX_CLOCK_GETTIME_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_EXIT_GROUP:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_LINUX_EXIT_GROUP_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_GETRANDOM:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_LINUX_GETRANDOM_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_DARWIN_GETDIRENTRIES:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_DARWIN_GETDIRENTRIES_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_DARWIN_GETDIRENTRIES64:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_DARWIN_GETDIRENTRIES64_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_DARWIN_NANOSLEEP:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_DARWIN_NANOSLEEP_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #197 // imm 0-15
    movk x1, #512, lsl #16 // imm 16-31
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
...
SYS_DARWIN_CLOCK_GETTIME:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_SYS_DARWIN_CLOCK_GETTIME_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
_La3fa_sys_read_bb0:
    ...
    cbz x0, _La3fa_sys_read_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_read_bb1 // branch -> then
_La3fa_sys_read_bb1:
...
sys_write:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_La3fa_sys_write_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_write_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_write_bb1 // branch -> then
_La3fa_sys_write_bb1:
...
_La3fa_sys_open_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_open_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_open_bb1 // branch -> then
_La3fa_sys_open_bb1:
...
sys_close:
    ...
    sub sp, sp, #112 // sp adj
    stp x0, x1, [sp, #0] // ingress param 0
_La3fa_sys_close_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #16] // hv store L1
    ldp x0, x1, [sp, #16] // hv load L1
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_close_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_close_bb1 // branch -> then
_La3fa_sys_close_bb1:
...
sys_lseek:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_La3fa_sys_lseek_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_lseek_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_lseek_bb1 // branch -> then
_La3fa_sys_lseek_bb1:
...
sys_unlink:
    ...
    sub sp, sp, #112 // sp adj
    stp x0, x1, [sp, #0] // ingress param 0
_La3fa_sys_unlink_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #16] // hv store L1
    ldp x0, x1, [sp, #16] // hv load L1
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_unlink_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_unlink_bb1 // branch -> then
_La3fa_sys_unlink_bb1:
...
sys_mkdir:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_La3fa_sys_mkdir_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_mkdir_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_mkdir_bb1 // branch -> then
_La3fa_sys_mkdir_bb1:
...
_La3fa_sys_mmap_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_mmap_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_mmap_bb1 // branch -> then
_La3fa_sys_mmap_bb1:
...
sys_munmap:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_La3fa_sys_munmap_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_munmap_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_munmap_bb1 // branch -> then
_La3fa_sys_munmap_bb1:
...
_La3fa_sys_exit_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_exit_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_exit_bb1 // branch -> then
_La3fa_sys_exit_bb1:
...
sys_getrandom:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_La3fa_sys_getrandom_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_getrandom_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_getrandom_bb1 // branch -> then
_La3fa_sys_getrandom_bb1:
...
_La3fa_sys_getrandom_bb2:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_getrandom_bb4 // br_cond: !truthy -> else
    b _La3fa_sys_getrandom_bb3 // branch -> then
_La3fa_sys_getrandom_bb3:
    ldp x0, x1, [sp, #144] // hv load L9
    add sp, sp, #240 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_La3fa_sys_getrandom_bb4:
    ldp x0, x1, [sp, #144] // hv load L9
    ldp x2, x3, [sp, #0] // hv load L0
    ldp x4, x5, [sp, #16] // hv load L1
...
sys_clock_gettime:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_La3fa_sys_clock_gettime_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_clock_gettime_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_clock_gettime_bb1 // branch -> then
_La3fa_sys_clock_gettime_bb1:
...
_La3fa_sys_fork_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_fork_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_fork_bb1 // branch -> then
_La3fa_sys_fork_bb1:
...
sys_execve:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_La3fa_sys_execve_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_execve_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_execve_bb1 // branch -> then
_La3fa_sys_execve_bb1:
...
_La3fa_sys_wait4_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #80] // hv store L4
    ldp x0, x1, [sp, #80] // hv load L4
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_wait4_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_wait4_bb1 // branch -> then
_La3fa_sys_wait4_bb1:
...
_La3fa_sys_pipe_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_pipe_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_pipe_bb1 // branch -> then
_La3fa_sys_pipe_bb1:
...
_La3fa_sys_dup2_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_dup2_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_dup2_bb1 // branch -> then
_La3fa_sys_dup2_bb1:
...
sys_nanosleep:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_La3fa_sys_nanosleep_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_sys_nanosleep_bb2 // br_cond: !truthy -> else
    b _La3fa_sys_nanosleep_bb1 // branch -> then
_La3fa_sys_nanosleep_bb1:
...
flag_o_creat:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_La3fa_flag_o_creat_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_flag_o_creat_bb2 // br_cond: !truthy -> else
    b _La3fa_flag_o_creat_bb1 // branch -> then
_La3fa_flag_o_creat_bb1:
...
flag_o_append:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_La3fa_flag_o_append_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_flag_o_append_bb2 // br_cond: !truthy -> else
    b _La3fa_flag_o_append_bb1 // branch -> then
_La3fa_flag_o_append_bb1:
...
flag_o_trunc:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_La3fa_flag_o_trunc_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_flag_o_trunc_bb2 // br_cond: !truthy -> else
    b _La3fa_flag_o_trunc_bb1 // branch -> then
_La3fa_flag_o_trunc_bb1:
...
flag_map_anon:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_La3fa_flag_map_anon_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_flag_map_anon_bb2 // br_cond: !truthy -> else
    b _La3fa_flag_map_anon_bb1 // branch -> then
_La3fa_flag_map_anon_bb1:
...
CLOCK_MONOTONIC_LINUX:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_CLOCK_MONOTONIC_LINUX_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
...
CLOCK_MONOTONIC_DARWIN:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_La3fa_CLOCK_MONOTONIC_DARWIN_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
clock_monotonic:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_La3fa_clock_monotonic_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_clock_monotonic_bb2 // br_cond: !truthy -> else
    b _La3fa_clock_monotonic_bb1 // branch -> then
_La3fa_clock_monotonic_bb1:
...
_La3fa___arena_grow_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa___arena_grow_bb2 // br_cond: !truthy -> else
    b _La3fa___arena_grow_bb1 // branch -> then
_La3fa___arena_grow_bb1:
    movz x0, #0 // hv const_int: TAG_INT
...
_La3fa_page_alloc_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_page_alloc_bb2 // br_cond: !truthy -> else
    b _La3fa_page_alloc_bb1 // branch -> then
_La3fa_page_alloc_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #137 // hv const_int val
    bl sys_exit // call sys_exit
    stp x0, x1, [sp, #272] // hv store L15
...
_La3fa_rt_init_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_rt_init_bb2 // br_cond: !truthy -> else
    b _La3fa_rt_init_bb1 // branch -> then
_La3fa_rt_init_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #137 // hv const_int val
    bl sys_exit // call sys_exit
...
_La3fa_hexa_arena_mark_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_arena_mark_bb2 // br_cond: !truthy -> else
    b _La3fa_hexa_arena_mark_bb1 // branch -> then
_La3fa_hexa_arena_mark_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // imm 0-15
    mvn x1, x1 // hv const_int: negate
    add sp, sp, #176 // sp adj
...
_La3fa_hexa_arena_rewind_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_arena_rewind_bb2 // br_cond: !truthy -> else
    b _La3fa_hexa_arena_rewind_bb1 // branch -> then
_La3fa_hexa_arena_rewind_bb1:
...
_La3fa_hexa_arena_rewind_bb2:
    ...
    b _La3fa_hexa_arena_rewind_bb3 // branch
_La3fa_hexa_arena_rewind_bb3:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_arena_rewind_bb5 // br_cond: !truthy -> else
    b _La3fa_hexa_arena_rewind_bb4 // branch -> then
_La3fa_hexa_arena_rewind_bb4:
    ldp x0, x1, [sp, #240] // hv load L15
...
hexa_arena_reset:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #128 // sp adj
_La3fa_hexa_arena_reset_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    stp x0, x1, [sp, #0] // hv store L0
    b _La3fa_hexa_arena_reset_bb1 // branch
_La3fa_hexa_arena_reset_bb1:
    bl __a_np // call __a_np
    stp x0, x1, [sp, #16] // hv store L1
    ldp x0, x1, [sp, #0] // hv load L0
    ldp x2, x3, [sp, #16] // hv load L1
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_arena_reset_bb3 // br_cond: !truthy -> else
    b _La3fa_hexa_arena_reset_bb2 // branch -> then
_La3fa_hexa_arena_reset_bb2:
    ldp x0, x1, [sp, #0] // hv load L0
    bl __p_base // call __p_base
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #0] // hv load L0
...
_La3fa_hexa_ptr_alloc_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_ptr_alloc_bb2 // br_cond: !truthy -> else
    b _La3fa_hexa_ptr_alloc_bb1 // branch -> then
_La3fa_hexa_ptr_alloc_bb1:
    ldp x0, x1, [sp, #32] // hv load L2
...
_La3fa_hexa_ptr_alloc_bb2:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_ptr_alloc_bb4 // br_cond: !truthy -> else
    b _La3fa_hexa_ptr_alloc_bb3 // branch -> then
_La3fa_hexa_ptr_alloc_bb3:
    bl __arena_grow // call __arena_grow
    stp x0, x1, [sp, #176] // hv store L11
    b _La3fa_hexa_ptr_alloc_bb4 // branch
_La3fa_hexa_ptr_alloc_bb4:
    bl __a_np // call __a_np
    stp x0, x1, [sp, #192] // hv store L12
    ldp x0, x1, [sp, #192] // hv load L12
    movz x2, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_ptr_alloc_bb6 // br_cond: !truthy -> else
    b _La3fa_hexa_ptr_alloc_bb5 // branch -> then
_La3fa_hexa_ptr_alloc_bb5:
    bl __arena_grow // call __arena_grow
    stp x0, x1, [sp, #320] // hv store L20
    b _La3fa_hexa_ptr_alloc_bb6 // branch
_La3fa_hexa_ptr_alloc_bb6:
    bl __a_np // call __a_np
    stp x0, x1, [sp, #336] // hv store L21
    ldp x0, x1, [sp, #336] // hv load L21
    movz x2, #0 // hv const_int: TAG_INT
...
_La3fa_hexa_ptr_free_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _La3fa_hexa_ptr_free_bb2 // br_cond: !truthy -> else
    b _La3fa_hexa_ptr_free_bb1 // branch -> then
_La3fa_hexa_ptr_free_bb1:
    ldp x0, x1, [sp, #0] // hv load L0
    ldp x2, x3, [sp, #16] // hv load L1
...
hexa_ptr_write_byte:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_La3fa_hexa_ptr_write_byte_bb0:
    ldp x0, x1, [sp, #0] // hv load L0
    ldp x2, x3, [sp, #16] // hv load L1
