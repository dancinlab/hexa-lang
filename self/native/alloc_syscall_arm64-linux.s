...
SYS_LINUX_NANOSLEEP:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_LINUX_NANOSLEEP_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_GETDENTS64:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_LINUX_GETDENTS64_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_CLOCK_GETTIME:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_LINUX_CLOCK_GETTIME_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_EXIT_GROUP:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_LINUX_EXIT_GROUP_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_LINUX_GETRANDOM:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_LINUX_GETRANDOM_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_DARWIN_GETDIRENTRIES:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_DARWIN_GETDIRENTRIES_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_DARWIN_GETDIRENTRIES64:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_DARWIN_GETDIRENTRIES64_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
SYS_DARWIN_NANOSLEEP:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_DARWIN_NANOSLEEP_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #197 // imm 0-15
    movk x1, #512, lsl #16 // imm 16-31
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
...
SYS_DARWIN_CLOCK_GETTIME:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_SYS_DARWIN_CLOCK_GETTIME_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
_L7797_sys_read_bb0:
    ...
    cbz x0, _L7797_sys_read_bb2 // br_cond: !truthy -> else
    b _L7797_sys_read_bb1 // branch -> then
_L7797_sys_read_bb1:
...
sys_write:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_L7797_sys_write_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_write_bb2 // br_cond: !truthy -> else
    b _L7797_sys_write_bb1 // branch -> then
_L7797_sys_write_bb1:
...
_L7797_sys_open_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_open_bb2 // br_cond: !truthy -> else
    b _L7797_sys_open_bb1 // branch -> then
_L7797_sys_open_bb1:
...
sys_close:
    ...
    sub sp, sp, #112 // sp adj
    stp x0, x1, [sp, #0] // ingress param 0
_L7797_sys_close_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #16] // hv store L1
    ldp x0, x1, [sp, #16] // hv load L1
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_close_bb2 // br_cond: !truthy -> else
    b _L7797_sys_close_bb1 // branch -> then
_L7797_sys_close_bb1:
...
sys_lseek:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_L7797_sys_lseek_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_lseek_bb2 // br_cond: !truthy -> else
    b _L7797_sys_lseek_bb1 // branch -> then
_L7797_sys_lseek_bb1:
...
sys_unlink:
    ...
    sub sp, sp, #112 // sp adj
    stp x0, x1, [sp, #0] // ingress param 0
_L7797_sys_unlink_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #16] // hv store L1
    ldp x0, x1, [sp, #16] // hv load L1
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_unlink_bb2 // br_cond: !truthy -> else
    b _L7797_sys_unlink_bb1 // branch -> then
_L7797_sys_unlink_bb1:
...
sys_mkdir:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_L7797_sys_mkdir_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_mkdir_bb2 // br_cond: !truthy -> else
    b _L7797_sys_mkdir_bb1 // branch -> then
_L7797_sys_mkdir_bb1:
...
_L7797_sys_mmap_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_mmap_bb2 // br_cond: !truthy -> else
    b _L7797_sys_mmap_bb1 // branch -> then
_L7797_sys_mmap_bb1:
...
sys_munmap:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_L7797_sys_munmap_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_munmap_bb2 // br_cond: !truthy -> else
    b _L7797_sys_munmap_bb1 // branch -> then
_L7797_sys_munmap_bb1:
...
_L7797_sys_exit_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_exit_bb2 // br_cond: !truthy -> else
    b _L7797_sys_exit_bb1 // branch -> then
_L7797_sys_exit_bb1:
...
sys_getrandom:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_L7797_sys_getrandom_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_getrandom_bb2 // br_cond: !truthy -> else
    b _L7797_sys_getrandom_bb1 // branch -> then
_L7797_sys_getrandom_bb1:
...
_L7797_sys_getrandom_bb2:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_getrandom_bb4 // br_cond: !truthy -> else
    b _L7797_sys_getrandom_bb3 // branch -> then
_L7797_sys_getrandom_bb3:
    ldp x0, x1, [sp, #144] // hv load L9
    add sp, sp, #240 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L7797_sys_getrandom_bb4:
    ldp x0, x1, [sp, #144] // hv load L9
    ldp x2, x3, [sp, #0] // hv load L0
    ldp x4, x5, [sp, #16] // hv load L1
...
sys_clock_gettime:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_L7797_sys_clock_gettime_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_clock_gettime_bb2 // br_cond: !truthy -> else
    b _L7797_sys_clock_gettime_bb1 // branch -> then
_L7797_sys_clock_gettime_bb1:
...
_L7797_sys_fork_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_fork_bb2 // br_cond: !truthy -> else
    b _L7797_sys_fork_bb1 // branch -> then
_L7797_sys_fork_bb1:
...
sys_execve:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_L7797_sys_execve_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #48] // hv store L3
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_execve_bb2 // br_cond: !truthy -> else
    b _L7797_sys_execve_bb1 // branch -> then
_L7797_sys_execve_bb1:
...
_L7797_sys_wait4_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #80] // hv store L4
    ldp x0, x1, [sp, #80] // hv load L4
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_wait4_bb2 // br_cond: !truthy -> else
    b _L7797_sys_wait4_bb1 // branch -> then
_L7797_sys_wait4_bb1:
...
_L7797_sys_pipe_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_pipe_bb2 // br_cond: !truthy -> else
    b _L7797_sys_pipe_bb1 // branch -> then
_L7797_sys_pipe_bb1:
...
_L7797_sys_dup2_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_dup2_bb2 // br_cond: !truthy -> else
    b _L7797_sys_dup2_bb1 // branch -> then
_L7797_sys_dup2_bb1:
...
sys_nanosleep:
    ...
    stp x0, x1, [sp, #0] // ingress param 0
    stp x2, x3, [sp, #16] // ingress param 1
_L7797_sys_nanosleep_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #32] // hv store L2
    ldp x0, x1, [sp, #32] // hv load L2
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_sys_nanosleep_bb2 // br_cond: !truthy -> else
    b _L7797_sys_nanosleep_bb1 // branch -> then
_L7797_sys_nanosleep_bb1:
...
flag_o_creat:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_L7797_flag_o_creat_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_flag_o_creat_bb2 // br_cond: !truthy -> else
    b _L7797_flag_o_creat_bb1 // branch -> then
_L7797_flag_o_creat_bb1:
...
flag_o_append:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_L7797_flag_o_append_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_flag_o_append_bb2 // br_cond: !truthy -> else
    b _L7797_flag_o_append_bb1 // branch -> then
_L7797_flag_o_append_bb1:
...
flag_o_trunc:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_L7797_flag_o_trunc_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_flag_o_trunc_bb2 // br_cond: !truthy -> else
    b _L7797_flag_o_trunc_bb1 // branch -> then
_L7797_flag_o_trunc_bb1:
...
flag_map_anon:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_L7797_flag_map_anon_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_flag_map_anon_bb2 // br_cond: !truthy -> else
    b _L7797_flag_map_anon_bb1 // branch -> then
_L7797_flag_map_anon_bb1:
...
CLOCK_MONOTONIC_LINUX:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_CLOCK_MONOTONIC_LINUX_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
...
CLOCK_MONOTONIC_DARWIN:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_CLOCK_MONOTONIC_DARWIN_bb0:
    movz x0, #0 // hv const_int: TAG_INT
...
clock_monotonic:
    ...
    mov x29, sp // prologue: set fp
    sub sp, sp, #64 // sp adj
_L7797_clock_monotonic_bb0:
    bl target_is_linux // call target_is_linux
    stp x0, x1, [sp, #0] // hv store L0
    ldp x0, x1, [sp, #0] // hv load L0
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_clock_monotonic_bb2 // br_cond: !truthy -> else
    b _L7797_clock_monotonic_bb1 // branch -> then
_L7797_clock_monotonic_bb1:
...
HEXA_ARENA_BLOCK_SIZE:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
_L7797_HEXA_ARENA_BLOCK_SIZE_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // imm 0-15
...
_L7797___env_extend_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797___env_extend_bb2 // br_cond: !truthy -> else
    b _L7797___env_extend_bb1 // branch -> then
_L7797___env_extend_bb1:
    ldp x0, x1, [sp, #0] // hv load L0
    adrp x15, g2@PAGE // hv global page (store)
    add x15, x15, g2@PAGEOFF // hv global off (store)
    stp x0, x1, [x15] // hv store global g2
    b _L7797___env_extend_bb5 // branch
_L7797___env_extend_bb2:
    ldp x0, x1, [sp, #0] // hv load L0
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797___env_extend_bb4 // br_cond: !truthy -> else
    b _L7797___env_extend_bb3 // branch -> then
_L7797___env_extend_bb3:
    ldp x0, x1, [sp, #0] // hv load L0
    adrp x15, g2@PAGE // hv global page (store)
    add x15, x15, g2@PAGEOFF // hv global off (store)
    stp x0, x1, [x15] // hv store global g2
    b _L7797___env_extend_bb4 // branch
_L7797___env_extend_bb4:
    b _L7797___env_extend_bb5 // branch
_L7797___env_extend_bb5:
    ldp x0, x1, [sp, #0] // hv load L0
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797___env_extend_bb7 // br_cond: !truthy -> else
    b _L7797___env_extend_bb6 // branch -> then
_L7797___env_extend_bb6:
    ldp x0, x1, [sp, #112] // hv load L7
    adrp x15, g3@PAGE // hv global page (store)
    add x15, x15, g3@PAGEOFF // hv global off (store)
    stp x0, x1, [x15] // hv store global g3
    b _L7797___env_extend_bb7 // branch
_L7797___env_extend_bb7:
...
_L7797_hexa_arena_new_block_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_new_block_bb2 // br_cond: !truthy -> else
    b _L7797_hexa_arena_new_block_bb1 // branch -> then
_L7797_hexa_arena_new_block_bb1:
    ldp x0, x1, [sp, #32] // hv load L0
    stp x0, x1, [sp, #64] // hv store L2
    b _L7797_hexa_arena_new_block_bb2 // branch
_L7797_hexa_arena_new_block_bb2:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_new_block_bb4 // br_cond: !truthy -> else
    b _L7797_hexa_arena_new_block_bb3 // branch -> then
_L7797_hexa_arena_new_block_bb3:
    movz x0, #0 // hv const_int: TAG_INT
    ...
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L7797_hexa_arena_new_block_bb4:
    ldp x0, x1, [sp, #304] // hv load L17
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
...
_L7797_hexa_arena_alloc_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb2 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb1 // branch -> then
_L7797_hexa_arena_alloc_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #8 // hv const_int val
    stp x0, x1, [sp, #48] // hv store L3
    b _L7797_hexa_arena_alloc_bb2 // branch
_L7797_hexa_arena_alloc_bb2:
    adrp x0, g0@PAGE // hv global page
    add x0, x0, g0@PAGEOFF // hv global off
    ldp x0, x1, [x0] // hv load global g0
    movz x2, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb4 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb3 // branch -> then
_L7797_hexa_arena_alloc_bb3:
    ldp x0, x1, [sp, #48] // hv load L3
    bl hexa_arena_new_block // call hexa_arena_new_block
    stp x0, x1, [sp, #128] // hv store L8
    ldp x0, x1, [sp, #128] // hv load L8
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb6 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb5 // branch -> then
_L7797_hexa_arena_alloc_bb4:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb8 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb7 // branch -> then
_L7797_hexa_arena_alloc_bb5:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add sp, sp, #688 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L7797_hexa_arena_alloc_bb6:
    b _L7797_hexa_arena_alloc_bb4 // branch
_L7797_hexa_arena_alloc_bb7:
    ldp x0, x1, [sp, #176] // hv load L11
    bl __blk_next // call __blk_next
    stp x0, x1, [sp, #272] // hv store L17
    ldp x0, x1, [sp, #272] // hv load L17
    stp x0, x1, [sp, #288] // hv store L18
    b _L7797_hexa_arena_alloc_bb9 // branch
_L7797_hexa_arena_alloc_bb8:
    bl BLOCK_HDR // call BLOCK_HDR
...
_L7797_hexa_arena_alloc_bb9:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb11 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb10 // branch -> then
_L7797_hexa_arena_alloc_bb10:
    ldp x0, x1, [sp, #288] // hv load L18
    bl __blk_cap // call __blk_cap
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb13 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb12 // branch -> then
_L7797_hexa_arena_alloc_bb11:
    ldp x0, x1, [sp, #288] // hv load L18
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    bl hexa_eq // binop ==
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb15 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb14 // branch -> then
_L7797_hexa_arena_alloc_bb12:
    b _L7797_hexa_arena_alloc_bb11 // branch
_L7797_hexa_arena_alloc_bb13:
    ldp x0, x1, [sp, #288] // hv load L18
    bl __blk_next // call __blk_next
...
_L7797_hexa_arena_alloc_bb14:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb17 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb16 // branch -> then
_L7797_hexa_arena_alloc_bb15:
    ldp x0, x1, [sp, #288] // hv load L18
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    bl __blk_set_used // call __blk_set_used
    ...
    ldp x0, x1, [sp, #288] // hv load L18
    stp x0, x1, [sp, #176] // hv store L11
    b _L7797_hexa_arena_alloc_bb8 // branch
_L7797_hexa_arena_alloc_bb16:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    add sp, sp, #688 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L7797_hexa_arena_alloc_bb17:
    adrp x0, g1@PAGE // hv global page
    add x0, x0, g1@PAGEOFF // hv global off
    ldp x0, x1, [x0] // hv load global g1
    stp x0, x1, [sp, #464] // hv store L29
    b _L7797_hexa_arena_alloc_bb18 // branch
_L7797_hexa_arena_alloc_bb18:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_alloc_bb20 // br_cond: !truthy -> else
    b _L7797_hexa_arena_alloc_bb19 // branch -> then
_L7797_hexa_arena_alloc_bb19:
    ldp x0, x1, [sp, #464] // hv load L29
    bl __blk_next // call __blk_next
...
_L7797_hexa_arena_mark_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_mark_bb2 // br_cond: !truthy -> else
    b _L7797_hexa_arena_mark_bb1 // branch -> then
_L7797_hexa_arena_mark_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
...
_L7797_hexa_arena_rewind_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_rewind_bb2 // br_cond: !truthy -> else
    b _L7797_hexa_arena_rewind_bb1 // branch -> then
_L7797_hexa_arena_rewind_bb1:
    adrp x0, g0@PAGE // hv global page
    add x0, x0, g0@PAGEOFF // hv global off
    ldp x0, x1, [x0] // hv load global g0
    movz x2, #0 // hv const_int: TAG_INT
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_rewind_bb4 // br_cond: !truthy -> else
    b _L7797_hexa_arena_rewind_bb3 // branch -> then
_L7797_hexa_arena_rewind_bb2:
    ldp x0, x1, [sp, #32] // hv load L2
    ...
    ldp x0, x1, [sp, #176] // hv load L11
    stp x0, x1, [sp, #192] // hv store L12
    b _L7797_hexa_arena_rewind_bb5 // branch
_L7797_hexa_arena_rewind_bb3:
    adrp x0, g0@PAGE // hv global page
    add x0, x0, g0@PAGEOFF // hv global off
    ldp x0, x1, [x0] // hv load global g0
    movz x2, #0 // hv const_int: TAG_INT
    ...
    add x15, x15, g1@PAGEOFF // hv global off (store)
    stp x0, x1, [x15] // hv store global g1
    b _L7797_hexa_arena_rewind_bb4 // branch
_L7797_hexa_arena_rewind_bb4:
    movz x0, #4 // ret void: TAG_VOID
    movz x1, #0 // ret void: payload 0
    add sp, sp, #256 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L7797_hexa_arena_rewind_bb5:
    ldp x0, x1, [sp, #192] // hv load L12
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    bl hexa_eq // ne: eq
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_rewind_bb7 // br_cond: !truthy -> else
    b _L7797_hexa_arena_rewind_bb6 // branch -> then
_L7797_hexa_arena_rewind_bb6:
    ldp x0, x1, [sp, #192] // hv load L12
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    bl __blk_set_used // call __blk_set_used
...
_L7797_hexa_arena_reset_bb0:
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_reset_bb2 // br_cond: !truthy -> else
    b _L7797_hexa_arena_reset_bb1 // branch -> then
_L7797_hexa_arena_reset_bb1:
    movz x0, #4 // ret void: TAG_VOID
    movz x1, #0 // ret void: payload 0
    add sp, sp, #96 // sp adj
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L7797_hexa_arena_reset_bb2:
    adrp x0, g0@PAGE // hv global page
    add x0, x0, g0@PAGEOFF // hv global off
    ldp x0, x1, [x0] // hv load global g0
    stp x0, x1, [sp, #32] // hv store L2
    b _L7797_hexa_arena_reset_bb3 // branch
_L7797_hexa_arena_reset_bb3:
    ldp x0, x1, [sp, #32] // hv load L2
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    bl hexa_eq // ne: eq
    ...
    bl hexa_truthy // br_cond: truthy → w0
    uxtw x0, w0 // br_cond: zext w0
    cbz x0, _L7797_hexa_arena_reset_bb5 // br_cond: !truthy -> else
    b _L7797_hexa_arena_reset_bb4 // branch -> then
_L7797_hexa_arena_reset_bb4:
    ldp x0, x1, [sp, #32] // hv load L2
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    bl __blk_set_used // call __blk_set_used
...
hexa_ptr_write_byte:
    ...
    stp x2, x3, [sp, #16] // ingress param 1
    stp x4, x5, [sp, #32] // ingress param 2
_L7797_hexa_ptr_write_byte_bb0:
    ldp x0, x1, [sp, #0] // hv load L0
    ldp x2, x3, [sp, #16] // hv load L1
...
main:
    ...
    stp x29, x30, [sp, #-16]! // prologue: save fp/lr
    mov x29, sp // prologue: set fp
    bl hexa_set_args // entry: wire argc/argv -> hexa_set_args
    sub sp, sp, #64 // sp adj
_L7797_main_bb0:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #0 // hv const_int val
