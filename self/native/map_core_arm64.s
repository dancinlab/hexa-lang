// map_core_arm64.s — FROZEN BOOTSTRAP SEED (RT-NATIVE leg B M4 MAP-CONSTRUCT-R1).
// GENERATED: tool/regen_map_core_native_s.sh — aprime_cc _drv.hexa --emit=asm
//   --target=arm64-apple-darwin -o map_core_arm64.s stdlib/runtime/map_core.hexa.
...
//   ABI: Mach-O, _rt_map_*_native underscore-prefixed; external _hexa_to_int. External: hexa_to_int (runtime.c).
...
__L16d1_rt_map_fnv1a_native_bb0:
    ...
    b __L16d1_rt_map_fnv1a_native_bb1 ; branch
__L16d1_rt_map_fnv1a_native_bb1:
    ...
    cbz x0, __L16d1_rt_map_fnv1a_native_bb3 ; br_cond: !truthy -> else
    b __L16d1_rt_map_fnv1a_native_bb2 ; branch -> then
__L16d1_rt_map_fnv1a_native_bb2:
    ...
    stp x0, x1, [sp, #64] ; hv store L4
    b __L16d1_rt_map_fnv1a_native_bb1 ; branch
__L16d1_rt_map_fnv1a_native_bb3:
    ldp x0, x1, [sp, #16] ; hv load L1
    add sp, sp, #192 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_map_strcmp0_native
.private_extern _rt_map_strcmp0_native
    .p2align 2
_rt_map_strcmp0_native:
    .loc 1 54 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
...
__L16d1_rt_map_strcmp0_native_bb0:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    stp x0, x1, [sp, #32] ; hv store L2
    ldp x0, x1, [sp, #0] ; hv load L0
    ...
    ldp x0, x1, [sp, #80] ; hv load L5
    stp x0, x1, [sp, #96] ; hv store L6
    b __L16d1_rt_map_strcmp0_native_bb1 ; branch
__L16d1_rt_map_strcmp0_native_bb1:
    ldp x0, x1, [sp, #64] ; hv load L4
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_strcmp0_native_bb3 ; br_cond: !truthy -> else
    b __L16d1_rt_map_strcmp0_native_bb2 ; branch -> then
__L16d1_rt_map_strcmp0_native_bb2:
    ldp x0, x1, [sp, #64] ; hv load L4
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    cmp x1, x3 ; __hx_payload_eq: cmp payloads
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_strcmp0_native_bb5 ; br_cond: !truthy -> else
    b __L16d1_rt_map_strcmp0_native_bb4 ; branch -> then
__L16d1_rt_map_strcmp0_native_bb3:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add sp, sp, #208 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_strcmp0_native_bb4:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add sp, sp, #208 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_strcmp0_native_bb5:
    ldp x0, x1, [sp, #32] ; hv load L2
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_map_get_native
.private_extern _rt_map_get_native
    .p2align 2
_rt_map_get_native:
    .loc 1 73 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L16d1_rt_map_get_native_bb0:
    ...
    ldp x0, x1, [sp, #16] ; hv load L1
    bl _rt_map_fnv1a_native ; call rt_map_fnv1a_native
    ...
    b __L16d1_rt_map_get_native_bb1 ; branch
__L16d1_rt_map_get_native_bb1:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_get_native_bb3 ; br_cond: !truthy -> else
    b __L16d1_rt_map_get_native_bb2 ; branch -> then
__L16d1_rt_map_get_native_bb2:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_get_native_bb5 ; br_cond: !truthy -> else
    b __L16d1_rt_map_get_native_bb4 ; branch -> then
__L16d1_rt_map_get_native_bb3:
    movz x0, #0 ; hv const_int: TAG_INT
...
__L16d1_rt_map_get_native_bb5:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_get_native_bb7 ; br_cond: !truthy -> else
    b __L16d1_rt_map_get_native_bb6 ; branch -> then
__L16d1_rt_map_get_native_bb6:
    ldp x0, x1, [sp, #432] ; hv load L27
    ldp x2, x3, [sp, #16] ; hv load L1
    bl _rt_map_strcmp0_native ; call rt_map_strcmp0_native
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_get_native_bb9 ; br_cond: !truthy -> else
    b __L16d1_rt_map_get_native_bb8 ; branch -> then
__L16d1_rt_map_get_native_bb7:
    ldp x0, x1, [sp, #304] ; hv load L19
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
...
__L16d1_rt_map_get_native_bb8:
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_get_native_bb9:
    b __L16d1_rt_map_get_native_bb7 ; branch
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
    add sp, sp, #880 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_map_contains_native
.private_extern _rt_map_contains_native
    .p2align 2
_rt_map_contains_native:
    .loc 1 115 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L16d1_rt_map_contains_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    movz x1, #0 ; hv const_int val
    stp x0, x1, [sp, #288] ; hv store L18
    b __L16d1_rt_map_contains_native_bb1 ; branch
__L16d1_rt_map_contains_native_bb1:
    ldp x0, x1, [sp, #288] ; hv load L18
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_contains_native_bb3 ; br_cond: !truthy -> else
    b __L16d1_rt_map_contains_native_bb2 ; branch -> then
__L16d1_rt_map_contains_native_bb2:
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_contains_native_bb5 ; br_cond: !truthy -> else
    b __L16d1_rt_map_contains_native_bb4 ; branch -> then
__L16d1_rt_map_contains_native_bb3:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_contains_native_bb4:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_contains_native_bb5:
    ldp x0, x1, [sp, #368] ; hv load L23
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #8 ; hv const_int val
    add x1, x1, x3 ; __hx_ptr_load64: addr = ptr + off
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_contains_native_bb7 ; br_cond: !truthy -> else
    b __L16d1_rt_map_contains_native_bb6 ; branch -> then
__L16d1_rt_map_contains_native_bb6:
    ldp x0, x1, [sp, #400] ; hv load L25
    ldp x2, x3, [sp, #16] ; hv load L1
    bl _rt_map_strcmp0_native ; call rt_map_strcmp0_native
    add x15, sp, #560 ; hv frame base
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_contains_native_bb9 ; br_cond: !truthy -> else
    b __L16d1_rt_map_contains_native_bb8 ; branch -> then
__L16d1_rt_map_contains_native_bb7:
    ldp x0, x1, [sp, #272] ; hv load L17
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #288] ; hv store L18
    b __L16d1_rt_map_contains_native_bb1 ; branch
__L16d1_rt_map_contains_native_bb8:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_contains_native_bb9:
    b __L16d1_rt_map_contains_native_bb7 ; branch
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
    add sp, sp, #720 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_map_set_inplace_native
.private_extern _rt_map_set_inplace_native
    .p2align 2
_rt_map_set_inplace_native:
    .loc 1 163 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
...
__L16d1_rt_map_set_inplace_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    ldp x0, x1, [sp, #416] ; hv load L26
    stp x0, x1, [sp, #432] ; hv store L27
    b __L16d1_rt_map_set_inplace_native_bb1 ; branch
__L16d1_rt_map_set_inplace_native_bb1:
    ldp x0, x1, [sp, #368] ; hv load L23
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_set_inplace_native_bb3 ; br_cond: !truthy -> else
    b __L16d1_rt_map_set_inplace_native_bb2 ; branch -> then
__L16d1_rt_map_set_inplace_native_bb2:
    ldp x0, x1, [sp, #352] ; hv load L22
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #16 ; hv const_int val
    mul x1, x1, x3 ; __hx_payload_mul: x1 = a.pl mul b.pl
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_set_inplace_native_bb5 ; br_cond: !truthy -> else
    b __L16d1_rt_map_set_inplace_native_bb4 ; branch -> then
__L16d1_rt_map_set_inplace_native_bb3:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_set_inplace_native_bb4:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_set_inplace_native_bb5:
    add x15, sp, #512 ; hv frame base
    ldp x0, x1, [x15] ; hv load L32
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #8 ; hv const_int val
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_set_inplace_native_bb7 ; br_cond: !truthy -> else
    b __L16d1_rt_map_set_inplace_native_bb6 ; branch -> then
__L16d1_rt_map_set_inplace_native_bb6:
    add x15, sp, #544 ; hv frame base
    ldp x0, x1, [x15] ; hv load L34
    ldp x2, x3, [sp, #16] ; hv load L1
    bl _rt_map_strcmp0_native ; call rt_map_strcmp0_native
    ...
    bl _hexa_truthy ; br_cond: truthy → w0
    uxtw x0, w0 ; br_cond: zext w0
    cbz x0, __L16d1_rt_map_set_inplace_native_bb9 ; br_cond: !truthy -> else
    b __L16d1_rt_map_set_inplace_native_bb8 ; branch -> then
__L16d1_rt_map_set_inplace_native_bb7:
    ldp x0, x1, [sp, #352] ; hv load L22
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #368] ; hv store L23
    b __L16d1_rt_map_set_inplace_native_bb1 ; branch
__L16d1_rt_map_set_inplace_native_bb8:
    ldp x0, x1, [sp, #352] ; hv load L22
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #16 ; hv const_int val
    mul x1, x1, x3 ; __hx_payload_mul: x1 = a.pl mul b.pl
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L16d1_rt_map_set_inplace_native_bb9:
    b __L16d1_rt_map_set_inplace_native_bb7 ; branch
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
    add sp, sp, #1088 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
