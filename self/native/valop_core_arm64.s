...
__L0436_rt_truthy_native_bb0:
    ...
    cbz x1, __L0436_rt_truthy_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb1 ; branch -> then
__L0436_rt_truthy_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
...
__L0436_rt_truthy_native_bb2:
    ...
    cbz x1, __L0436_rt_truthy_native_bb4 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb3 ; branch -> then
__L0436_rt_truthy_native_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
...
__L0436_rt_truthy_native_bb4:
    ...
    cbz x1, __L0436_rt_truthy_native_bb6 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb5 ; branch -> then
__L0436_rt_truthy_native_bb5:
    movz x0, #0 ; hv const_int: TAG_INT
...
__L0436_rt_truthy_native_bb6:
    ...
    cbz x1, __L0436_rt_truthy_native_bb8 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb7 ; branch -> then
__L0436_rt_truthy_native_bb7:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #2 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
...
__L0436_rt_truthy_native_bb8:
    ...
    cbz x1, __L0436_rt_truthy_native_bb10 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb9 ; branch -> then
__L0436_rt_truthy_native_bb9:
    ldp x0, x1, [sp, #0] ; hv load L0
    ...
    bl _hexa_bool ; __hx_payload_nz: box bool
    ...
    cbz x1, __L0436_rt_truthy_native_bb12 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb11 ; branch -> then
__L0436_rt_truthy_native_bb10:
    ldp x0, x1, [sp, #32] ; hv load L2
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L0436_rt_truthy_native_bb14 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb13 ; branch -> then
__L0436_rt_truthy_native_bb11:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #2 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
...
__L0436_rt_truthy_native_bb14:
    ...
    cbz x1, __L0436_rt_truthy_native_bb16 ; br_cond: !payload -> else
    b __L0436_rt_truthy_native_bb15 ; branch -> then
__L0436_rt_truthy_native_bb15:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
...
__L0436_rt_sub_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_sub_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_sub_native_bb1 ; branch -> then
__L0436_rt_sub_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
...
__L0436_rt_mul_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_mul_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_mul_native_bb1 ; branch -> then
__L0436_rt_mul_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L0436_rt_add_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_add_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_add_native_bb1 ; branch -> then
__L0436_rt_add_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    movz x0, #0 ; __hx_payload_add: TAG_INT
...
__L0436_rt_cmp_lt_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_cmp_lt_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_cmp_lt_native_bb1 ; branch -> then
__L0436_rt_cmp_lt_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L0436_rt_cmp_gt_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_cmp_gt_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_cmp_gt_native_bb1 ; branch -> then
__L0436_rt_cmp_gt_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    cmp x1, x3 ; __hx_payload_gt: cmp payloads
    cset x0, gt ; __hx_payload_gt: x0 = (a.pl gt b.pl)
...
__L0436_rt_cmp_le_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_cmp_le_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_cmp_le_native_bb1 ; branch -> then
__L0436_rt_cmp_le_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L0436_rt_cmp_ge_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L0436_rt_cmp_ge_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_cmp_ge_native_bb1 ; branch -> then
__L0436_rt_cmp_ge_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L0436_rt_mod_native_bb0:
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_eq_scalar_native
.private_extern _rt_eq_scalar_native
    .p2align 2
_rt_eq_scalar_native:
    .loc 1 332 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L0436_rt_eq_scalar_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    mov x1, x0 ; __hx_tag: payload = v.tag
    movz x0, #0 ; __hx_tag: TAG_INT
    stp x0, x1, [sp, #32] ; hv store L2
    ...
    stp x0, x1, [sp, #384] ; hv store L24
    ldp x0, x1, [sp, #384] ; hv load L24
    cbz x1, __L0436_rt_eq_scalar_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_eq_scalar_native_bb1 ; branch -> then
__L0436_rt_eq_scalar_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    scvtf d0, x1 ; __hx_to_double: d0 = (double)int
    fmov x2, d0 ; __hx_to_double: x2 = int-as-double bits
    cmp x0, #1 ; __hx_to_double: tag == TAG_FLOAT?
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_eq_scalar_native_bb2:
    ldp x0, x1, [sp, #112] ; hv load L7
    ldp x2, x3, [sp, #176] ; hv load L11
    and x1, x1, x3 ; __hx_payload_and: x1 = a.pl and b.pl
    movz x0, #0 ; __hx_payload_and: TAG_INT
    ...
    add x15, sp, #688 ; hv frame base
    ldp x0, x1, [x15] ; hv load L43
    cbz x1, __L0436_rt_eq_scalar_native_bb4 ; br_cond: !payload -> else
    b __L0436_rt_eq_scalar_native_bb3 ; branch -> then
__L0436_rt_eq_scalar_native_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    cmp x1, x3 ; __hx_payload_le: cmp payloads
    cset x0, le ; __hx_payload_le: x0 = (a.pl le b.pl)
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_eq_scalar_native_bb4:
    ldp x0, x1, [sp, #48] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #2 ; hv const_int val
    cmp x1, x3 ; __hx_payload_eq: cmp payloads
    ...
    cbz x1, __L0436_rt_eq_scalar_native_bb6 ; br_cond: !payload -> else
    b __L0436_rt_eq_scalar_native_bb5 ; branch -> then
__L0436_rt_eq_scalar_native_bb5:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    cmp x1, x3 ; __hx_payload_le: cmp payloads
    cset x0, le ; __hx_payload_le: x0 = (a.pl le b.pl)
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_eq_scalar_native_bb6:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #2 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_to_int_native
.private_extern _rt_to_int_native
    .p2align 2
_rt_to_int_native:
    .loc 1 378 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L0436_rt_to_int_native_bb0:
    ...
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    cbz x1, __L0436_rt_to_int_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_to_int_native_bb1 ; branch -> then
__L0436_rt_to_int_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    add sp, sp, #160 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_to_int_native_bb2:
    ldp x0, x1, [sp, #0] ; hv load L0
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_to_float_native
.private_extern _rt_to_float_native
    .p2align 2
_rt_to_float_native:
    .loc 1 387 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    ...
    sub sp, sp, #160 ; sp adj
    stp x0, x1, [sp, #0] ; ingress param 0
__L0436_rt_to_float_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    mov x1, x0 ; __hx_tag: payload = v.tag
    movz x0, #0 ; __hx_tag: TAG_INT
    stp x0, x1, [sp, #16] ; hv store L1
    ...
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    cbz x1, __L0436_rt_to_float_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_to_float_native_bb1 ; branch -> then
__L0436_rt_to_float_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    add sp, sp, #160 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_to_float_native_bb2:
    ldp x0, x1, [sp, #0] ; hv load L0
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_abs_native
.private_extern _rt_abs_native
    .p2align 2
_rt_abs_native:
    .loc 1 397 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L0436_rt_abs_native_bb0:
    ...
    stp x0, x1, [sp, #48] ; hv store L3
    ldp x0, x1, [sp, #48] ; hv load L3
    cbz x1, __L0436_rt_abs_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_abs_native_bb1 ; branch -> then
__L0436_rt_abs_native_bb1:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    stp x0, x1, [sp, #176] ; hv store L11
    ldp x0, x1, [sp, #176] ; hv load L11
    cbz x1, __L0436_rt_abs_native_bb4 ; br_cond: !payload -> else
    b __L0436_rt_abs_native_bb3 ; branch -> then
__L0436_rt_abs_native_bb2:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    scvtf d0, x1 ; __hx_to_double: d0 = (double)int
    fmov x2, d0 ; __hx_to_double: x2 = int-as-double bits
    ...
    stp x0, x1, [sp, #384] ; hv store L24
    ldp x0, x1, [sp, #384] ; hv load L24
    cbz x1, __L0436_rt_abs_native_bb6 ; br_cond: !payload -> else
    b __L0436_rt_abs_native_bb5 ; branch -> then
__L0436_rt_abs_native_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    add sp, sp, #496 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_abs_native_bb4:
    ldp x0, x1, [sp, #96] ; hv load L6
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_abs_native_bb5:
    ldp x0, x1, [sp, #0] ; hv load L0
    add sp, sp, #496 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_abs_native_bb6:
    ldp x0, x1, [sp, #304] ; hv load L19
    ldp x2, x3, [sp, #0] ; hv load L0
    fmov d0, x1 ; __hx_payload_fsub: d0 = a.f
    fmov d1, x3 ; __hx_payload_fsub: d1 = b.f
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_null_coal_native
.private_extern _rt_null_coal_native
    .p2align 2
_rt_null_coal_native:
    .loc 1 418 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
    ...
    stp x0, x1, [sp, #0] ; ingress param 0
    stp x2, x3, [sp, #16] ; ingress param 1
__L0436_rt_null_coal_native_bb0:
    ldp x0, x1, [sp, #0] ; hv load L0
    mov x1, x0 ; __hx_tag: payload = v.tag
    movz x0, #0 ; __hx_tag: TAG_INT
    stp x0, x1, [sp, #32] ; hv store L2
    ...
    stp x0, x1, [sp, #64] ; hv store L4
    ldp x0, x1, [sp, #64] ; hv load L4
    cbz x1, __L0436_rt_null_coal_native_bb2 ; br_cond: !payload -> else
    b __L0436_rt_null_coal_native_bb1 ; branch -> then
__L0436_rt_null_coal_native_bb1:
    ldp x0, x1, [sp, #16] ; hv load L1
    add sp, sp, #352 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_null_coal_native_bb2:
    ldp x0, x1, [sp, #48] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #3 ; hv const_int val
    cmp x1, x3 ; __hx_payload_eq: cmp payloads
    ...
    stp x0, x1, [sp, #96] ; hv store L6
    ldp x0, x1, [sp, #96] ; hv load L6
    cbz x1, __L0436_rt_null_coal_native_bb4 ; br_cond: !payload -> else
    b __L0436_rt_null_coal_native_bb3 ; branch -> then
__L0436_rt_null_coal_native_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x0, #0 ; __hx_str_ptr: TAG_INT
    stp x0, x1, [sp, #128] ; hv store L8
    ldp x0, x1, [sp, #128] ; hv load L8
    ...
    stp x0, x1, [sp, #224] ; hv store L14
    ldp x0, x1, [sp, #224] ; hv load L14
    cbz x1, __L0436_rt_null_coal_native_bb6 ; br_cond: !payload -> else
    b __L0436_rt_null_coal_native_bb5 ; branch -> then
__L0436_rt_null_coal_native_bb4:
    ldp x0, x1, [sp, #0] ; hv load L0
    add sp, sp, #352 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_null_coal_native_bb5:
    ldp x0, x1, [sp, #16] ; hv load L1
    add sp, sp, #352 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_null_coal_native_bb6:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_str_byte: x1 = s + i
    ...
    stp x0, x1, [sp, #320] ; hv store L20
    ldp x0, x1, [sp, #320] ; hv load L20
    cbz x1, __L0436_rt_null_coal_native_bb8 ; br_cond: !payload -> else
    b __L0436_rt_null_coal_native_bb7 ; branch -> then
__L0436_rt_null_coal_native_bb7:
    ldp x0, x1, [sp, #16] ; hv load L1
    add sp, sp, #352 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L0436_rt_null_coal_native_bb8:
    ldp x0, x1, [sp, #0] ; hv load L0
    add sp, sp, #352 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
