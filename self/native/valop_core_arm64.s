...
__L9cae_rt_truthy_native_bb0:
    ...
    cbz x1, __L9cae_rt_truthy_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_truthy_native_bb1 ; branch -> then
__L9cae_rt_truthy_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
...
__L9cae_rt_truthy_native_bb2:
    ...
    cbz x1, __L9cae_rt_truthy_native_bb4 ; br_cond: !payload -> else
    b __L9cae_rt_truthy_native_bb3 ; branch -> then
__L9cae_rt_truthy_native_bb3:
    ldp x0, x1, [sp, #0] ; hv load L0
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
...
__L9cae_rt_truthy_native_bb4:
    ...
    cbz x1, __L9cae_rt_truthy_native_bb6 ; br_cond: !payload -> else
    b __L9cae_rt_truthy_native_bb5 ; branch -> then
__L9cae_rt_truthy_native_bb5:
    movz x0, #0 ; hv const_int: TAG_INT
...
__L9cae_rt_truthy_native_bb6:
    ...
    cbz x1, __L9cae_rt_truthy_native_bb8 ; br_cond: !payload -> else
    b __L9cae_rt_truthy_native_bb7 ; branch -> then
__L9cae_rt_truthy_native_bb7:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #2 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
...
__L9cae_rt_sub_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_sub_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_sub_native_bb1 ; branch -> then
__L9cae_rt_sub_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
...
__L9cae_rt_mul_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_mul_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_mul_native_bb1 ; branch -> then
__L9cae_rt_mul_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L9cae_rt_add_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_add_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_add_native_bb1 ; branch -> then
__L9cae_rt_add_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    movz x0, #0 ; __hx_payload_add: TAG_INT
...
__L9cae_rt_cmp_lt_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_cmp_lt_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_cmp_lt_native_bb1 ; branch -> then
__L9cae_rt_cmp_lt_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L9cae_rt_cmp_gt_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_cmp_gt_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_cmp_gt_native_bb1 ; branch -> then
__L9cae_rt_cmp_gt_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L9cae_rt_cmp_le_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_cmp_le_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_cmp_le_native_bb1 ; branch -> then
__L9cae_rt_cmp_le_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
...
__L9cae_rt_cmp_ge_native_bb0:
    ...
    stp x0, x1, [sp, #192] ; hv store L12
    ldp x0, x1, [sp, #192] ; hv load L12
    cbz x1, __L9cae_rt_cmp_ge_native_bb2 ; br_cond: !payload -> else
    b __L9cae_rt_cmp_ge_native_bb1 ; branch -> then
__L9cae_rt_cmp_ge_native_bb1:
    ldp x0, x1, [sp, #0] ; hv load L0
    ldp x2, x3, [sp, #16] ; hv load L1
