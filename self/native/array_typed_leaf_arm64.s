...
//   ABI: Mach-O, _-prefixed. External U-floor: malloc realloc write hexa_exit hexa_int hexa_throw (libc-bearing: realloc grow dissolves the
...
.globl _hexa_arr_i64_new
.private_extern _hexa_arr_i64_new
    .p2align 2
_hexa_arr_i64_new:
    .loc 1 62 0
...
__L6cf9_hexa_arr_i64_new_bb0:
    ...
    cbz x1, __L6cf9_hexa_arr_i64_new_bb2 ; br_cond: !payload -> else
    b __L6cf9_hexa_arr_i64_new_bb1 ; branch -> then
__L6cf9_hexa_arr_i64_new_bb1:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    stp x0, x1, [sp, #16] ; hv store L1
    b __L6cf9_hexa_arr_i64_new_bb2 ; branch
__L6cf9_hexa_arr_i64_new_bb2:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    ret ; return
.globl _hexa_arr_i64_push
.private_extern _hexa_arr_i64_push
    .p2align 2
_hexa_arr_i64_push:
    .loc 1 76 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L6cf9_hexa_arr_i64_push_bb0:
    ...
    stp x0, x1, [sp, #128] ; hv store L8
    ldp x0, x1, [sp, #128] ; hv load L8
    cbz x1, __L6cf9_hexa_arr_i64_push_bb2 ; br_cond: !payload -> else
    b __L6cf9_hexa_arr_i64_push_bb1 ; branch -> then
__L6cf9_hexa_arr_i64_push_bb1:
    ldp x0, x1, [sp, #112] ; hv load L7
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L6cf9_hexa_arr_i64_push_bb4 ; br_cond: !payload -> else
    b __L6cf9_hexa_arr_i64_push_bb3 ; branch -> then
__L6cf9_hexa_arr_i64_push_bb2:
    ldp x0, x1, [sp, #48] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_ptr_load64: addr = ptr + off
...
__L6cf9_hexa_arr_i64_push_bb3:
    ...
    b __L6cf9_hexa_arr_i64_push_bb4 ; branch
__L6cf9_hexa_arr_i64_push_bb4:
    ldp x0, x1, [sp, #48] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    b __L6cf9_hexa_arr_i64_push_bb2 ; branch
    movz x0, #4 ; ret void: TAG_VOID
    movz x1, #0 ; ret void: payload 0
    add sp, sp, #544 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _hexa_arr_i64_len
.private_extern _hexa_arr_i64_len
    .p2align 2
_hexa_arr_i64_len:
    .loc 1 102 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L6cf9_hexa_arr_i64_len_bb0:
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _hexa_arr_i64_box
.private_extern _hexa_arr_i64_box
    .p2align 2
_hexa_arr_i64_box:
    .loc 1 110 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
...
__L6cf9_hexa_arr_i64_box_bb0:
    ...
    stp x0, x1, [sp, #96] ; hv store L6
    ldp x0, x1, [sp, #96] ; hv load L6
    cbz x1, __L6cf9_hexa_arr_i64_box_bb2 ; br_cond: !payload -> else
    b __L6cf9_hexa_arr_i64_box_bb1 ; branch -> then
__L6cf9_hexa_arr_i64_box_bb1:
    movz x0, #3 ; hv const_str: TAG_STR
    adrp x1, .LCstr1@PAGE ; hv str ptr page
    add x1, x1, .LCstr1@PAGEOFF ; hv str ptr off
    bl _hexa_throw ; call hexa_throw
    stp x0, x1, [sp, #128] ; hv store L8
    b __L6cf9_hexa_arr_i64_box_bb2 ; branch
__L6cf9_hexa_arr_i64_box_bb2:
    ldp x0, x1, [sp, #16] ; hv load L1
    ldp x2, x3, [sp, #80] ; hv load L5
    cmp x1, x3 ; __hx_payload_ge: cmp payloads
    cset x0, ge ; __hx_payload_ge: x0 = (a.pl ge b.pl)
    ...
    cbz x1, __L6cf9_hexa_arr_i64_box_bb4 ; br_cond: !payload -> else
    b __L6cf9_hexa_arr_i64_box_bb3 ; branch -> then
__L6cf9_hexa_arr_i64_box_bb3:
    movz x0, #3 ; hv const_str: TAG_STR
    adrp x1, .LCstr1@PAGE ; hv str ptr page
    add x1, x1, .LCstr1@PAGEOFF ; hv str ptr off
    bl _hexa_throw ; call hexa_throw
    stp x0, x1, [sp, #176] ; hv store L11
    b __L6cf9_hexa_arr_i64_box_bb4 ; branch
__L6cf9_hexa_arr_i64_box_bb4:
    ldp x0, x1, [sp, #48] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    add x1, x1, x3 ; __hx_ptr_load64: addr = ptr + off
