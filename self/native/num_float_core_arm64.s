...
//   via this seed.
//   ABI: Mach-O, _rt_parse_float_native underscore-prefixed; no external. External: the PARSE half is self-contained (float leaves lower
...
__L22ed_rt_parse_float_native_bb0:
    ...
    b __L22ed_rt_parse_float_native_bb1 ; branch
__L22ed_rt_parse_float_native_bb1:
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb3 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb2 ; branch -> then
__L22ed_rt_parse_float_native_bb2:
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb5 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb4 ; branch -> then
__L22ed_rt_parse_float_native_bb3:
    ldp x0, x1, [sp, #48] ; hv load L2
    ldp x2, x3, [sp, #64] ; hv load L3
    add x1, x1, x3 ; __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] ; __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb8 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb7 ; branch -> then
__L22ed_rt_parse_float_native_bb4:
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb6 ; branch
__L22ed_rt_parse_float_native_bb5:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    stp x0, x1, [sp, #80] ; hv store L4
    b __L22ed_rt_parse_float_native_bb6 ; branch
__L22ed_rt_parse_float_native_bb6:
    b __L22ed_rt_parse_float_native_bb1 ; branch
__L22ed_rt_parse_float_native_bb7:
    ldp x0, x1, [sp, #64] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb11 ; branch
__L22ed_rt_parse_float_native_bb8:
    ldp x0, x1, [sp, #368] ; hv load L22
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb10 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb9 ; branch -> then
__L22ed_rt_parse_float_native_bb9:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    stp x0, x1, [sp, #0] ; hv store L23
    ldp x0, x1, [sp, #64] ; hv load L3
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb10 ; branch
__L22ed_rt_parse_float_native_bb10:
    b __L22ed_rt_parse_float_native_bb11 ; branch
__L22ed_rt_parse_float_native_bb11:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    b __L22ed_rt_parse_float_native_bb12 ; branch
__L22ed_rt_parse_float_native_bb12:
    add x15, sp, #560 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb14 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb13 ; branch -> then
__L22ed_rt_parse_float_native_bb13:
    ldp x0, x1, [sp, #48] ; hv load L2
    ldp x2, x3, [sp, #64] ; hv load L3
    add x1, x1, x3 ; __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] ; __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb16 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb15 ; branch -> then
__L22ed_rt_parse_float_native_bb14:
    ldp x0, x1, [sp, #48] ; hv load L2
    ldp x2, x3, [sp, #64] ; hv load L3
    add x1, x1, x3 ; __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] ; __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb30 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb29 ; branch -> then
__L22ed_rt_parse_float_native_bb15:
    add x15, sp, #608 ; hv frame base
    ldp x0, x1, [x15] ; hv load L38
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb18 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb17 ; branch -> then
__L22ed_rt_parse_float_native_bb16:
    add x15, sp, #736 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb23 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb22 ; branch -> then
__L22ed_rt_parse_float_native_bb17:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #544 ; hv frame base
    stp x0, x1, [x15] ; hv store L34
    b __L22ed_rt_parse_float_native_bb19 ; branch
__L22ed_rt_parse_float_native_bb18:
    ...
    stp x0, x1, [sp, #480] ; hv store L30
    b __L22ed_rt_parse_float_native_bb19 ; branch
__L22ed_rt_parse_float_native_bb19:
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb21 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb20 ; branch -> then
__L22ed_rt_parse_float_native_bb20:
    add x15, sp, #512 ; hv frame base
    ...
    add x15, sp, #512 ; hv frame base
    stp x0, x1, [x15] ; hv store L32
    b __L22ed_rt_parse_float_native_bb21 ; branch
__L22ed_rt_parse_float_native_bb21:
    ldp x0, x1, [sp, #64] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb28 ; branch
__L22ed_rt_parse_float_native_bb22:
    add x15, sp, #528 ; hv frame base
    ldp x0, x1, [x15] ; hv load L33
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb25 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb24 ; branch -> then
__L22ed_rt_parse_float_native_bb23:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #560 ; hv frame base
    stp x0, x1, [x15] ; hv store L35
    b __L22ed_rt_parse_float_native_bb27 ; branch
__L22ed_rt_parse_float_native_bb24:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #560 ; hv frame base
    stp x0, x1, [x15] ; hv store L35
    b __L22ed_rt_parse_float_native_bb26 ; branch
__L22ed_rt_parse_float_native_bb25:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #528 ; hv frame base
    stp x0, x1, [x15] ; hv store L33
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb26 ; branch
__L22ed_rt_parse_float_native_bb26:
    b __L22ed_rt_parse_float_native_bb27 ; branch
__L22ed_rt_parse_float_native_bb27:
    b __L22ed_rt_parse_float_native_bb28 ; branch
__L22ed_rt_parse_float_native_bb28:
    b __L22ed_rt_parse_float_native_bb12 ; branch
__L22ed_rt_parse_float_native_bb29:
    ldp x0, x1, [sp, #64] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb32 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb31 ; branch -> then
__L22ed_rt_parse_float_native_bb30:
    add x15, sp, #1200 ; hv frame base
    ldp x0, x1, [x15] ; hv load L75
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb45 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb44 ; branch -> then
__L22ed_rt_parse_float_native_bb31:
    ldp x0, x1, [sp, #64] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb35 ; branch
__L22ed_rt_parse_float_native_bb32:
    add x15, sp, #1328 ; hv frame base
    ldp x0, x1, [x15] ; hv load L83
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #45 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb34 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb33 ; branch -> then
__L22ed_rt_parse_float_native_bb33:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1216 ; hv frame base
    stp x0, x1, [x15] ; hv store L76
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb34 ; branch
__L22ed_rt_parse_float_native_bb34:
    b __L22ed_rt_parse_float_native_bb35 ; branch
__L22ed_rt_parse_float_native_bb35:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1440 ; hv frame base
    stp x0, x1, [x15] ; hv store L90
    b __L22ed_rt_parse_float_native_bb36 ; branch
__L22ed_rt_parse_float_native_bb36:
    add x15, sp, #1440 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb38 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb37 ; branch -> then
__L22ed_rt_parse_float_native_bb37:
    ldp x0, x1, [sp, #48] ; hv load L2
    ldp x2, x3, [sp, #64] ; hv load L3
    add x1, x1, x3 ; __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] ; __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb40 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb39 ; branch -> then
__L22ed_rt_parse_float_native_bb38:
    b __L22ed_rt_parse_float_native_bb30 ; branch
__L22ed_rt_parse_float_native_bb39:
    add x15, sp, #1488 ; hv frame base
    ldp x0, x1, [x15] ; hv load L93
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #48 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb42 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb41 ; branch -> then
__L22ed_rt_parse_float_native_bb40:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #1440 ; hv frame base
    stp x0, x1, [x15] ; hv store L90
    b __L22ed_rt_parse_float_native_bb43 ; branch
__L22ed_rt_parse_float_native_bb41:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1000 ; hv const_int val
    add x15, sp, #1232 ; hv frame base
    stp x0, x1, [x15] ; hv store L77
    b __L22ed_rt_parse_float_native_bb42 ; branch
__L22ed_rt_parse_float_native_bb42:
    ldp x0, x1, [sp, #64] ; hv load L3
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    add x1, x1, x3 ; __hx_payload_add: x1 = a.pl add b.pl
    ...
    stp x0, x1, [sp, #64] ; hv store L3
    b __L22ed_rt_parse_float_native_bb43 ; branch
__L22ed_rt_parse_float_native_bb43:
    b __L22ed_rt_parse_float_native_bb36 ; branch
__L22ed_rt_parse_float_native_bb44:
    add x15, sp, #1216 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb47 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb46 ; branch -> then
__L22ed_rt_parse_float_native_bb45:
    ldp x0, x1, [sp, #48] ; hv load L2
    ldp x2, x3, [sp, #64] ; hv load L3
    add x1, x1, x3 ; __hx_ptr_load8: addr = ptr + off
    ldrb w1, [x1] ; __hx_ptr_load8: w1 = *(u8*)addr (zero-ext)
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb50 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb49 ; branch -> then
__L22ed_rt_parse_float_native_bb46:
    add x15, sp, #512 ; hv frame base
    ldp x0, x1, [x15] ; hv load L32
    add x15, sp, #1232 ; hv frame base
    ldp x2, x3, [x15] ; hv load L77
    ...
    add x15, sp, #512 ; hv frame base
    stp x0, x1, [x15] ; hv store L32
    b __L22ed_rt_parse_float_native_bb48 ; branch
__L22ed_rt_parse_float_native_bb47:
    add x15, sp, #512 ; hv frame base
    ldp x0, x1, [x15] ; hv load L32
    add x15, sp, #1232 ; hv frame base
    ldp x2, x3, [x15] ; hv load L77
    ...
    stp x0, x1, [x15] ; hv store L32
    b __L22ed_rt_parse_float_native_bb48 ; branch
__L22ed_rt_parse_float_native_bb48:
    b __L22ed_rt_parse_float_native_bb45 ; branch
__L22ed_rt_parse_float_native_bb49:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1920 ; hv frame base
    stp x0, x1, [x15] ; hv store L120
    b __L22ed_rt_parse_float_native_bb50 ; branch
__L22ed_rt_parse_float_native_bb50:
    add x15, sp, #544 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb52 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb51 ; branch -> then
__L22ed_rt_parse_float_native_bb51:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1920 ; hv frame base
    stp x0, x1, [x15] ; hv store L120
    b __L22ed_rt_parse_float_native_bb52 ; branch
__L22ed_rt_parse_float_native_bb52:
    add x15, sp, #1200 ; hv frame base
    ldp x0, x1, [x15] ; hv load L75
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb54 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb53 ; branch -> then
__L22ed_rt_parse_float_native_bb53:
    add x15, sp, #1248 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb56 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb55 ; branch -> then
__L22ed_rt_parse_float_native_bb54:
    add x15, sp, #1904 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb58 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb57 ; branch -> then
__L22ed_rt_parse_float_native_bb55:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1920 ; hv frame base
    stp x0, x1, [x15] ; hv store L120
    b __L22ed_rt_parse_float_native_bb56 ; branch
__L22ed_rt_parse_float_native_bb56:
    b __L22ed_rt_parse_float_native_bb54 ; branch
__L22ed_rt_parse_float_native_bb57:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1920 ; hv frame base
    stp x0, x1, [x15] ; hv store L120
    b __L22ed_rt_parse_float_native_bb58 ; branch
__L22ed_rt_parse_float_native_bb58:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb60 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb59 ; branch -> then
__L22ed_rt_parse_float_native_bb59:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1920 ; hv frame base
    stp x0, x1, [x15] ; hv store L120
    b __L22ed_rt_parse_float_native_bb60 ; branch
__L22ed_rt_parse_float_native_bb60:
    add x15, sp, #2144 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb62 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb61 ; branch -> then
__L22ed_rt_parse_float_native_bb61:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #512 ; hv frame base
    ldp x2, x3, [x15] ; hv load L32
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb64 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb63 ; branch -> then
__L22ed_rt_parse_float_native_bb62:
    add x15, sp, #1920 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb66 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb65 ; branch -> then
__L22ed_rt_parse_float_native_bb63:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #1920 ; hv frame base
    stp x0, x1, [x15] ; hv store L120
    b __L22ed_rt_parse_float_native_bb64 ; branch
__L22ed_rt_parse_float_native_bb64:
    b __L22ed_rt_parse_float_native_bb62 ; branch
__L22ed_rt_parse_float_native_bb65:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    ret ; return
__L22ed_rt_parse_float_native_bb66:
    ldp x0, x1, [sp, #480] ; hv load L30
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb68 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb67 ; branch -> then
__L22ed_rt_parse_float_native_bb67:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #512 ; hv frame base
    ldp x2, x3, [x15] ; hv load L32
    ...
    add x15, sp, #2528 ; hv frame base
    stp x0, x1, [x15] ; hv store L158
    b __L22ed_rt_parse_float_native_bb68 ; branch
__L22ed_rt_parse_float_native_bb68:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #2624 ; hv frame base
    stp x0, x1, [x15] ; hv store L164
    b __L22ed_rt_parse_float_native_bb69 ; branch
__L22ed_rt_parse_float_native_bb69:
    add x15, sp, #2624 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb71 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb70 ; branch -> then
__L22ed_rt_parse_float_native_bb70:
    add x15, sp, #2448 ; hv frame base
    ...
    stp x0, x1, [x15] ; hv store L164
    b __L22ed_rt_parse_float_native_bb69 ; branch
__L22ed_rt_parse_float_native_bb71:
    add x15, sp, #2384 ; hv frame base
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb73 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb72 ; branch -> then
__L22ed_rt_parse_float_native_bb72:
    add x15, sp, #2384 ; hv frame base
    ldp x0, x1, [x15] ; hv load L149
    add x15, sp, #2448 ; hv frame base
    ...
    add x15, sp, #2688 ; hv frame base
    stp x0, x1, [x15] ; hv store L168
    b __L22ed_rt_parse_float_native_bb74 ; branch
__L22ed_rt_parse_float_native_bb73:
    add x15, sp, #2384 ; hv frame base
    ldp x0, x1, [x15] ; hv load L149
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    stp x0, x1, [x15] ; hv store L168
    b __L22ed_rt_parse_float_native_bb74 ; branch
__L22ed_rt_parse_float_native_bb74:
    ...
    cbz x1, __L22ed_rt_parse_float_native_bb76 ; br_cond: !payload -> else
    b __L22ed_rt_parse_float_native_bb75 ; branch -> then
__L22ed_rt_parse_float_native_bb75:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #2688 ; hv frame base
    stp x0, x1, [x15] ; hv store L168
    b __L22ed_rt_parse_float_native_bb76 ; branch
__L22ed_rt_parse_float_native_bb76:
    add x15, sp, #2688 ; hv frame base
    ldp x0, x1, [x15] ; hv load L168
    add sp, sp, #2880 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
...
__L22ed__g_digits_bb0:
    ...
    cbz x1, __L22ed__g_digits_bb2 ; br_cond: !payload -> else
    b __L22ed__g_digits_bb1 ; branch -> then
__L22ed__g_digits_bb1:
...
__L22ed__g_digits_bb2:
    ...
    b __L22ed__g_digits_bb3 ; branch
__L22ed__g_digits_bb3:
    ...
    cbz x1, __L22ed__g_digits_bb5 ; br_cond: !payload -> else
    b __L22ed__g_digits_bb4 ; branch -> then
__L22ed__g_digits_bb4:
    ldp x0, x1, [sp, #96] ; hv load L6
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #10 ; hv const_int val
    bl _hexa_mod ; binop %
...
__L22ed__g_digits_bb5:
    ...
    b __L22ed__g_digits_bb6 ; branch
__L22ed__g_digits_bb6:
    ...
    cbz x1, __L22ed__g_digits_bb8 ; br_cond: !payload -> else
    b __L22ed__g_digits_bb7 ; branch -> then
__L22ed__g_digits_bb7:
    ldp x0, x1, [sp, #80] ; hv load L5
    ...
    stp x0, x1, [sp, #256] ; hv store L16
    b __L22ed__g_digits_bb6 ; branch
__L22ed__g_digits_bb8:
    ldp x0, x1, [sp, #208] ; hv load L13
    add sp, sp, #336 ; sp adj
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
.globl _rt_format_float_native
.private_extern _rt_format_float_native
    .p2align 2
_rt_format_float_native:
    .loc 1 314 0
    stp x29, x30, [sp, #-16]! ; prologue: save fp/lr
    mov x29, sp ; prologue: set fp
...
__L22ed_rt_format_float_native_bb0:
    ldp x0, x1, [sp, #16] ; hv load L0
    bl _hexa_float_to_bits ; call hexa_float_to_bits
    stp x0, x1, [sp, #48] ; hv store L2
    ldp x0, x1, [sp, #48] ; hv load L2
    stp x0, x1, [sp, #64] ; hv store L3
    ldp x0, x1, [sp, #64] ; hv load L3
    ...
    stp x0, x1, [sp, #224] ; hv store L14
    ldp x0, x1, [sp, #224] ; hv load L14
    cbz x1, __L22ed_rt_format_float_native_bb2 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb1 ; branch -> then
__L22ed_rt_format_float_native_bb1:
    ldp x0, x1, [sp, #112] ; hv load L6
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl _hexa_eq ; ne: eq
    ...
    stp x0, x1, [sp, #256] ; hv store L16
    ldp x0, x1, [sp, #256] ; hv load L16
    cbz x1, __L22ed_rt_format_float_native_bb4 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb3 ; branch -> then
__L22ed_rt_format_float_native_bb2:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    stp x0, x1, [sp, #480] ; hv store L30
    ldp x0, x1, [sp, #480] ; hv load L30
    cbz x1, __L22ed_rt_format_float_native_bb9 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb8 ; branch -> then
__L22ed_rt_format_float_native_bb3:
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb4 ; branch
__L22ed_rt_format_float_native_bb4:
    ldp x0, x1, [sp, #192] ; hv load L11
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl _hexa_eq ; binop ==
    stp x0, x1, [sp, #304] ; hv store L19
    ldp x0, x1, [sp, #304] ; hv load L19
    cbz x1, __L22ed_rt_format_float_native_bb6 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb5 ; branch -> then
__L22ed_rt_format_float_native_bb5:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb7 ; branch
__L22ed_rt_format_float_native_bb6:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #110 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb7 ; branch
__L22ed_rt_format_float_native_bb7:
    ldp x0, x1, [sp, #0] ; hv load L13
    bl _hexa_bytes_to_str_raw ; call hexa_bytes_to_str_raw
    stp x0, x1, [sp, #432] ; hv store L27
    ldp x0, x1, [sp, #432] ; hv load L27
    movz x15, #7312 ; imm 0-15
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L22ed_rt_format_float_native_bb8:
    ldp x0, x1, [sp, #192] ; hv load L11
    stp x0, x1, [sp, #448] ; hv store L28
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    add x15, sp, #512 ; hv frame base
    ldp x0, x1, [x15] ; hv load L32
    cbz x1, __L22ed_rt_format_float_native_bb11 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb10 ; branch -> then
__L22ed_rt_format_float_native_bb9:
    ldp x0, x1, [sp, #192] ; hv load L11
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; imm 0-15
    ...
    ldp x0, x1, [x15] ; hv load L40
    stp x0, x1, [sp, #464] ; hv store L29
    b __L22ed_rt_format_float_native_bb14 ; branch
__L22ed_rt_format_float_native_bb10:
    ldp x0, x1, [sp, #112] ; hv load L6
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl _hexa_eq ; ne: eq
    ...
    add x15, sp, #544 ; hv frame base
    ldp x0, x1, [x15] ; hv load L34
    cbz x1, __L22ed_rt_format_float_native_bb13 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb12 ; branch -> then
__L22ed_rt_format_float_native_bb11:
    b __L22ed_rt_format_float_native_bb14 ; branch
__L22ed_rt_format_float_native_bb12:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #45 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    ldp x0, x1, [x15] ; hv load L36
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb13 ; branch
__L22ed_rt_format_float_native_bb13:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #48 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    ldp x29, x30, [sp], #16 ; epilogue: restore fp/lr
    ret ; return
__L22ed_rt_format_float_native_bb14:
    ldp x0, x1, [sp, #32] ; hv load L1
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    add x15, sp, #656 ; hv frame base
    ...
    cbz x1, __L22ed_rt_format_float_native_bb16 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb15 ; branch -> then
__L22ed_rt_format_float_native_bb15:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #6 ; hv const_int val
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb16 ; branch
__L22ed_rt_format_float_native_bb16:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    b __L22ed_rt_format_float_native_bb17 ; branch
__L22ed_rt_format_float_native_bb17:
    add x15, sp, #768 ; hv frame base
    ...
    add x15, sp, #784 ; hv frame base
    ldp x0, x1, [x15] ; hv load L49
    cbz x1, __L22ed_rt_format_float_native_bb19 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb18 ; branch -> then
__L22ed_rt_format_float_native_bb18:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    stp x0, x1, [x15] ; hv store L48
    b __L22ed_rt_format_float_native_bb17 ; branch
__L22ed_rt_format_float_native_bb19:
    add x15, sp, #720 ; hv frame base
    ldp x0, x1, [x15] ; hv load L45
    add x15, sp, #832 ; hv frame base
    stp x0, x1, [x15] ; hv store L52
    ...
    add x15, sp, #896 ; hv frame base
    ldp x0, x1, [x15] ; hv load L56
    cbz x1, __L22ed_rt_format_float_native_bb21 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb20 ; branch -> then
__L22ed_rt_format_float_native_bb20:
    ldp x0, x1, [sp, #448] ; hv load L28
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #51712 ; imm 0-15
    movk x3, #15258, lsl #16 ; imm 16-31
    ...
    add x15, sp, #848 ; hv frame base
    stp x0, x1, [x15] ; hv store L53
    b __L22ed_rt_format_float_native_bb22 ; branch
__L22ed_rt_format_float_native_bb21:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #832 ; hv frame base
    ldp x2, x3, [x15] ; hv load L52
    ...
    stp x0, x1, [x15] ; hv store L47
    b __L22ed_rt_format_float_native_bb22 ; branch
__L22ed_rt_format_float_native_bb22:
    b __L22ed_rt_format_float_native_bb23 ; branch
__L22ed_rt_format_float_native_bb23:
    ldp x0, x1, [sp, #464] ; hv load L29
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl _hexa_cmp_gt ; binop >
    ...
    add x15, sp, #992 ; hv frame base
    ldp x0, x1, [x15] ; hv load L62
    cbz x1, __L22ed_rt_format_float_native_bb25 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb24 ; branch -> then
__L22ed_rt_format_float_native_bb24:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #1008 ; hv frame base
    stp x0, x1, [x15] ; hv store L63
    ...
    add x15, sp, #1040 ; hv frame base
    ldp x0, x1, [x15] ; hv load L65
    cbz x1, __L22ed_rt_format_float_native_bb27 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb26 ; branch -> then
__L22ed_rt_format_float_native_bb25:
    b __L22ed_rt_format_float_native_bb39 ; branch
__L22ed_rt_format_float_native_bb26:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #29 ; hv const_int val
    add x15, sp, #1024 ; hv frame base
    stp x0, x1, [x15] ; hv store L64
    b __L22ed_rt_format_float_native_bb27 ; branch
__L22ed_rt_format_float_native_bb27:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #1088 ; hv frame base
    stp x0, x1, [x15] ; hv store L68
    b __L22ed_rt_format_float_native_bb28 ; branch
__L22ed_rt_format_float_native_bb28:
    add x15, sp, #1088 ; hv frame base
    ldp x0, x1, [x15] ; hv load L68
    add x15, sp, #848 ; hv frame base
    ...
    add x15, sp, #1104 ; hv frame base
    ldp x0, x1, [x15] ; hv load L69
    cbz x1, __L22ed_rt_format_float_native_bb30 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb29 ; branch -> then
__L22ed_rt_format_float_native_bb29:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #1088 ; hv frame base
    ...
    stp x0, x1, [x15] ; hv store L68
    b __L22ed_rt_format_float_native_bb28 ; branch
__L22ed_rt_format_float_native_bb30:
    add x15, sp, #1008 ; hv frame base
    ldp x0, x1, [x15] ; hv load L63
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    add x15, sp, #1232 ; hv frame base
    ldp x0, x1, [x15] ; hv load L77
    cbz x1, __L22ed_rt_format_float_native_bb32 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb31 ; branch -> then
__L22ed_rt_format_float_native_bb31:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #752 ; hv frame base
    stp x0, x1, [x15] ; hv store L47
    b __L22ed_rt_format_float_native_bb32 ; branch
__L22ed_rt_format_float_native_bb32:
    b __L22ed_rt_format_float_native_bb33 ; branch
__L22ed_rt_format_float_native_bb33:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    cbz x1, __L22ed_rt_format_float_native_bb35 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb34 ; branch -> then
__L22ed_rt_format_float_native_bb34:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #1328 ; hv frame base
    ldp x0, x1, [x15] ; hv load L83
    cbz x1, __L22ed_rt_format_float_native_bb37 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb36 ; branch -> then
__L22ed_rt_format_float_native_bb35:
    ldp x0, x1, [sp, #464] ; hv load L29
    add x15, sp, #1024 ; hv frame base
    ldp x2, x3, [x15] ; hv load L64
    bl _hexa_sub ; binop -
    ...
    stp x0, x1, [sp, #464] ; hv store L29
    b __L22ed_rt_format_float_native_bb23 ; branch
__L22ed_rt_format_float_native_bb36:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #880 ; hv frame base
    stp x0, x1, [x15] ; hv store L55
    b __L22ed_rt_format_float_native_bb38 ; branch
__L22ed_rt_format_float_native_bb37:
    b __L22ed_rt_format_float_native_bb35 ; branch
__L22ed_rt_format_float_native_bb38:
    b __L22ed_rt_format_float_native_bb33 ; branch
__L22ed_rt_format_float_native_bb39:
    ldp x0, x1, [sp, #464] ; hv load L29
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl _hexa_cmp_lt ; binop <
    ...
    add x15, sp, #1392 ; hv frame base
    ldp x0, x1, [x15] ; hv load L87
    cbz x1, __L22ed_rt_format_float_native_bb41 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb40 ; branch -> then
__L22ed_rt_format_float_native_bb40:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    add x15, sp, #1456 ; hv frame base
    ldp x0, x1, [x15] ; hv load L91
    cbz x1, __L22ed_rt_format_float_native_bb43 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb42 ; branch -> then
__L22ed_rt_format_float_native_bb41:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #2000 ; hv frame base
    stp x0, x1, [x15] ; hv store L125
    ...
    cbz x1, __L22ed_rt_format_float_native_bb54 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb53 ; branch -> then
__L22ed_rt_format_float_native_bb42:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #9 ; hv const_int val
    add x15, sp, #1440 ; hv frame base
    stp x0, x1, [x15] ; hv store L90
    b __L22ed_rt_format_float_native_bb43 ; branch
__L22ed_rt_format_float_native_bb43:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    add x15, sp, #1648 ; hv frame base
    stp x0, x1, [x15] ; hv store L103
    b __L22ed_rt_format_float_native_bb44 ; branch
__L22ed_rt_format_float_native_bb44:
    add x15, sp, #1648 ; hv frame base
    ...
    add x15, sp, #1664 ; hv frame base
    ldp x0, x1, [x15] ; hv load L104
    cbz x1, __L22ed_rt_format_float_native_bb46 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb45 ; branch -> then
__L22ed_rt_format_float_native_bb45:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #1648 ; hv frame base
    ldp x2, x3, [x15] ; hv load L103
    ...
    stp x0, x1, [x15] ; hv store L103
    b __L22ed_rt_format_float_native_bb44 ; branch
__L22ed_rt_format_float_native_bb46:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    add x15, sp, #1824 ; hv frame base
    ldp x0, x1, [x15] ; hv load L114
    cbz x1, __L22ed_rt_format_float_native_bb48 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb47 ; branch -> then
__L22ed_rt_format_float_native_bb47:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #848 ; hv frame base
    stp x0, x1, [x15] ; hv store L53
    b __L22ed_rt_format_float_native_bb48 ; branch
__L22ed_rt_format_float_native_bb48:
    add x15, sp, #1408 ; hv frame base
    ...
    add x15, sp, #1872 ; hv frame base
    ldp x0, x1, [x15] ; hv load L117
    cbz x1, __L22ed_rt_format_float_native_bb50 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb49 ; branch -> then
__L22ed_rt_format_float_native_bb49:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #880 ; hv frame base
    ldp x2, x3, [x15] ; hv load L55
    ...
    add x15, sp, #880 ; hv frame base
    stp x0, x1, [x15] ; hv store L55
    b __L22ed_rt_format_float_native_bb50 ; branch
__L22ed_rt_format_float_native_bb50:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    add x15, sp, #1936 ; hv frame base
    ldp x0, x1, [x15] ; hv load L121
    cbz x1, __L22ed_rt_format_float_native_bb52 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb51 ; branch -> then
__L22ed_rt_format_float_native_bb51:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    add x15, sp, #1552 ; hv frame base
    ldp x2, x3, [x15] ; hv load L97
    ...
    add x15, sp, #880 ; hv frame base
    stp x0, x1, [x15] ; hv store L55
    b __L22ed_rt_format_float_native_bb52 ; branch
__L22ed_rt_format_float_native_bb52:
    ldp x0, x1, [sp, #464] ; hv load L29
    add x15, sp, #1440 ; hv frame base
    ldp x2, x3, [x15] ; hv load L90
    bl _hexa_add_slow ; binop +
    ...
    stp x0, x1, [sp, #464] ; hv store L29
    b __L22ed_rt_format_float_native_bb39 ; branch
__L22ed_rt_format_float_native_bb53:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    add x15, sp, #2000 ; hv frame base
    stp x0, x1, [x15] ; hv store L125
    b __L22ed_rt_format_float_native_bb55 ; branch
__L22ed_rt_format_float_native_bb54:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_format_float_native_bb59 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb58 ; branch -> then
__L22ed_rt_format_float_native_bb55:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    add x15, sp, #2112 ; hv frame base
    ldp x0, x1, [x15] ; hv load L132
    cbz x1, __L22ed_rt_format_float_native_bb57 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb56 ; branch -> then
__L22ed_rt_format_float_native_bb56:
    add x15, sp, #2048 ; hv frame base
    ...
    stp x0, x1, [x15] ; hv store L125
    b __L22ed_rt_format_float_native_bb55 ; branch
__L22ed_rt_format_float_native_bb57:
    b __L22ed_rt_format_float_native_bb54 ; branch
__L22ed_rt_format_float_native_bb58:
    add x15, sp, #2192 ; hv frame base
    ldp x0, x1, [x15] ; hv load L137
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #2192 ; hv frame base
    stp x0, x1, [x15] ; hv store L137
    b __L22ed_rt_format_float_native_bb59 ; branch
__L22ed_rt_format_float_native_bb59:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    add x15, sp, #832 ; hv frame base
    ldp x2, x3, [x15] ; hv load L52
    ...
    cbz x1, __L22ed_rt_format_float_native_bb61 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb60 ; branch -> then
__L22ed_rt_format_float_native_bb60:
    movz x0, #0 ; hv const_int: TAG_INT
    ...
    add x15, sp, #2512 ; hv frame base
    stp x0, x1, [x15] ; hv store L157
    b __L22ed_rt_format_float_native_bb62 ; branch
__L22ed_rt_format_float_native_bb61:
    b __L22ed_rt_format_float_native_bb99 ; branch
__L22ed_rt_format_float_native_bb62:
    add x15, sp, #2512 ; hv frame base
    ldp x0, x1, [x15] ; hv load L157
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #9 ; hv const_int val
    ...
    add x15, sp, #2560 ; hv frame base
    ldp x0, x1, [x15] ; hv load L160
    cbz x1, __L22ed_rt_format_float_native_bb64 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb63 ; branch -> then
__L22ed_rt_format_float_native_bb63:
    add x15, sp, #2528 ; hv frame base
    ...
    stp x0, x1, [x15] ; hv store L157
    b __L22ed_rt_format_float_native_bb62 ; branch
__L22ed_rt_format_float_native_bb64:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    add x15, sp, #2656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L166
    cbz x1, __L22ed_rt_format_float_native_bb66 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb65 ; branch -> then
__L22ed_rt_format_float_native_bb65:
    add x15, sp, #2656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L166
    add x15, sp, #2672 ; hv frame base
    stp x0, x1, [x15] ; hv store L167
    b __L22ed_rt_format_float_native_bb67 ; branch
__L22ed_rt_format_float_native_bb66:
    add x15, sp, #2448 ; hv frame base
    ldp x0, x1, [x15] ; hv load L153
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    stp x0, x1, [x15] ; hv store L167
    b __L22ed_rt_format_float_native_bb67 ; branch
__L22ed_rt_format_float_native_bb67:
    add x15, sp, #2672 ; hv frame base
    ldp x0, x1, [x15] ; hv load L167
    ...
    cbz x1, __L22ed_rt_format_float_native_bb69 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb68 ; branch -> then
__L22ed_rt_format_float_native_bb68:
    add x15, sp, #2528 ; hv frame base
    ldp x0, x1, [x15] ; hv load L158
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_format_float_native_bb71 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb70 ; branch -> then
__L22ed_rt_format_float_native_bb69:
    add x15, sp, #2448 ; hv frame base
    ldp x0, x1, [x15] ; hv load L153
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb98 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb97 ; branch -> then
__L22ed_rt_format_float_native_bb70:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #2784 ; hv frame base
    stp x0, x1, [x15] ; hv store L174
    b __L22ed_rt_format_float_native_bb71 ; branch
__L22ed_rt_format_float_native_bb71:
    add x15, sp, #2528 ; hv frame base
    ldp x0, x1, [x15] ; hv load L158
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #51712 ; imm 0-15
    ...
    cbz x1, __L22ed_rt_format_float_native_bb73 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb72 ; branch -> then
__L22ed_rt_format_float_native_bb72:
    add x15, sp, #2448 ; hv frame base
    ldp x0, x1, [x15] ; hv load L153
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    cbz x1, __L22ed_rt_format_float_native_bb75 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb74 ; branch -> then
__L22ed_rt_format_float_native_bb73:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb79 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb78 ; branch -> then
__L22ed_rt_format_float_native_bb74:
    add x15, sp, #2448 ; hv frame base
    ldp x0, x1, [x15] ; hv load L153
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb77 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb76 ; branch -> then
__L22ed_rt_format_float_native_bb75:
    b __L22ed_rt_format_float_native_bb73 ; branch
__L22ed_rt_format_float_native_bb76:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #2784 ; hv frame base
    stp x0, x1, [x15] ; hv store L174
    b __L22ed_rt_format_float_native_bb77 ; branch
__L22ed_rt_format_float_native_bb77:
    b __L22ed_rt_format_float_native_bb75 ; branch
__L22ed_rt_format_float_native_bb78:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    add x15, sp, #3024 ; hv frame base
    stp x0, x1, [x15] ; hv store L189
    b __L22ed_rt_format_float_native_bb86 ; branch
__L22ed_rt_format_float_native_bb79:
    add x15, sp, #2640 ; hv frame base
    ldp x0, x1, [x15] ; hv load L165
    add x15, sp, #2768 ; hv frame base
    ldp x2, x3, [x15] ; hv load L173
    ...
    cbz x1, __L22ed_rt_format_float_native_bb81 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb80 ; branch -> then
__L22ed_rt_format_float_native_bb80:
    add x15, sp, #2448 ; hv frame base
    ldp x0, x1, [x15] ; hv load L153
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb83 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb82 ; branch -> then
__L22ed_rt_format_float_native_bb81:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #3024 ; hv frame base
    stp x0, x1, [x15] ; hv store L189
    b __L22ed_rt_format_float_native_bb85 ; branch
__L22ed_rt_format_float_native_bb82:
    add x15, sp, #2784 ; hv frame base
    ldp x0, x1, [x15] ; hv load L174
    add x15, sp, #3024 ; hv frame base
    stp x0, x1, [x15] ; hv store L189
    b __L22ed_rt_format_float_native_bb84 ; branch
__L22ed_rt_format_float_native_bb83:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #3024 ; hv frame base
    stp x0, x1, [x15] ; hv store L189
    b __L22ed_rt_format_float_native_bb84 ; branch
__L22ed_rt_format_float_native_bb84:
    b __L22ed_rt_format_float_native_bb85 ; branch
__L22ed_rt_format_float_native_bb85:
    b __L22ed_rt_format_float_native_bb86 ; branch
__L22ed_rt_format_float_native_bb86:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    cbz x1, __L22ed_rt_format_float_native_bb88 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb87 ; branch -> then
__L22ed_rt_format_float_native_bb87:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    add x15, sp, #752 ; hv frame base
    stp x0, x1, [x15] ; hv store L47
    b __L22ed_rt_format_float_native_bb89 ; branch
__L22ed_rt_format_float_native_bb88:
    b __L22ed_rt_format_float_native_bb69 ; branch
__L22ed_rt_format_float_native_bb89:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    cbz x1, __L22ed_rt_format_float_native_bb91 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb90 ; branch -> then
__L22ed_rt_format_float_native_bb90:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    cbz x1, __L22ed_rt_format_float_native_bb93 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb92 ; branch -> then
__L22ed_rt_format_float_native_bb91:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #10 ; hv const_int val
    ...
    add x15, sp, #2000 ; hv frame base
    stp x0, x1, [x15] ; hv store L125
    b __L22ed_rt_format_float_native_bb94 ; branch
__L22ed_rt_format_float_native_bb92:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #752 ; hv frame base
    stp x0, x1, [x15] ; hv store L47
    b __L22ed_rt_format_float_native_bb93 ; branch
__L22ed_rt_format_float_native_bb93:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #2448 ; hv frame base
    ldp x2, x3, [x15] ; hv load L153
    ...
    stp x0, x1, [x15] ; hv store L47
    b __L22ed_rt_format_float_native_bb89 ; branch
__L22ed_rt_format_float_native_bb94:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    cbz x1, __L22ed_rt_format_float_native_bb96 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb95 ; branch -> then
__L22ed_rt_format_float_native_bb95:
    add x15, sp, #3376 ; hv frame base
    ...
    stp x0, x1, [x15] ; hv store L125
    b __L22ed_rt_format_float_native_bb94 ; branch
__L22ed_rt_format_float_native_bb96:
    b __L22ed_rt_format_float_native_bb88 ; branch
__L22ed_rt_format_float_native_bb97:
    add x15, sp, #2448 ; hv frame base
    ldp x0, x1, [x15] ; hv load L153
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #880 ; hv frame base
    stp x0, x1, [x15] ; hv store L55
    b __L22ed_rt_format_float_native_bb98 ; branch
__L22ed_rt_format_float_native_bb98:
    b __L22ed_rt_format_float_native_bb61 ; branch
__L22ed_rt_format_float_native_bb99:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    cbz x1, __L22ed_rt_format_float_native_bb101 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb100 ; branch -> then
__L22ed_rt_format_float_native_bb100:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb103 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb102 ; branch -> then
__L22ed_rt_format_float_native_bb101:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb106 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb105 ; branch -> then
__L22ed_rt_format_float_native_bb102:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #880 ; hv frame base
    stp x0, x1, [x15] ; hv store L55
    b __L22ed_rt_format_float_native_bb104 ; branch
__L22ed_rt_format_float_native_bb103:
    b __L22ed_rt_format_float_native_bb101 ; branch
__L22ed_rt_format_float_native_bb104:
    b __L22ed_rt_format_float_native_bb99 ; branch
__L22ed_rt_format_float_native_bb105:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb106 ; branch
__L22ed_rt_format_float_native_bb106:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    add x15, sp, #2000 ; hv frame base
    ldp x2, x3, [x15] ; hv load L125
    ...
    cbz x1, __L22ed_rt_format_float_native_bb108 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb107 ; branch -> then
__L22ed_rt_format_float_native_bb107:
    add x15, sp, #2000 ; hv frame base
    ldp x0, x1, [x15] ; hv load L125
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #3 ; imm 0-15
    ...
    b __L22ed_rt_format_float_native_bb109 ; branch
__L22ed_rt_format_float_native_bb108:
    add x15, sp, #3680 ; hv frame base
    ldp x0, x1, [x15] ; hv load L230
    add x15, sp, #3696 ; hv frame base
    stp x0, x1, [x15] ; hv store L231
    b __L22ed_rt_format_float_native_bb109 ; branch
__L22ed_rt_format_float_native_bb109:
    add x15, sp, #3696 ; hv frame base
    ldp x0, x1, [x15] ; hv load L231
    cbz x1, __L22ed_rt_format_float_native_bb111 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb110 ; branch -> then
__L22ed_rt_format_float_native_bb110:
    add x15, sp, #2160 ; hv frame base
    ldp x0, x1, [x15] ; hv load L135
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb112 ; branch
__L22ed_rt_format_float_native_bb111:
    add x15, sp, #2160 ; hv frame base
    ldp x0, x1, [x15] ; hv load L135
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #2 ; hv const_int val
    ...
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb112 ; branch
__L22ed_rt_format_float_native_bb112:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #9 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb114 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb113 ; branch -> then
__L22ed_rt_format_float_native_bb113:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb116 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb115 ; branch -> then
__L22ed_rt_format_float_native_bb114:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    add x15, sp, #832 ; hv frame base
    ldp x2, x3, [x15] ; hv load L52
    ...
    cbz x1, __L22ed_rt_format_float_native_bb121 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb120 ; branch -> then
__L22ed_rt_format_float_native_bb115:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #10 ; hv const_int val
    ...
    add x15, sp, #3824 ; hv frame base
    stp x0, x1, [x15] ; hv store L239
    b __L22ed_rt_format_float_native_bb117 ; branch
__L22ed_rt_format_float_native_bb116:
    b __L22ed_rt_format_float_native_bb114 ; branch
__L22ed_rt_format_float_native_bb117:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb119 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb118 ; branch -> then
__L22ed_rt_format_float_native_bb118:
    add x15, sp, #3936 ; hv frame base
    ...
    stp x0, x1, [x15] ; hv store L239
    b __L22ed_rt_format_float_native_bb117 ; branch
__L22ed_rt_format_float_native_bb119:
    b __L22ed_rt_format_float_native_bb116 ; branch
__L22ed_rt_format_float_native_bb120:
    movz x15, #4096 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb123 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb122 ; branch -> then
__L22ed_rt_format_float_native_bb121:
    movz x15, #4096 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L256
    add x15, sp, #2000 ; hv frame base
    ...
    cbz x1, __L22ed_rt_format_float_native_bb127 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb126 ; branch -> then
__L22ed_rt_format_float_native_bb122:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #4160 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L260
    b __L22ed_rt_format_float_native_bb123 ; branch
__L22ed_rt_format_float_native_bb123:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #4160 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb125 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb124 ; branch -> then
__L22ed_rt_format_float_native_bb124:
    movz x15, #4160 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L260
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb125 ; branch
__L22ed_rt_format_float_native_bb125:
    b __L22ed_rt_format_float_native_bb130 ; branch
__L22ed_rt_format_float_native_bb126:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #4272 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L267
    b __L22ed_rt_format_float_native_bb127 ; branch
__L22ed_rt_format_float_native_bb127:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #4272 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb129 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb128 ; branch -> then
__L22ed_rt_format_float_native_bb128:
    movz x15, #4272 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L267
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb129 ; branch
__L22ed_rt_format_float_native_bb129:
    b __L22ed_rt_format_float_native_bb130 ; branch
__L22ed_rt_format_float_native_bb130:
    ldp x0, x1, [sp, #112] ; hv load L6
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    bl _hexa_eq ; ne: eq
    ...
    cbz x1, __L22ed_rt_format_float_native_bb132 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb131 ; branch -> then
__L22ed_rt_format_float_native_bb131:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #45 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb132 ; branch
__L22ed_rt_format_float_native_bb132:
    add x15, sp, #2160 ; hv frame base
    ldp x0, x1, [x15] ; hv load L135
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #102 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb134 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb133 ; branch -> then
__L22ed_rt_format_float_native_bb133:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    add x15, sp, #832 ; hv frame base
    ldp x2, x3, [x15] ; hv load L52
    ...
    cbz x1, __L22ed_rt_format_float_native_bb136 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb135 ; branch -> then
__L22ed_rt_format_float_native_bb134:
    add x15, sp, #2000 ; hv frame base
    ldp x0, x1, [x15] ; hv load L125
    ...
    cbz x1, __L22ed_rt_format_float_native_bb180 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb179 ; branch -> then
__L22ed_rt_format_float_native_bb135:
    add x15, sp, #832 ; hv frame base
    ldp x0, x1, [x15] ; hv load L52
    add x15, sp, #848 ; hv frame base
    stp x0, x1, [x15] ; hv store L53
    b __L22ed_rt_format_float_native_bb136 ; branch
__L22ed_rt_format_float_native_bb136:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    movz x15, #4464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L279
    b __L22ed_rt_format_float_native_bb137 ; branch
__L22ed_rt_format_float_native_bb137:
    movz x15, #4464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb139 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb138 ; branch -> then
__L22ed_rt_format_float_native_bb138:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    movz x15, #4464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb141 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb140 ; branch -> then
__L22ed_rt_format_float_native_bb139:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb156 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb155 ; branch -> then
__L22ed_rt_format_float_native_bb140:
    movz x15, #4528 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    b __L22ed_rt_format_float_native_bb142 ; branch
__L22ed_rt_format_float_native_bb141:
    movz x15, #4528 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L283
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb149 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb148 ; branch -> then
__L22ed_rt_format_float_native_bb142:
    movz x15, #4592 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb144 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb143 ; branch -> then
__L22ed_rt_format_float_native_bb143:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #48 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [x15] ; hv store L287
    b __L22ed_rt_format_float_native_bb142 ; branch
__L22ed_rt_format_float_native_bb144:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #4656 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L291
    b __L22ed_rt_format_float_native_bb145 ; branch
__L22ed_rt_format_float_native_bb145:
    movz x15, #4528 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L283
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb147 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb146 ; branch -> then
__L22ed_rt_format_float_native_bb146:
    movz x15, #4528 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L283
    movz x15, #4656 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L291
    b __L22ed_rt_format_float_native_bb145 ; branch
__L22ed_rt_format_float_native_bb147:
    b __L22ed_rt_format_float_native_bb154 ; branch
__L22ed_rt_format_float_native_bb148:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #48 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb153 ; branch
__L22ed_rt_format_float_native_bb149:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #4816 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L301
    b __L22ed_rt_format_float_native_bb150 ; branch
__L22ed_rt_format_float_native_bb150:
    movz x15, #4528 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L283
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb152 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb151 ; branch -> then
__L22ed_rt_format_float_native_bb151:
    movz x15, #4528 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L283
    movz x15, #4816 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L301
    b __L22ed_rt_format_float_native_bb150 ; branch
__L22ed_rt_format_float_native_bb152:
    b __L22ed_rt_format_float_native_bb153 ; branch
__L22ed_rt_format_float_native_bb153:
    b __L22ed_rt_format_float_native_bb154 ; branch
__L22ed_rt_format_float_native_bb154:
    movz x15, #4464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L279
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    stp x0, x1, [x15] ; hv store L279
    b __L22ed_rt_format_float_native_bb137 ; branch
__L22ed_rt_format_float_native_bb155:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #46 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb156 ; branch
__L22ed_rt_format_float_native_bb156:
    add x15, sp, #832 ; hv frame base
    ldp x0, x1, [x15] ; hv load L52
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L279
    b __L22ed_rt_format_float_native_bb157 ; branch
__L22ed_rt_format_float_native_bb157:
    movz x15, #4464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L279
    add x15, sp, #880 ; hv frame base
    ...
    cbz x1, __L22ed_rt_format_float_native_bb161 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb160 ; branch -> then
__L22ed_rt_format_float_native_bb158:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    movz x15, #4464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    b __L22ed_rt_format_float_native_bb163 ; branch
__L22ed_rt_format_float_native_bb159:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb175 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb174 ; branch -> then
__L22ed_rt_format_float_native_bb160:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    b __L22ed_rt_format_float_native_bb162 ; branch
__L22ed_rt_format_float_native_bb161:
    movz x15, #4992 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L312
    movz x15, #5008 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L313
    b __L22ed_rt_format_float_native_bb162 ; branch
__L22ed_rt_format_float_native_bb162:
    movz x15, #5008 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L313
    cbz x1, __L22ed_rt_format_float_native_bb159 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb158 ; branch -> then
__L22ed_rt_format_float_native_bb163:
    movz x15, #5136 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb165 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb164 ; branch -> then
__L22ed_rt_format_float_native_bb164:
    movz x15, #5104 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    stp x0, x1, [x15] ; hv store L321
    b __L22ed_rt_format_float_native_bb163 ; branch
__L22ed_rt_format_float_native_bb165:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #5200 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L325
    b __L22ed_rt_format_float_native_bb166 ; branch
__L22ed_rt_format_float_native_bb166:
    movz x15, #5072 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L317
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb168 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb167 ; branch -> then
__L22ed_rt_format_float_native_bb167:
    movz x15, #5072 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L317
    movz x15, #5200 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L325
    b __L22ed_rt_format_float_native_bb166 ; branch
__L22ed_rt_format_float_native_bb168:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #9 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb170 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb169 ; branch -> then
__L22ed_rt_format_float_native_bb169:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #5296 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L331
    b __L22ed_rt_format_float_native_bb170 ; branch
__L22ed_rt_format_float_native_bb170:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #5344 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L334
    b __L22ed_rt_format_float_native_bb171 ; branch
__L22ed_rt_format_float_native_bb171:
    movz x15, #5344 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb173 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb172 ; branch -> then
__L22ed_rt_format_float_native_bb172:
    movz x15, #5104 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L319
    movz x15, #5344 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L334
    b __L22ed_rt_format_float_native_bb171 ; branch
__L22ed_rt_format_float_native_bb173:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #9 ; hv const_int val
    ...
    stp x0, x1, [x15] ; hv store L279
    b __L22ed_rt_format_float_native_bb157 ; branch
__L22ed_rt_format_float_native_bb174:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #5488 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L343
    b __L22ed_rt_format_float_native_bb176 ; branch
__L22ed_rt_format_float_native_bb175:
    b __L22ed_rt_format_float_native_bb238 ; branch
__L22ed_rt_format_float_native_bb176:
    movz x15, #5488 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb178 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb177 ; branch -> then
__L22ed_rt_format_float_native_bb177:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #48 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [x15] ; hv store L343
    b __L22ed_rt_format_float_native_bb176 ; branch
__L22ed_rt_format_float_native_bb178:
    b __L22ed_rt_format_float_native_bb175 ; branch
__L22ed_rt_format_float_native_bb179:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    movz x15, #5568 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L347
    b __L22ed_rt_format_float_native_bb180 ; branch
__L22ed_rt_format_float_native_bb180:
    movz x15, #5552 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb182 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb181 ; branch -> then
__L22ed_rt_format_float_native_bb181:
    movz x15, #5680 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L355
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L355
    b __L22ed_rt_format_float_native_bb183 ; branch
__L22ed_rt_format_float_native_bb182:
    movz x15, #5680 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L355
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    stp x0, x1, [x15] ; hv store L355
    b __L22ed_rt_format_float_native_bb183 ; branch
__L22ed_rt_format_float_native_bb183:
    movz x15, #5648 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb185 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb184 ; branch -> then
__L22ed_rt_format_float_native_bb184:
    movz x15, #5648 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L353
    bl _hexa_len ; call hexa_len
    ...
    b __L22ed_rt_format_float_native_bb186 ; branch
__L22ed_rt_format_float_native_bb185:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #5904 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L369
    b __L22ed_rt_format_float_native_bb189 ; branch
__L22ed_rt_format_float_native_bb186:
    movz x15, #5840 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb188 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb187 ; branch -> then
__L22ed_rt_format_float_native_bb187:
    movz x15, #5680 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L355
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    stp x0, x1, [x15] ; hv store L365
    b __L22ed_rt_format_float_native_bb186 ; branch
__L22ed_rt_format_float_native_bb188:
    b __L22ed_rt_format_float_native_bb185 ; branch
__L22ed_rt_format_float_native_bb189:
    movz x15, #5648 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L353
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb191 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb190 ; branch -> then
__L22ed_rt_format_float_native_bb190:
    movz x15, #5648 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L353
    movz x15, #5904 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L369
    b __L22ed_rt_format_float_native_bb189 ; branch
__L22ed_rt_format_float_native_bb191:
    add x15, sp, #880 ; hv frame base
    ldp x0, x1, [x15] ; hv load L55
    add x15, sp, #848 ; hv frame base
    ldp x2, x3, [x15] ; hv load L53
    ...
    cbz x1, __L22ed_rt_format_float_native_bb193 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb192 ; branch -> then
__L22ed_rt_format_float_native_bb192:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #1 ; hv const_int val
    ...
    add x15, sp, #880 ; hv frame base
    stp x0, x1, [x15] ; hv store L55
    b __L22ed_rt_format_float_native_bb193 ; branch
__L22ed_rt_format_float_native_bb193:
    add x15, sp, #848 ; hv frame base
    ldp x0, x1, [x15] ; hv load L53
    movz x15, #6048 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L378
    b __L22ed_rt_format_float_native_bb194 ; branch
__L22ed_rt_format_float_native_bb194:
    movz x15, #6048 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb198 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb197 ; branch -> then
__L22ed_rt_format_float_native_bb195:
    add x15, sp, #752 ; hv frame base
    ldp x0, x1, [x15] ; hv load L47
    movz x15, #6048 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb201 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb200 ; branch -> then
__L22ed_rt_format_float_native_bb196:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    cbz x1, __L22ed_rt_format_float_native_bb231 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb230 ; branch -> then
__L22ed_rt_format_float_native_bb197:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #0 ; hv const_int val
    ...
    b __L22ed_rt_format_float_native_bb199 ; branch
__L22ed_rt_format_float_native_bb198:
    movz x15, #6064 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L379
    movz x15, #6080 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L380
    b __L22ed_rt_format_float_native_bb199 ; branch
__L22ed_rt_format_float_native_bb199:
    movz x15, #6080 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L380
    cbz x1, __L22ed_rt_format_float_native_bb196 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb195 ; branch -> then
__L22ed_rt_format_float_native_bb200:
    movz x15, #6144 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    b __L22ed_rt_format_float_native_bb202 ; branch
__L22ed_rt_format_float_native_bb201:
    movz x15, #6144 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L384
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb209 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb208 ; branch -> then
__L22ed_rt_format_float_native_bb202:
    movz x15, #6240 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb204 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb203 ; branch -> then
__L22ed_rt_format_float_native_bb203:
    movz x15, #6176 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    stp x0, x1, [x15] ; hv store L390
    b __L22ed_rt_format_float_native_bb202 ; branch
__L22ed_rt_format_float_native_bb204:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #6304 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L394
    b __L22ed_rt_format_float_native_bb205 ; branch
__L22ed_rt_format_float_native_bb205:
    movz x15, #6144 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L384
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb207 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb206 ; branch -> then
__L22ed_rt_format_float_native_bb206:
    movz x15, #6144 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L384
    movz x15, #6304 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L394
    b __L22ed_rt_format_float_native_bb205 ; branch
__L22ed_rt_format_float_native_bb207:
    b __L22ed_rt_format_float_native_bb214 ; branch
__L22ed_rt_format_float_native_bb208:
    movz x15, #6176 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L386
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L386
    b __L22ed_rt_format_float_native_bb213 ; branch
__L22ed_rt_format_float_native_bb209:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #6464 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L404
    b __L22ed_rt_format_float_native_bb210 ; branch
__L22ed_rt_format_float_native_bb210:
    movz x15, #6144 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L384
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb212 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb211 ; branch -> then
__L22ed_rt_format_float_native_bb211:
    movz x15, #6144 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L384
    movz x15, #6464 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L404
    b __L22ed_rt_format_float_native_bb210 ; branch
__L22ed_rt_format_float_native_bb212:
    b __L22ed_rt_format_float_native_bb213 ; branch
__L22ed_rt_format_float_native_bb213:
    b __L22ed_rt_format_float_native_bb214 ; branch
__L22ed_rt_format_float_native_bb214:
    movz x15, #6176 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L386
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb216 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb215 ; branch -> then
__L22ed_rt_format_float_native_bb215:
    movz x15, #6176 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L386
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_format_float_native_bb218 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb217 ; branch -> then
__L22ed_rt_format_float_native_bb216:
    movz x15, #6576 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb225 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb224 ; branch -> then
__L22ed_rt_format_float_native_bb217:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #46 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [sp, #0] ; hv store L13
    b __L22ed_rt_format_float_native_bb218 ; branch
__L22ed_rt_format_float_native_bb218:
    movz x15, #6576 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L411
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    cbz x1, __L22ed_rt_format_float_native_bb220 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb219 ; branch -> then
__L22ed_rt_format_float_native_bb219:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #6736 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L421
    b __L22ed_rt_format_float_native_bb220 ; branch
__L22ed_rt_format_float_native_bb220:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #1 ; hv const_int val
    ...
    b __L22ed_rt_format_float_native_bb221 ; branch
__L22ed_rt_format_float_native_bb221:
    movz x15, #6800 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb223 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb222 ; branch -> then
__L22ed_rt_format_float_native_bb222:
    movz x15, #6176 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L386
    movz x15, #6784 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L425
    b __L22ed_rt_format_float_native_bb221 ; branch
__L22ed_rt_format_float_native_bb223:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #6720 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    add x15, sp, #656 ; hv frame base
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb229 ; branch
__L22ed_rt_format_float_native_bb224:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #6912 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L432
    b __L22ed_rt_format_float_native_bb225 ; branch
__L22ed_rt_format_float_native_bb225:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    ...
    b __L22ed_rt_format_float_native_bb226 ; branch
__L22ed_rt_format_float_native_bb226:
    movz x15, #6976 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb228 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb227 ; branch -> then
__L22ed_rt_format_float_native_bb227:
    movz x15, #6176 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L386
    movz x15, #6960 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L436
    b __L22ed_rt_format_float_native_bb226 ; branch
__L22ed_rt_format_float_native_bb228:
    add x15, sp, #656 ; hv frame base
    ldp x0, x1, [x15] ; hv load L41
    movz x15, #6576 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    stp x0, x1, [x15] ; hv store L41
    b __L22ed_rt_format_float_native_bb229 ; branch
__L22ed_rt_format_float_native_bb229:
    movz x15, #6048 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L378
    movz x2, #0 ; hv const_int: TAG_INT
    ...
    stp x0, x1, [x15] ; hv store L378
    b __L22ed_rt_format_float_native_bb194 ; branch
__L22ed_rt_format_float_native_bb230:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #7136 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L446
    b __L22ed_rt_format_float_native_bb232 ; branch
__L22ed_rt_format_float_native_bb231:
    movz x0, #0 ; hv const_int: TAG_INT
    movz x1, #0 ; hv const_int val
    movz x15, #7200 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    stp x0, x1, [x15] ; hv store L450
    b __L22ed_rt_format_float_native_bb235 ; branch
__L22ed_rt_format_float_native_bb232:
    movz x15, #7136 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ...
    cbz x1, __L22ed_rt_format_float_native_bb234 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb233 ; branch -> then
__L22ed_rt_format_float_native_bb233:
    ldp x0, x1, [sp, #0] ; hv load L13
    movz x2, #0 ; hv const_int: TAG_INT
    movz x3, #48 ; hv const_int val
    bl _hexa_array_push ; call hexa_array_push
    ...
    stp x0, x1, [x15] ; hv store L446
    b __L22ed_rt_format_float_native_bb232 ; branch
__L22ed_rt_format_float_native_bb234:
    b __L22ed_rt_format_float_native_bb231 ; branch
__L22ed_rt_format_float_native_bb235:
    movz x15, #5680 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L355
    bl _hexa_len ; call hexa_len
    ...
    cbz x1, __L22ed_rt_format_float_native_bb237 ; br_cond: !payload -> else
    b __L22ed_rt_format_float_native_bb236 ; branch -> then
__L22ed_rt_format_float_native_bb236:
    movz x15, #5680 ; imm 0-15
    add x15, sp, x15 ; hv frame base (big)
    ldp x0, x1, [x15] ; hv load L355
    movz x15, #7200 ; imm 0-15
    ...
    stp x0, x1, [x15] ; hv store L450
    b __L22ed_rt_format_float_native_bb235 ; branch
__L22ed_rt_format_float_native_bb237:
    b __L22ed_rt_format_float_native_bb238 ; branch
__L22ed_rt_format_float_native_bb238:
    ldp x0, x1, [sp, #0] ; hv load L13
    bl _hexa_bytes_to_str_raw ; call hexa_bytes_to_str_raw
