...
//   ABI: ELF aarch64, no underscore. External U-floor: malloc realloc write hexa_exit hexa_throw (libc-bearing: realloc grow dissolves the
...
_L1161_hexa_arr_f64_new_bb0:
    ...
    cbz x1, _L1161_hexa_arr_f64_new_bb2 // br_cond: !payload -> else
    b _L1161_hexa_arr_f64_new_bb1 // branch -> then
_L1161_hexa_arr_f64_new_bb1:
    movz x0, #0 // hv const_int: TAG_INT
    movz x1, #1 // hv const_int val
    stp x0, x1, [sp, #16] // hv store L1
    b _L1161_hexa_arr_f64_new_bb2 // branch
_L1161_hexa_arr_f64_new_bb2:
    movz x0, #0 // hv const_int: TAG_INT
...
_L1161_hexa_arr_f64_push_bits_bb0:
    ldp x0, x1, [sp, #0] // hv load L0
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    stp x0, x1, [sp, #128] // hv store L8
    ldp x0, x1, [sp, #128] // hv load L8
    cbz x1, _L1161_hexa_arr_f64_push_bits_bb2 // br_cond: !payload -> else
    b _L1161_hexa_arr_f64_push_bits_bb1 // branch -> then
_L1161_hexa_arr_f64_push_bits_bb1:
    ldp x0, x1, [sp, #112] // hv load L7
    movz x2, #0 // hv const_int: TAG_INT
    ...
    cbz x1, _L1161_hexa_arr_f64_push_bits_bb4 // br_cond: !payload -> else
    b _L1161_hexa_arr_f64_push_bits_bb3 // branch -> then
_L1161_hexa_arr_f64_push_bits_bb2:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_ptr_load64: addr = ptr + off
    ...
    ldp x29, x30, [sp], #16 // epilogue: restore fp/lr
    ret // return
_L1161_hexa_arr_f64_push_bits_bb3:
    ...
    b _L1161_hexa_arr_f64_push_bits_bb4 // branch
_L1161_hexa_arr_f64_push_bits_bb4:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    ...
    b _L1161_hexa_arr_f64_push_bits_bb2 // branch
...
_L1161_hexa_arr_f64_box_bb0:
    ...
    stp x0, x1, [sp, #96] // hv store L6
    ldp x0, x1, [sp, #96] // hv load L6
    cbz x1, _L1161_hexa_arr_f64_box_bb2 // br_cond: !payload -> else
    b _L1161_hexa_arr_f64_box_bb1 // branch -> then
_L1161_hexa_arr_f64_box_bb1:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr1 // hv str ptr page
    add x1, x1, :lo12:.LCstr1 // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #128] // hv store L8
    b _L1161_hexa_arr_f64_box_bb2 // branch
_L1161_hexa_arr_f64_box_bb2:
    ldp x0, x1, [sp, #16] // hv load L1
    ldp x2, x3, [sp, #80] // hv load L5
    cmp x1, x3 // __hx_payload_ge: cmp payloads
    cset x0, ge // __hx_payload_ge: x0 = (a.pl ge b.pl)
    ...
    cbz x1, _L1161_hexa_arr_f64_box_bb4 // br_cond: !payload -> else
    b _L1161_hexa_arr_f64_box_bb3 // branch -> then
_L1161_hexa_arr_f64_box_bb3:
    movz x0, #3 // hv const_str: TAG_STR
    adrp x1, .LCstr1 // hv str ptr page
    add x1, x1, :lo12:.LCstr1 // hv str ptr off
    bl hexa_throw // call hexa_throw
    stp x0, x1, [sp, #176] // hv store L11
    b _L1161_hexa_arr_f64_box_bb4 // branch
_L1161_hexa_arr_f64_box_bb4:
    ldp x0, x1, [sp, #48] // hv load L3
    movz x2, #0 // hv const_int: TAG_INT
    movz x3, #0 // hv const_int val
    add x1, x1, x3 // __hx_ptr_load64: addr = ptr + off
