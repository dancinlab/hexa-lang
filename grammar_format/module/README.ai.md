---
schema: hexa-lang/grammar_format/module/ai-native/1
last_updated: 2026-05-02
ssot:
  interface: hexa-lang/grammar_format/core/source.hexa
  registry:  hexa-lang/grammar_format/core/registry.hexa
  router:    hexa-lang/grammar_format/core/router.hexa
  config:    hexa-lang/config/grammar_format_sources.json
  aggregator: hexa-lang/grammar_format/core/grammar_format_main.hexa
spec_cross_link:
...
```
caller
  └── hexa-lang/grammar_format/core/router.hexa            (shebang detect + fallback chain)
       └── hexa-lang/grammar_format/core/registry.hexa     (name → schema)
            └── hexa-lang/grammar_format/core/source.hexa  (GrammarSchema interface SSOT)
                 ├── hexa-lang/grammar_format/module/grammar_v1.hexa     mk1   WRAPPED        (wraps self/lexer.hexa + self/parser.hexa)
                 ├── hexa-lang/grammar_format/module/grammar_v2.hexa     mk2   STUB-FROM-SPEC (Phase β: @attr AST + strict + typing)
                 ├── hexa-lang/grammar_format/module/grammar_v3.hexa     mk3   STUB-FROM-SPEC (Phase γ: pub/public + Result fail-loud)
                 ├── hexa-lang/grammar_format/module/grammar_v4.hexa     mk4   STUB-FROM-SPEC (Phase δ: @module + typed use + composition)
                 └── hexa-lang/grammar_format/module/grammar_v5.hexa     mk5   STUB-FUTURE     (phase epsilon TBD)

aggregator
  └── hexa-lang/grammar_format/core/grammar_format_main.hexa  (5-version selftest aggregate)
...
1. Copy `grammar_format/module/grammar_v5.hexa` → `grammar_v6.hexa`.
...
4. Add to `grammar_format/core/registry.hexa` `grammar_registry_names()` + `grammar_registry_schema()` switch.
5. Add to `grammar_format/core/router.hexa` `_route_parse()` + `grammar_detect_shebang()`.
6. Add to `grammar_format/core/grammar_format_main.hexa` `_schema_for()` + names list + selftest.
...
6. **Cross-file struct mirror duplication** — every module mirrors `GrammarSchema`/`AST`/`Token`/`Issue` per the rng prototype's 4-core file pattern. Drift risk = 7 sites (4 core + 5 modules + 1 SSOT source.hexa = 10 - dedup); mitigated by selftest cross-checks but real fix awaits Phase δ L5 declarative @module.
...
|------|--------------|------|--------|
| /Users/<user>/core/hexa-lang/grammar_format/core/source.hexa | ~200 | GrammarSchema interface SSOT | _self-pinned at land time_ |
| /Users/<user>/core/hexa-lang/grammar_format/core/registry.hexa | ~180 | name → schema dispatch | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/core/router.hexa | ~280 | shebang dispatch + fallback | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/core/grammar_format_main.hexa | ~210 | aggregator + selftest | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/module/grammar_v1.hexa | ~190 | mk1 WRAPPED | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/module/grammar_v2.hexa | ~210 | Phase β STUB-FROM-SPEC | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/module/grammar_v3.hexa | ~200 | Phase γ STUB-FROM-SPEC | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/module/grammar_v4.hexa | ~200 | Phase δ STUB-FROM-SPEC | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/module/grammar_v5.hexa | ~170 | future STUB-FUTURE | _pin_ |
| /Users/<user>/core/hexa-lang/config/grammar_format_sources.json | ~25 | priority chain + env config | _pin_ |
| /Users/<user>/core/hexa-lang/grammar_format/module/README.ai.md | (this) | landing doc | _pin_ |
