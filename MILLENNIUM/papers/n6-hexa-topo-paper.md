<!-- @canonical-origin: canon@a86ca143:papers/n6-hexa-topo-paper.md (moved 2026-05-10) -->
<!-- gold-standard: shared/harness/sample.md -->
---
domain: topo
requires: []
---
# [CANONICAL v2] Ultimate topo (HEXA-HEXA-TOPO) — n=6 Arithmetic Coordinate Mapping

> **Author**: Park Min-woo (canon)
> **Category**: topo — n=6 arithmetic seed paper
> **Version**: v2 (2026-04-14 canonical)
> **Upstream BT**: BT-90, BT-91, BT-92
> **Linked atlas node**: `topo` 10/10 EXACT [10*]

---

## 0. Abstract

This paper demonstrates that the core parameters of the topo domain are systematically
...
interlocks with the basic numerical values of topo. Atlas.n6 registration: 10/10 items EXACT.

This paper does not claim a new topo; it is a seed paper that assigns **n=6 arithmetic
...
topo(topo) is reinterpreted within the n=6 arithmetic system. The perfect number n=6
simultaneously satisfies the number-theoretic constant family σ(6)=12, τ(6)=4, φ=2,
sopfr(6)=5, which structurally aligns with the core parameters of the topo domain.
**This paper assigns an n=6 arithmetic coordinate system on top of existing topo knowledge.**

| Effect | Before | After HEXA-HEXA-TOPO | Perceived change |
|--------|--------|----------------------|------------------|
...
uniqueness necessarily interlocks with the basic numerical values of topo.

### What n=6 coordinate mapping changes

```
  Before: "Why is this topo value this number?" → experience/convention
  HEXA:   "This topo value = σ(6) or τ(6) or sopfr(6)" → number-theoretic necessity
       ↓
...
## §2 COMPARE (legacy topo vs n=6) — performance comparison (ASCII)
...
### Performance-comparison ASCII bars (legacy topo method vs HEXA-HEXA-TOPO)
...
```
+--------------------------------------------------------------------------+
|                    HEXA-HEXA-TOPO           system structure             |
+------------+------------+------------+------------+----------------------+
...
4. **Domain overlap**: the σ=12 axis is a common parameter shared by topo and dozens of other domains.
...
HEXA-HEXA-TOPO stagewise maturity roadmap — verification density increases per Mk:

<details open>
<summary><b>Mk.V — 2045+ integrated completion (target)</b></summary>

Target: complete integration of the full topo domain into n=6 arithmetic. Cross-reference
...
Map topo core parameters to σ/τ/φ/sopfr/J_2.
...
Verify with stdlib only whether HEXA-HEXA-TOPO is physically / mathematically /
...
Check whether the main topo scaling laws follow exponents τ(6)=4 or sopfr(6)=5 via log-log regression.
...
TOPO-domain physical bounds (Carnot / Shannon / Bekenstein, etc.) checked separately.
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY -- HEXA-HEXA-TOPO n=6 honesty verification (stdlib only, topo domain)
#
...
FALSIFIERS = [
    "If topo main-parameter n=6 alignment < 70%, retire the core claim of this paper",
