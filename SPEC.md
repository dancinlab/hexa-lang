...
| Surface | Path |
|---|---|
| Manifest | `archive/patches/PATCHES.yaml` |
| Audit log | `archive/patches/manifest_log.jsonl` |
...
| wilson `hexa build core/main.hexa` → `OK: built build/wilson` → `wilson 0.0.1` (hello, harness-cli/print/rpc, tool-core, provider-claude-cli/anthropic, agents-md) — hexa-lang side of wilson CLOSED | PASS | 340c3788 (closure note `docs/notes/2026-05-11-wilson-hexa-lang-closure.md`) |
