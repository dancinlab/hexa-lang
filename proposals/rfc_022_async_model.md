...
- **Block dependency**: wilson core port (archive/patches/PATCHES.yaml#wilson-pi-port-6-gap-prereq) — G2 of {G1, G2, G3} prereq triple
...
- `archive/patches/PATCHES.yaml#wilson-pi-port-6-gap-prereq` (downstream consumer entry)
