...
4     |   .    |   .     |   ⚠ throws (T34 stderr msg) |   honest-caveat partial (catch only)  |    .
5     |   .    |   ⚠ partial (consts only) |   ⚠ throws |   .   |    .
6     |   .    |   .     |   ✗ silent truncate |   .   |    .
7     |   .    |   .     |   .     |   ✓ audit_shim_ssot + follow-up |    .
8     |   .    |   .     |   .     |   ✓ audit_shim_ssot + idempotency |    .
```
...
| 7 hive policy | baseline rule 8 (stage0/stage1 retire) | follow-up |
